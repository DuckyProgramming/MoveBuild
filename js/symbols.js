function displayStatusSymbol(layer,x,y,type,direction,size,fade){
    ...
    switch(type){
        ...
        case 592:
            ...
            layer.stroke(255,175,100,fade)
            layer.strokeWeight(1.8)
            layer.line(-1.8,0,1.8,0)
            layer.line(-1.8,0,0,-4.2)
            layer.line(1.8,0,0,4.2)
            layer.fill(100,fade)
            layer.noStroke()
            layer.triangle(-4,-2,-4,2,6,0)
        ...
        case 595:
            ...
            regStar(layer,0,0,5,1.5,1.5,4.5,4.5,0)
            layer.fill(255,fade)
            regStar(layer,0,0,5,1,1,3,3,0)
        break
        case 596:
            layer.fill(150,0,0,fade)
            layer.arc(0,0,8,8,0,180)
        ...
        case 598:
            ...
            layer.rect(0,6,5,2)
            layer.rect(0,8,3,2)
            layer.triangle(0,9.5,-1,11,1,11)
        break
        case 599:
            layer.fill(125,fade)
            layer.stroke(100,fade)
        ...
        case 600:
            ...
            layer.noStroke()
            layer.fill(225,fade)
            layer.rect(-1,0.25,3,1.5)
            layer.triangle(0.5,1,0.5,-1.5,3,1)
        break
        case 601:
            layer.fill(150,0,0,fade)
            regStar(layer,0,0,8,5,5,3,3,0)
        ...
        case 604:
            layer.fill(255,50,50,fade)
            layer.rect(0,-3,10,2)
            layer.triangle(-3,-1,-5,4,-1,4)
            layer.triangle(3,-1,5,4,1,4)
            layer.ellipse(0,-6,2.5)
            layer.fill(200,fade)
        ...
        break
        case 610:
            layer.fill(80,140,160,fade)
            layer.ellipse(0,0,12)
            layer.stroke(0,fade)
            layer.strokeWeight(1)
            layer.arc(0,-2,10,4,15,165)
            layer.line(0,0,0,2)
            layer.line(-3,0,-4,1.5)
            layer.line(3,0,4,1.5)
        break
        case 611:
            layer.fill(150,0,0,fade)
        ...
        case 614:
            ...
            layer.fill(255,fade)
            layer.noStroke()
            layer.triangle(-0.25,-2,-2.75,0,-0.25,2)
            layer.triangle(0.25,-2,2.75,0,0.25,2)
        break
        case 615:
            layer.stroke(255,fade)
        ...
        case 625:
            ...
            layer.ellipse(-2,-2,2.5)
            layer.ellipse(-1,2.5,2)
            layer.ellipse(2.5,0.5,3)
        break
        case 626:
            layer.fill(150,0,0,fade)
            regStar(layer,0,0,8,5,5,3,3,0)
        ...
        break
        case 631:
            layer.fill(50,225,125,fade)
            layer.stroke(25,200,100,fade)
            layer.strokeWeight(0.75)
            layer.strokeJoin(ROUND)
            regStar(layer,0,0,6,3.5,3.5,5,5,30)
            layer.strokeJoin(MITER)
            layer.noStroke()
            layer.fill(100,fade)
            layer.triangle(0,0,-2,-1.5,-2,1.5)
            layer.triangle(2.5,0,0.5,-1.5,0.5,1.5)
        break
        case 632:
        ...
        case 633:
            ...
            layer.fill(75,150,75,fade)
            layer.rect(0,1,2,3)
            layer.triangle(-2,-0.5,2,-0.5,0,-3.5)
        break
        case 634:
            layer.fill(40,fade)
            layer.ellipse(0,0,10)
        ...
        case 635:
            ...
            layer.noStroke()
            layer.fill(150,175,200,fade)
			layer.triangle(-2.5,-1.5,2.5,-1.5,0,-3)
			layer.arc(0,-1.5,5,8,0,180)
        break
        case 636:
            layer.fill(125,fade)
            layer.stroke(100,fade)
            ...
            layer.noStroke()
            layer.fill(225,fade)
            layer.rect(-1,-1.25,3,1.5)
            layer.triangle(0.5,-0.5,0.5,-3,3,-0.5)
            layer.ellipse(-1.5,1.5,2)
            layer.ellipse(1.5,1.5,2)
        break
        case 637:
            layer.fill(100,60,100,fade)
        ...
        case 640:
            ...
            layer.line(-1.8,-1.8*constants.sqrt3,1.8,1.8*constants.sqrt3)
            layer.line(-1.8,1.8*constants.sqrt3,1.8,-1.8*constants.sqrt3)
            layer.fill(100,fade)
            layer.noStroke()
            layer.triangle(-4,-2,-4,2,6,0)
        ...
        case 642:
            ...
            layer.noStroke()
            layer.fill(255,100,100,fade)
            layer.triangle(0,-4,-2,-7,2,-7)
            layer.fill(255,225,25,fade)
            layer.beginShape()
            layer.vertex(0,2)
            layer.vertex(-3,0)
            layer.vertex(-4,-5)
        ...
        case 644:
            layer.fill(255,50,50,fade)
            layer.triangle(-4,-4,-4,-0.5,7,-2.25)
            layer.triangle(4,4,4,-0.5,-7,2.25)
            layer.rect(-6,-2.25,3)
            layer.rect(6,2.25,3)
        break
        case 645:
            ...
            layer.line(0,3,-3,1)
            layer.line(0,3,3,1)
            layer.line(-3,1,-1.5,-3)
            layer.line(0,0,-1.5,-3)
            layer.line(3,1,1.5,-3)
            layer.line(0,0,1.5,-3)
        break
        case 646:
            layer.strokeWeight(0.6)
            layer.stroke(100,0,100,fade)
            layer.triangle(-4.8,0,-0.3,-4.5,-0.3,4.5)
            layer.stroke(255,255,100,fade)
            layer.triangle(4.8,0,0.3,-4.5,0.3,4.5)
            layer.noStroke()
            layer.fill(25,fade)
            layer.arc(0,0,6,6,-180,0)
            layer.fill(255,fade)
            layer.arc(0,0,6,6,0,180)
        ...
        case 660:
            layer.stroke(255,fade)
            layer.strokeWeight(0.8)
            layer.arc(0,0,8,8,-165,-105)
            layer.arc(0,0,8,8,-75,-15)
            layer.arc(0,0,8,8,15,75)
            layer.arc(0,0,8,8,105,165)
            layer.stroke(0,fade)
            layer.strokeWeight(1)
            layer.ellipse(0,0,10)
            layer.line(-8/3,-2/3,-4/3,2/3)
        ...
        case 661:
            ...
            layer.noStroke()
            layer.fill(255,255,150,fade)
            layer.triangle(-1.5,6,-0.5,6,-1,7)
            layer.triangle(0.5,6,1.5,6,1,7)
        break
        case 662:
            layer.fill(0,fade)
            layer.ellipse(0,0,9,9)
        ...
        break
        case 663:
            layer.fill(255,200,0,fade)
            layer.arc(0,0,10,10,-180,-120)
            layer.arc(0,0,10,10,-60,0)
            layer.arc(0,0,10,10,60,120)
            layer.fill(40,fade)
        ...
        case 666:
            ...
            layer.triangle(0,-4,-2,-7,2,-7)
            layer.fill(255,200,0,fade)
            layer.arc(0,0,6,6,-180,-120)
            layer.arc(0,0,6,6,-60,0)
            layer.arc(0,0,6,6,60,120)
            layer.fill(40,fade)
            layer.arc(0,0,6,6,0,60)
            layer.arc(0,0,6,6,-120,-60)
            layer.arc(0,0,6,6,120,180)
        break
        case 667:
            layer.fill(40,fade)
            layer.ellipse(0,0,10)
        ...
        case 668:
            ...
            layer.line(-4,-4,0,-4)
            layer.line(4,4,0,4)
            layer.fill(75,255,255,fade)
            layer.noStroke()
            layer.triangle(0,6.5,-1,9.5,1,9.5)
        break
        case 669:
            layer.fill(225,240,240,fade)
            layer.rect(-2.5,-2.5,4,4)
            layer.rect(2.5,2.5,4,4)
            layer.fill(120,210,240,fade)
            layer.triangle(-0.5,0.5,-4.5,0.5,-0.5,4.5)
            layer.triangle(0.5,-0.5,4.5,-0.5,0.5,-4.5)
        break
        case 670:
            layer.fill(255,fade/5)
        ...
        case 675:
            ...
            layer.rect(4.5,-0.5,1,2)
            layer.fill(120,fade)
            layer.rect(-1.5,-0.5,1,2)
            layer.rect(1.5,-0.5,1,2)
        break
        case 676:
            layer.fill(255,255,150,fade)
            layer.ellipse(0,0,9)
            layer.ellipse(-2.5,-2.5,3.5)
            layer.ellipse(-2.5,2.5,3.5)
            layer.ellipse(2.5,-2.5,3.5)
            layer.ellipse(2.5,2.5,3.5)
            layer.fill(0,fade)
            layer.ellipse(0,0,8)
            layer.ellipse(-2.5,-2.5,2.5)
            layer.ellipse(-2.5,2.5,2.5)
            layer.ellipse(2.5,-2.5,2.5)
            layer.ellipse(2.5,2.5,2.5)
            layer.fill(255,255,150,fade)
            layer.ellipse(-2,-0.5,1.5)
            layer.ellipse(2,-0.5,1.5)
        break
        case 677:
            layer.fill(255,255,200,fade)
            ...
            layer.beginShape()
            layer.vertex(0,6)
            layer.bezierVertex(-7.5,3,4.5,-2,0,-6)
            layer.bezierVertex(7.5,-3,-4.5,2,0,6)
            layer.endShape()
            layer.strokeJoin(MITER)
        break
        ...
        case 680:
            ...
            layer.noStroke()
            layer.fill(75,225,75,fade)
            layer.quad(-2,0,0,-5,2,0,0,5)
            layer.quad(-5,0,-3,-2,-1,0,-3,2)
            layer.quad(5,0,3,-2,1,0,3,2)
        break
        case 681:
            layer.fill(255,50,50,fade)
        ...
        break
        case 684:
            layer.fill(220,225,230,fade)
            layer.ellipse(0,0,10)
            layer.fill(80,60,80,fade)
            for(let a=0,la=8;a<la;a++){
                layer.ellipse(3.5*lsin(a/la*360),3.5*lcos(a/la*360),1.5)
            }
            layer.fill(125,fade)
            layer.stroke(100,fade)
            layer.strokeWeight(1)
        ...
        case 686:
            layer.fill(255,50,50,fade)
            layer.triangle(-2,0,2,0,0,-6)
            layer.triangle(-4.5,-4.5,1.5,-1.5,-1.5,1.5)
            layer.triangle(4.5,-4.5,-1.5,-1.5,1.5,1.5)
            layer.fill(255,200,255,fade)
            layer.quad(-1,-7.5,0,-5,0,5,-1,5)
            layer.fill(255,150,255,fade)
        ...
        case 692:
            ...
            regStar(layer,0,0,8,6,6,3.6,3.6,0)
            layer.fill(125,255,255,fade)
            layer.rect(0,0,7.5,7.5)
            layer.fill(175,255,255,fade)
            layer.rect(0,0,5,5)
            layer.fill(225,255,255,fade)
            layer.rect(0,0,2.5,2.5)
        break
        case 693:
            layer.fill(140,120,160,fade)
            layer.stroke(120,100,140,fade)
        ...
        case 708:
            layer.fill(150,175,200,fade)
            layer.triangle(-2,-1,2,-1,0,-6)
            layer.triangle(-2,1,2,1,0,6)
            layer.fill(255,225,150,fade)
        ...
        case 715:
            ...
            layer.fill(225,fade)
            layer.rect(0,0,1,10)
            layer.arc(-1.5,0,4,10,90,270)
            layer.arc(1.5,0,4,10,-90,90)
        break
        case 716:
            layer.fill(150,175,200,fade)
			layer.triangle(-5,-3,5,-3,0,-6)
        ...
        case 719:
            ...
            layer.noStroke()
            layer.fill(100,150,255,fade)
            layer.triangle(6,-2,6,2,8,0)
        break
        case 720:
            layer.fill(75,255,75,fade)
            layer.rect(0,0,8,8)
            layer.fill(225,fade)
            layer.rect(0,0,6,6)
            layer.fill(75,255,75,fade)
            layer.rect(-1.5,0,1,4)
            layer.rect(1.5,0,1,4)
            layer.rect(0,-1,2,1)
            layer.rect(0,1,2,1)
            layer.fill(200,fade)
        ...
        case 727:
            ...
            layer.rect(0,0,4,4)
            layer.quad(0,-2*constants.sqrt2,-2*constants.sqrt2,0,0,2*constants.sqrt2,2*constants.sqrt2,0)
        break
        case 728:
            layer.fill(125,fade)
            layer.stroke(100,fade)
        ...
        case 740:
            layer.fill(255,255,0,fade)
            layer.quad(-0.5,-3,-0.5,3,-2,5,-2,-5)
            layer.quad(4.5,-3,4.5,3,3,5,3,-5)
            layer.fill(0,255,255,fade)
            layer.quad(0.5,-3,0.5,3,2,5,2,-5)
            layer.quad(-4.5,-3,-4.5,3,-3,5,-3,-5)
        break
        ...
        case 744:
            layer.fill(255,50,50,fade)
            layer.triangle(-3,-3,-3,3,6,0)
            layer.fill(75,0,125)
            for(let a=0,la=7;a<la;a++){
                layer.triangle(0,-3.4,-1,-5,1,-5)
                layer.rotate(180/la)
                layer.triangle(0,-5,-0.75,-3.8,0.75,-3.8)
                layer.rotate(180/la)
            }
        break
        case 745:
        ...
        case 746:
            ...
            layer.quad(0,0,constants.sqrt2*2,-constants.sqrt2*2,0,-constants.sqrt2*4,-constants.sqrt2*2,-constants.sqrt2*2)
            layer.fill(180,fade)
            layer.rect(1.6,0,2.4,8.8)
            layer.rect(-1.6,-1.6,2.4,5.6)
            layer.rect(0,3.2,5.6,2.4)
        break
        case 747:
            layer.fill(255,50,50,fade)
            layer.triangle(0,-6,-3,3,3,3)
        ...
        case 766:
            ...
            regPoly(layer,0,0,6,5,5,0)
            regPoly(layer,0,0,6,5.8,5.8,30)
        break
        case 767:
            layer.fill(150,175,200,fade)
			layer.triangle(-5,-3,5,-3,0,-6)
        ...
        case 784:
            layer.fill(225,25,25,fade)
            regStar(layer,-3,0,5,3,3,1.25,1.25,180)
            layer.stroke(255,255,50,fade)
            layer.noFill()
            layer.strokeWeight(0.5)
            layer.ellipse(-3,0,6)
            layer.noStroke()
            layer.fill(255,50,50,fade)
            layer.triangle(3,3,1.5,-1.5,4.5,-1.5)
        break
        case 785:
            layer.fill(225,25,25,fade)
            regStar(layer,-3,0,5,3,3,1.25,1.25,180)
        ...
        case 786:
            ...
            layer.rect(0,0,4.5,6,1)
            layer.noStroke()
            layer.fill(25,225,175,fade)
            layer.quad(-0.5,0,-0.5,2,-2.5,0,-2.5,-2)
            layer.quad(0.5,0,0.5,-2,2.5,0,2.5,2)
        break
        case 787:
            layer.fill(25,225,175,fade)
        ...
        break
        case 790:
            layer.fill(50,0,150,fade)
            layer.triangle(-0.5,-2,-0.5,1,-4,-4)
            layer.triangle(-0.5,2,-0.5,-1,-3.5,3.5)
            layer.triangle(0.5,-2,0.5,1,4,-4)
            layer.triangle(0.5,2,0.5,-1,3.5,3.5)
            layer.fill(125,fade)
            layer.stroke(100,fade)
        ...
        case 794:
            ...
            layer.triangle(1.5,-3,-3,-4,-3,-2)
            layer.triangle(1.5,3,-3,2,-3,4)
        break
        case 795:
            layer.stroke(150,0,200,fade)
            layer.strokeWeight(0.5)
        ...
        case 796:
            ...
            layer.noStroke()
            layer.fill(225,25,25,fade)
            regStar(layer,0,0,5,3,3,1.25,1.25,180)
        break
        case 797:
            layer.fill(255,50,50,fade)
            layer.triangle(0,-6,-3,3,3,3)
        ...
        case 798:
            layer.fill(225,25,25,fade)
            regStar(layer,0,0,5,6,6,2.5,2.5,180)
            layer.fill(25,175,25,fade)
            regTriangle(layer,0,0,4.5,4.5,30)
            layer.fill(125,fade)
            layer.stroke(100,fade)
            layer.strokeWeight(1)
            layer.rect(0,0,4.5,6,1)
        ...
        case 799:
            layer.fill(225,25,25,fade)
            regStar(layer,0,0,5,6,6,2.5,2.5,180)
            layer.fill(25,225,225,fade)
            regStar(layer,0,0,5,3.6,3.6,1.5,1.5,180)
        break
        case 800:
            layer.fill(50,150,100,fade)
            layer.ellipse(0,0,8)
        ...
        case 811:
            ...
            layer.triangle(0,3.5,-1,6.5,1,6.5)
            layer.triangle(0,7,-1,10,1,10)
            layer.triangle(0,10.5,-1,13.5,1,13.5)
        break
        case 812:
            layer.fill(150,0,0,fade)
            regStar(layer,0,0,8,6,6,3.6,3.6,0)
        ...
        case 813:
            ...
            layer.triangle(-0.25,-4,-5.25,0,-0.25,4)
            layer.triangle(0.25,-4,5.25,0,0.25,4)
            layer.triangle(-1.5,-4.5,0,-7,1.5,-4.5)
        break
        case 814:
            layer.fill(255,50,50,fade)
            layer.rect(0,0,1,8)
        ...
        case 817:
            layer.fill(150,0,0,fade)
            halfRegStar(layer,0,0,4,6,6,3.6,3.6,0)
            layer.fill(0,100,200,fade)
            halfRegStar(layer,0,0,4,6,6,3.6,3.6,180)
            layer.fill(225,0,225,fade)
            layer.quad(-2,0,0,-2,2,0,0,2)
        break
        case 818:
            layer.fill(125,175,255,fade*0.8)
            layer.ellipse(0,0,6)
        ...
        case 831:
            ...
            layer.fill(60,fade)
            layer.rect(0,0,4)
            layer.triangle(-2.5,-2,-2.5,2,-4.5,-2)
            layer.triangle(2.5,2,2.5,-2,4.5,2)
        break
        case 832:
            layer.fill(150,175,200,fade)
        ...
        case 835:
            ...
            layer.ellipse(-2,-3.5,4)
            layer.beginShape()
            layer.vertex(-2+constants.sqrt2,-3.5-constants.sqrt2)
            layer.vertex(-2-constants.sqrt2,-3.5+constants.sqrt2)
            layer.vertex(0.5,0.5)
            layer.vertex(-3,5.5)
            layer.vertex(3,0.5)
            layer.endShape()
        break
        ...
        case 864:
            ...
            regTriangle(layer,-2.5,0,2,2,0)
            layer.fill(225,75,225,fade)
            regTriangle(layer,0,-2.5,2,2,30)
            layer.fill(225,150,75,fade)
            regTriangle(layer,2.5,0,2,2,60)
            layer.fill(225,225,75,fade)
            regTriangle(layer,0,2.5,2,2,90)
        break
        case 865:
            layer.fill(0,150,255,fade)
            layer.ellipse(0,0,8)
        ...
        case 887:
            ...
            layer.triangle(4,0,3,-4,2,0)
            layer.triangle(-2,0,2,0,0,-6)
            layer.fill(240,120,60,fade)
            layer.quad(0,-4,-4,0,0,4,4,0)
            layer.fill(160,fade)
            layer.beginShape()
            layer.vertex(-6,0)
            layer.vertex(-4,-2)
        ...
        break
        case 889:
            layer.fill(242,204,252,fade)
            for(let a=0,la=5;a<la;a++){
                layer.ellipse(0,-6,2.4)
                layer.rotate(72)
            }
            layer.fill(255,244,255,fade)
            layer.arc(0,0,8,8,-180,0)
            for(let a=0,la=5;a<la;a++){
                layer.ellipse(0,-6,1.6)
                layer.rotate(72)
            }
            layer.fill(115,9,135,fade)
            layer.arc(0,0,8,8,0,180)
            layer.ellipse(2,0,4)
            layer.fill(255,244,255,fade)
            layer.ellipse(-2,0,4)
        ...
        case 900:
            ...
            layer.noStroke()
            layer.fill(150,175,200,fade)
			layer.triangle(-3,-1.8,3,-1.8,0,-3.6)
			layer.arc(0,-1.8,6,9.6,0,180)
        break
        case 901:
            layer.fill(255,255,50,fade)
            layer.rotate(-15)
        ...
        case 911:
            ...
            layer.quad(-4,0,0,-5,4,0,0,5)
            layer.fill(180,fade)
            layer.rect(1.2,0,1.8,6.6)
            layer.rect(-1.2,-1.2,1.8,4.2)
            layer.rect(0,2.4,4.2,1.8)
        break
        case 912:
            layer.fill(255,50,50,fade)
            layer.triangle(9,0,-4.5,-3,-4.5,3)
        ...
        case 919:
            ...
            layer.fill(200,255,255,fade)
            layer.quad(-3.2,0,0,-4,3.2,0,0,4)
            layer.rect(-4.5,-0.5,1,1)
            layer.rect(-4.5,0,0.5,2)
            layer.rect(4.5,-0.5,1,1)
            layer.rect(4.5,0,0.5,2)
        break
        case 920:
        ...
        case 943:
            ...
            layer.fill(40,fade)
            layer.ellipse(-3,0,2)
            layer.ellipse(-5,6,1.2)
            layer.ellipse(-3,6,1.2)
            layer.ellipse(-1,6,1.2)
            layer.fill(255,50,50,fade)
            layer.triangle(4,-6,1,3,7,3)
        break
        case 944:
        ...
        case 951:
            ...
            layer.ellipse(-3,6,1.2)
            layer.ellipse(-1,6,1.2)
            displayMtgManaSymbol(layer,4,0,0,0,0.4,fade,-1,[])
        break
        case 952:
            layer.fill(225,fade)
            layer.rect(-3,0,10,10,2)
        ...
        case 953:
            ...
            layer.ellipse(-3,6,1.2)
            layer.ellipse(-1,6,1.2)
            displayMtgManaSymbol(layer,4,0,1,0,0.4,fade,-1,[])
        break
        case 954:
            layer.fill(225,fade)
            layer.rect(-3,0,10,10,2)
        ...
        case 955:
            ...
            layer.ellipse(-3,6,1.2)
            layer.ellipse(-1,6,1.2)
            displayMtgManaSymbol(layer,4,0,2,0,0.4,fade,-1,[])
        break
        case 956:
            layer.fill(225,fade)
            layer.rect(-3,0,10,10,2)
        ...
        case 957:
            ...
            layer.ellipse(-3,6,1.2)
            layer.ellipse(-1,6,1.2)
            displayMtgManaSymbol(layer,4,0,3,0,0.4,fade,-1,[])
        break
        case 958:
            layer.fill(225,fade)
            layer.rect(-3,0,10,10,2)
        ...
        case 959:
            ...
            layer.ellipse(-3,6,1.2)
            layer.ellipse(-1,6,1.2)
            displayMtgManaSymbol(layer,4,0,4,0,0.4,fade,-1,[])
        break
        case 960:
            layer.fill(225,fade)
            layer.rect(-3,0,10,10,2)
        ...
        case 961:
            ...
            layer.ellipse(-3,6,1.2)
            layer.ellipse(-1,6,1.2)
            displayMtgManaSymbol(layer,4,0,5,0,0.4,fade,-1,[])
        break
        case 962:
            layer.fill(225,fade)
            layer.rect(-3,0,10,10,2)
        ...
        case 963:
            ...
            layer.ellipse(-3,6,1.2)
            layer.ellipse(-1,6,1.2)
            displayMtgManaSymbol(layer,4,0,6,0,0.4,fade,-1,[])
        break
        case 964:
            layer.fill(225,fade)
            layer.rect(-3,0,10,10,2)
        ...
        case 965:
            ...
            layer.ellipse(-1,6,1.2)
            layer.fill(150,175,200,fade)
			layer.triangle(1,-1.8,7,-1.8,4,-3.6)
			layer.arc(4,-1.8,6,9.6,0,180)
        break
        case 966:
            layer.fill(225,fade)
            layer.rect(-3,0,10,10,2)
        ...
        case 967:
            ...
            layer.rect(3.5,0,6,11)
            layer.fill(200,fade)
            layer.rect(-3.5,-0.8,4,1)
            layer.rect(-3.5,2.4,4,1)
            layer.rect(3.5,-4,4,1)
            layer.rect(3.5,0.8,4,1)
            layer.rect(3.5,2.4,4,1)
        break
        ...
        case 972:
            ...
            layer.strokeWeight(0.4)
            layer.fill(240,240,220,fade)
            layer.ellipse(-6,0,16)
            layer.noStroke()
            layer.fill(220,220,200,fade)
            layer.ellipse(-6,0,10)
            layer.fill(255,255,100,fade)
            layer.ellipse(-6,0,4)
            layer.triangle(-7,-3,-5,-3,-6,-7)
            layer.triangle(-7,3,-5,3,-6,7)
            layer.stroke(0,fade)
            layer.strokeWeight(0.4)
            layer.fill(240,240,220,fade)
        ...
        case 974:
            ...
            layer.noStroke()
            layer.ellipse(0,0,12)
            layer.fill(200,fade*0.5)
            layer.ellipse(0,0,7.2)
            layer.stroke(255,fade*0.5)
            layer.strokeWeight(1.2)
...
function displayPlayerSymbol(layer,x,y,type,direction,size,fade){
    ...
    switch(type){
        ...
        break
        case 18:
            layer.ellipse(-10,12,10,8)
            layer.ellipse(8,9,10,8)
            layer.rect(-6.5,0,3,24)
            layer.rect(11.5,-3,3,24)
            layer.quad(-8,-10,-8,-13,13,-17,13,-14)
        ...
        case 20:
            ...
            layer.arc(0,0,30,30,180,240)
            for(let a=0,la=4;a<la;a++){
                layer.rotate(15)
                layer.triangle(0,0,-2,-22,2,-22)
                layer.rotate(15)
            }
            layer.noFill()
            layer.stroke(120,160,40,fade)
            layer.strokeWeight(4)
            ...
            layer.rotate(-60)
            layer.arc(0,0,10,10,0,180)
            layer.ellipse(0,0,10,4)
            layer.triangle(-5,0,-3,0,-4,-3)
            layer.triangle(-4,0,-1,0,-2.5,-5)
            layer.triangle(-2,0,1,0,-0.5,-4)
...
function displayIntentSymbol(layer,x,y,type,effect,direction,size,fade,info){
    ...
    switch(type){
        ...
        case 406:
            layer.fill(255,50,50,fade)
            layer.rect(-5,0,4,4)
            layer.triangle(-7,-2,-3,-2,-2,-4)
            layer.triangle(-7,2,-3,2,-2,4)
            layer.arc(-3,0,6,4,-90,90)
            layer.rect(3,0,4,4)
            layer.triangle(1,-2,5,-2,6,-4)
            layer.triangle(1,2,5,2,6,4)
            layer.arc(5,0,6,4,-90,90)
        break
        case 407:
            layer.fill(255,50,50,fade)
            layer.triangle(9,-2.5,0,-4.5,0,-0.5)
        ...
        case 410:
			...
			layer.triangle(-5,-3,5,-3,0,-6)
			layer.arc(0,-3,10,16,0,180)
            layer.ellipse(-6,0,1.5)
            layer.ellipse(6,-1,1.5)
            layer.ellipse(6,1,1.5)
        break
        case 411:
            layer.fill(100,125,150,fade)
        ...
        case 415:
            ...
            for(let b=0,lb=3;b<lb;b++){
                ...
                for(let a=0,la=6;a<la;a++){
                    layer.rotate(60)
                    layer.triangle(4,0,0,-1,0,1)
                }
                layer.rect(0,-4.5,3,1)
                layer.translate(sin(b*120)*-5,cos(b*120)*-5)
            }
        break
        case 417:
        ...
        case 422:
            layer.fill(150,175,200,fade)
			layer.triangle(-2,-3,2,-3,0,-6)
			layer.arc(0,-3,4,16,0,180)
            layer.triangle(-7,-3,-3,-3,-5,-6)
			layer.arc(-5,-3,4,16,0,180)
            layer.triangle(3,-3,7,-3,5,-6)
			layer.arc(5,-3,4,16,0,180)
        break
        case 423:
            layer.fill(255,200,0,fade)
        ...
        break
        case 425:
            layer.fill(200,100,255,fade*0.6)
            layer.quad(-8,0,-6,-4,-4,0,-6,4)
            layer.quad(-5,0,-3,-5,-1,0,-3,5)
            layer.quad(-2,0,0,-6,2,0,0,6)
            layer.quad(1,0,3,-5,5,0,3,5)
        ...
        case 436:
            ...
            layer.rect(-1.5,3,6,4)
            layer.arc(1.5,3,9,4,-90,90)
            layer.triangle(0,-5.5,-3,-5.5,-3,-8.5)
            layer.triangle(0,5.5,-3,5.5,-3,8.5)
        break
        case 437:
            layer.fill(240,240,40,fade)
        ...
        case 444:
            ...
            layer.triangle(-4.5,-1.5,1.5,-1.5,3,-4.5)
            layer.triangle(-4.5,1.5,1.5,1.5,3,4.5)
        break
        case 445:
            layer.fill(255,50,50,fade)
            layer.triangle(-2.5,0,-4.5,-2,-4.5,2)
            layer.rect(-0.5,0,4,6)
            layer.arc(1.5,0,9,6,-90,90)
        break
        case 446:
            layer.fill(255,50,50,fade)
            layer.rect(-1,0,4,4)
            layer.arc(1,0,6,4,-90,90)
            layer.triangle(4.5,-1,4.5,1,6,0)
            layer.triangle(-4.5,-1,-4.5,1,-6,0)
            layer.triangle(-1,4.5,1,4.5,0,6)
            layer.triangle(-1,-4.5,1,-4.5,0,-6)
        break
        case 447:
            layer.fill(255,50,50,fade)
            layer.rect(-5.25,0,2.5,3)
            layer.rect(-2.25,0,2.5,3)
            layer.triangle(6,0,-1,-4,-1,4)
        break
        case 448:
            layer.fill(255,50,50,fade)
            layer.triangle(-1,-3,-3,-3,-1,3)
            layer.arc(-2.25,-6,3,3,-270,-90)
            layer.fill(0,150,255,fade)
            layer.beginShape()
            layer.vertex(-1,-3)
            layer.vertex(1,-3)
        ...
        case 450:
            ...
            layer.beginShape()
            layer.vertex(-7.75,-5)
            layer.vertex(-10,0.75)
            layer.vertex(-7.75,0.75)
            layer.vertex(-8.25,5)
            layer.vertex(-6,-0.75)
            layer.vertex(-8.25,-0.75)
            layer.endShape()
        break
        case 451:
            layer.fill(255,50,50,fade)
        ...
        case 472:
            layer.fill(200,fade)
            layer.stroke(120,135,150,fade)
            layer.strokeWeight(1)
            layer.rect(0,0,6,8,1)
        break
        case 473:
            layer.fill(200,fade)
            layer.stroke(255,175,255,fade)
            layer.strokeWeight(1)
            layer.rect(0,0,6,8,1)
        break
        case 474:
    ...
    if(info){
        switch(type){
            ...
            break
            case 190: case 269: case 379: case 434: case 435: case 448: case 476:
            ...
            break
            case 348:
                layer.text(`${effect[0]}x2|${effect[1]}|${effect[2]}`,0,0)
            break
            case 360:
...
function displaySymbol(layer,x,y,type,direction,size,fade){
    ...
    switch(type){
        ...
        case 18:
            layer.stroke(150,0,0,fade)
            layer.strokeWeight(1)
            regStar(layer,0,0,8,10,10,5,5,0)
        break
        case 19:
            layer.stroke(150,175,200,fade)
            layer.strokeWeight(1.5)
        ...
        case 29:
            ...
            layer.beginShape()
            layer.vertex(-6,4.5)
            layer.vertex(-10.5,1.125)
            layer.vertex(-5.25,1.5)
            layer.vertex(-4.125,-5.25)
            layer.vertex(-1.875,-0.75)
            layer.vertex(-0,-7.5)
            layer.vertex(1.875,-0.25)
            layer.vertex(4.125,-5.25)
            layer.vertex(5.25,1.5)
            layer.vertex(10.5,1.125)
            layer.vertex(6,4.5)
