class combatantManager{
    ...
    bossHeal(){
        for(let a=0,la=this.combatants.length;a<la;a++){
            if(this.combatants[a].team>0&&!this.combatants[a].construct&&!this.combatants[a].support){
                this.combatants[a].healLifable(
                    game.diff>=3?
                    (this.combatants[a].base.life-this.combatants[a].life)*0.5:
                    game.ascend>=5?
                    (this.combatants[a].base.life-this.combatants[a].life)*0.75:
                    (this.combatants[a].base.life-this.combatants[a].life))
            }
        }
    }
    equalize(){
    ...
    targetCombatants(){
        for(let a=0,la=this.combatants.length;a<la;a++){
            ...
            if(
                (
                    this.battle.attackManager.targetInfo[0]==2||this.battle.attackManager.targetInfo[0]==3||this.battle.attackManager.targetInfo[0]==5||this.battle.attackManager.targetInfo[0]==10||this.battle.attackManager.targetInfo[0]==11||this.battle.attackManager.targetInfo[0]==22||this.battle.attackManager.targetInfo[0]==26||this.battle.attackManager.targetInfo[0]==30||this.battle.attackManager.targetInfo[0]==40||this.battle.attackManager.targetInfo[0]==52||
                    this.battle.attackManager.targetInfo[0]==53||this.battle.attackManager.targetInfo[0]==62||this.battle.attackManager.targetInfo[0]==63||this.battle.attackManager.targetInfo[0]==64||this.battle.attackManager.targetInfo[0]==67||this.battle.attackManager.targetInfo[0]==73||this.battle.attackManager.targetInfo[0]==74
                )&&
                this.combatants[a].life>0&&(this.combatants[a].team!=this.combatants[this.battle.attackManager.user].team||(this.battle.attackManager.targetInfo[0]==10||this.battle.attackManager.targetInfo[0]==26||this.battle.attackManager.targetInfo[0]==64||this.battle.attackManager.targetInfo[0]==73)&&this.combatants[a].tilePosition.x==this.battle.attackManager.tilePosition.x&&this.combatants[a].tilePosition.y==this.battle.attackManager.tilePosition.y)&&
                ...
                !(this.battle.attackManager.targetInfo[0]==73&&(this.combatants[a].tilePosition.x!=this.battle.attackManager.tilePosition.x||this.combatants[a].tilePosition.y!=this.battle.attackManager.tilePosition.y))&&
                ...
                (this.battle.attackManager.targetInfo[0]==10||this.battle.attackManager.targetInfo[0]==26||this.battle.attackManager.targetInfo[0]==64||this.battle.attackManager.targetInfo[0]==73)&&this.combatants[a].tilePosition.x==this.battle.attackManager.tilePosition.x&&this.combatants[a].tilePosition.y==this.battle.attackManager.tilePosition.y)
            ){
                this.subTarget(a)
            }
            if(
    ...
    numberAbstract(type,args){
        ...
        for(let a=0,la=this.combatants.length;a<la;a++){
            if(
                ...
                type==4&&this.combatants[a].intent>=0&&this.combatants[a].attack.length>0&&types.attack[this.combatants[a].attack[this.combatants[a].intent].type].class==args[0]||
