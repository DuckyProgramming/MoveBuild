        ...
        switch(this.type){
            ...
            case 2:
                switch(this.args[0]){
                    ...
                    case 108: case 109: case 110: case 113: case 115: case 116: case 117:
            ...
            switch(this.type){
                ...
                case 2:
                    switch(this.args[0]){
                        ...
                        case 107: case 108: case 109: case 110: case 113: case 116: case 117:
            ...
            switch(this.type){
                ...
                case 2:
                    if(this.args[0]==24){
                        ...
                        if(pointInsideBox({position:inputs.rel},{position:{x:this.layer.width/2-285,y:this.layer.height/2},width:40,height:40})&&this.page>0){
                            ...
                            this.page<ceil(this.battle.cardManagers[this.player].deck.cards.length/15)-1&&(
                                ...
                                this.args[0]==110||this.args[0]==113||this.args[0]==116||this.args[0]==117
                            )||
                    ...
                    switch(this.args[0]){
                        ...
                        case 109: case 110: case 113: case 115: case 116: case 117:
                            switch(this.args[0]){
