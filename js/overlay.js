    ...
    constructor(layer,battle,player,type,args){
        ...
        switch(this.type){
            ...
            case 2:
                this.page=0
                switch(this.args[0]){
                    case 3: case 17: case 43: case 75: case 77: case 91: case 116: case 117: case 122:
        ...
        switch(this.type){
            ...
            case 2:
                switch(this.args[0]){
                    ...
                    case 95: case 96: case 100: case 103: case 104: case 105: case 114: case 119: case 120: case 124:
                    case 127:
                    ...
                    case 46: case 52: case 77: case 79: case 99: case 101: case 102: case 111: case 112: case 121:
                    case 128:
                    ...
                    case 108: case 109: case 110: case 113: case 115: case 116: case 117: case 118: case 122: case 123:
                    case 125: case 126:
                ...
                switch(this.args[0]){
                    ...
                    case 67: case 81: case 82: case 87: case 90: case 92: case 93: case 98: case 119: case 121:
                    case 124:
                        this.activated=0
                    break
                    case 20: case 60: case 80: case 96: case 105: case 123: case 125:
                        this.args[1]=args[0]
                    break
                    ...
                    break
                    case 43: case 75: case 89: case 116: case 117: case 122:
                        this.card=new card(this.layer,this.battle,this.player,-100,-100,0,0,0,0)
                        this.card.nonCalc=true
                    break
                    ...
                    case 0:
                        for(let a=0,la=this.args[1];a<la;a++){
                            ...
                            switch(this.cards[a].attack){
                                ...
                                break
                                case 8354:
                                    this.cards[a].attack=[-1086,-1001][a]
                                break
                                case 8355:
                                ...
                                break
                                case 9949:
                                    this.cards[a].attack=[-1090,-1013][a]
                                break
                            }
                        }
                    break
            ...
            case 30:
                ...
                for(let a=0,la=6;a<la;a++){
                    ...
                    switch(a){
                        ...
                        break
                        case 3:
                            type=randin(this.battle.cardManagers[this.player].listing.card[constants.playerNumber+2][3])
                        break
                        case 4:
                            type=randin(this.battle.cardManagers[this.player].listing.card[0][0])
                        break
                        case 5:
                            type=randin(this.battle.cardManagers[this.player].listing.card[constants.playerNumber+5][3])
                        break
                    }
                    this.cards.push(new card(this.layer,this.battle,this.player,0,0,type,0,this.battle.standardColorize(type),0))
                }
                this.sets=[]
                for(let a=0,la=6;a<la;a++){
                    this.sets.push(a,a)
            ...
            break
            case 31:
                let set=this.battle.relicManager.makeRelicSelection(args)
                this.relics=[]
                for(let a=0,la=set.length;a<la;a++){
                    this.relics.push(new relic(this.layer,this.battle,this.player,this.layer.width/2-la*30+30+a*60,this.layer.height/2,set[a],1))
                }
            break
        ...
        switch(this.type){
            case 1:
                switch(args.type){
                    ...
                    break
                    case 6:
                        this.battle.nodeManager.freeMove[0]=1
                    break
                    case 7:
                ...
                switch(this.args[0]){
                    case 0:
                        ...
                        switch(args[0].attack){
                            ...
                            case -1086:
                                this.card.costDown(0,[3])
                                userCombatant.statusEffect('Take Half Damage',args[0].effect[1])
                            break
                            case -1087:
                                this.card.costDown(0,[3])
                                for(let a=0,la=args[0].effect[2];a<la;a++){
                            ...
                            case -1090:
                                this.card.costDown(0,[4])
                                for(let a=0,la=args[0].effect[1];a<la;a++){
                                    this.battle.cardManagers[this.player].hand.add(findName('Protocol',types.card),0,0)
                                }
                                this.battle.cardManagers[this.player].draw(args[0].effect[2])
                            break
                        }
        ...
        switch(this.type){
            ...
            case 2:
                switch(this.args[0]){
                    ...
                    case 5: case 121: case 128: this.title='Put a Card From Discard Pile in Hand'; break
                    case 6: case 25: case 105: case 119: this.title='Put a Card From Draw Pile in Hand'; break
                    ...
                    case 43: case 116: case 122: this.title='Reduce the Cost of a Card by 1'; break
                    ...
                    case 125: this.title=`Make a Duplicate Card ${this.args[1]==4?`Polychrome`:`Negative`}`; break
                    case 126: this.title='Make a Card Common'; break
                    case 127: this.title='Put a Card From Draw Pile in Hand and Make it Foil'; break
                ...
                switch(this.args[0]){
                    ...
                    case 114: case 119: case 120: case 127:
                ...
                switch(this.args[0]){
                    ...
                    case 74: case 94: case 95: case 96: case 100: case 103: case 104: case 114: case 120: case 122:
                    case 127:
                    ...
                    case 90: case 91: case 106: case 107: case 108: case 109: case 110: case 113: case 116: case 117:
                    case 118: case 125: case 126:
                    ...
                    case 119: this.battle.cardManagers[this.player].reserve.display('overlay',[10,this.page,2]); break
                    case 121: this.battle.cardManagers[this.player].discard.display('overlay',[14,this.page,0]); break
                    case 123: this.battle.cardManagers[this.player].deck.display('overlay',[15,this.page,this.args[1]]); break
                    case 124: this.battle.cardManagers[this.player].reserve.display('overlay',[16,this.page]); break
                    case 128: this.battle.cardManagers[this.player].discard.display('overlay',[17,this.page,this.args[3]]); break

                }
                switch(this.args[0]){
                    case 3: case 17: case 43: case 75: case 77: case 89: case 91: case 100: case 101: case 116:
                    case 117: case 122:
                        this.card.fade=1
            ...
            case 3:
                this.layer.fill(160,this.fade*0.8)
                if(this.options>=12){
                    this.layer.rect(this.layer.width/2,this.layer.height/2,max(175,ceil(this.options/3)*100+40),460,10)
                }else if(this.options>=8){
                ...
                if(this.battle.relicManager.hasRelic(173,this.player)){
                    this.layer.rect(this.layer.width/2,this.layer.height/2+170+offset,120,40,10)
                }
                this.layer.fill(0,this.fade*0.8)
                this.layer.textSize(30)
                switch(this.args[0]){
                ...
                if(!this.battle.modded(83)){
                    ...
                    if(this.args[0]==0){
                        ...
                        if(this.battle.relicManager.hasRelic(521,this.player)){
                            bonuses.push('Potential Edition')
                        }
                    }
                    this.layer.textSize(8)
                    if(bonuses.length>=2){
                        this.layer.text('Multiple Bonuses',this.layer.width/2,this.layer.height/2+140+offset)
                    }else if(bonuses.length>=1){
                        this.layer.text(bonuses[0],this.layer.width/2,this.layer.height/2+140+offset)
                    }
                }
                if(this.battle.relicManager.hasRelic(173,this.player)){
                    this.layer.textSize(20)
                    this.layer.text('Select All',this.layer.width/2,this.layer.height/2+170+offset)
                }
                for(let a=0,la=this.cards.length;a<la;a++){
                    this.cards[a].fade=1
            ...
            break
            case 12:
                let len=this.battle.nodeManager.listing.static[this.world][2].length
                this.layer.fill(160,this.fade*0.8)
                this.layer.rect(this.layer.width/2,this.layer.height/2-150+len*20,300,50+len*40,10)
                this.layer.rect(this.layer.width/2,this.layer.height/2-205,120,40,10)
                this.layer.fill(0,this.fade*0.8)
                this.layer.textSize(30)
            ...
            case 21:
                ...
                let jump=0
                for(let a=0,la=constants.playerNumber;a+jump<la;a++){
                    ...
                    this.layer.fill(0,this.fade)
                    this.layer.textSize(15)
                    this.layer.text(types.combatant[a+1+jump].name,this.layer.width/2-300+a%5*150,this.layer.height/2-80+floor(a/5)*40)
                    /*if(a+1==this.battle.player[this.player]){
                        jump++
            ...
            case 30:
                this.layer.fill(160,this.fade*0.8)
                this.layer.rect(this.layer.width/2,this.layer.height/2-20,410,440,10)
                this.layer.rect(this.layer.width/2-85,this.layer.height/2+225,40,40,10)
                this.layer.rect(this.layer.width/2+85,this.layer.height/2+225,40,40,10)
                this.layer.rect(this.layer.width/2-130,this.layer.height/2+225,40,40,10)
                this.layer.rect(this.layer.width/2+130,this.layer.height/2+225,40,40,10)
                ...
                this.layer.fill(0,this.fade*0.8)
                this.layer.textSize(30)
                this.layer.text('Match Cards',this.layer.width/2,this.layer.height/2-210)
                this.layer.textSize(20)
                this.layer.text('Exit',this.layer.width/2,this.layer.height/2+225)
                this.layer.textSize(15)
                this.layer.text(`${this.picks} Pick${pl(this.picks)} Left`,this.layer.width/2+150,this.layer.height/2-210)
                this.cards.forEach(card=>{
                    card.fade=1
                    card.anim={select:0,afford:1}
                })
                for(let a=0,la=this.sets.length;a<la;a++){
                    this.layer.push()
                    this.layer.translate(this.layer.width/2-150+a%4*100,this.layer.height/2-130+floor(a/4)%3*130)
                    this.cards[this.sets[a]].display()
                    this.layer.fill(0,this.fade)
                    this.layer.rect(0,0,95*this.fades[a],125*this.fades[a],10*this.fades[a])
                    this.layer.pop()
                }
            break
            case 31:
                this.layer.fill(160,this.fade*0.8)
                this.layer.rect(this.layer.width/2,this.layer.height/2,10+this.relics.length*60,70,10)
                this.layer.rect(this.layer.width/2,this.layer.height/2+60,120,40,10)
                this.layer.fill(0,this.fade*0.8)
                this.layer.textSize(20)
                this.layer.text('Close',this.layer.width/2,this.layer.height/2+60)
                this.relics.forEach(relic=>{
                    relic.fade=this.fade
                    relic.display(0)
                    relic.displayInfo()
                    relic.update(true,0,inputs)
                })
            break
            ...
            switch(this.type){
                ...
                case 2:
                    switch(this.args[0]){
                        ...
                        case 63: case 74: case 94: case 95: case 96: case 100: case 103: case 104: case 114: case 119:
                        case 120: case 122: case 127:
                        ...
                        case 107: case 108: case 109: case 110: case 113: case 116: case 117: case 118: case 125: case 126:
                        ...
                        break
                        case 13: case 14: case 15: case 16: case 62: case 124:
                        ...
                        break
                        case 53: case 54: case 55: case 56: case 61: case 75: case 123:
                        ...
                        break
                        case 121: case 128:
                            this.page=constrain(this.page,0,ceil(this.battle.cardManagers[this.player].discard.finalPosition/15)-1)
                        break
                    }
                    switch(this.args[0]){
                        case 0: case 6: case 9: case 13: case 14: case 15: case 16: case 18: case 20: case 22:
                        case 23: case 25: case 30: case 41: case 44: case 45: case 47: case 48: case 49: case 58:
                        case 59: case 60: case 62: case 63: case 73: case 74: case 80: case 84: case 85: case 94:
                        case 95: case 96: case 100: case 103: case 104: case 105: case 114: case 119: case 120: case 122:
                        case 124: case 127:
                        ...
                        case 68: case 69: case 70: case 72: case 75: case 76: case 78: case 81: case 82: case 83:
                        case 86: case 87: case 89: case 90: case 91: case 92: case 93: case 98: case 106: case 107:
                        case 108: case 109: case 110: case 113: case 115: case 116: case 117: case 118: case 123: case 125:
                        case 126:
                ...
                case 30:
                    if(this.timer>0){
                        this.timer--
                        if(this.timer<=0){
                            if(this.sets[this.pick[0]]==this.sets[this.pick[1]]){
                                let card=this.cards[this.sets[this.pick[0]]]
                                this.battle.cardManagers[this.player].deck.add(card.type,card.level,card.color,card.edition)
                                card.deSize=true
                                this.held.push(...this.pick)
                            }
                            this.pick=[]
                            this.picks--
                            if(this.picks<=0){
                    ...
                    for(let a=0,la=this.fades.length;a<la;a++){
                        this.fades[a]=smoothAnim(this.fades[a],!this.pick.includes(a)&&!this.held.includes(a),0,1,5)
                    }
                    for(let a=0,la=this.cards.length;a<la;a++){
                        this.cards[a].size=smoothAnim(this.cards[a].size,!this.cards[a].deSize,0,1,5)
                    }
                break
            }
        }else if(!this.active){
            ...
            switch(this.type){
                ...
                case 2:
                    if(this.args[0]==24){
                        ...
                        if(pointInsideBox({position:inputs.rel},{position:{x:this.layer.width/2-285,y:this.layer.height/2},width:40,height:40})&&this.page>0){
                            ...
                            this.page<ceil(this.battle.cardManagers[this.player].reserve.cards.length/15)-1&&(
                                ...
                                this.args[0]==103||this.args[0]==104||this.args[0]==114||this.args[0]==122||this.args[0]==124||
                                this.args[0]==127
                            )||
                            ...
                            this.page<ceil(this.battle.cardManagers[this.player].deck.cards.length/15)-1&&(
                                ...
                                this.args[0]==110||this.args[0]==113||this.args[0]==116||this.args[0]==117||this.args[0]==118||
                                this.args[0]==120||this.args[0]==123||this.args[0]==125||this.args[0]==126
                            )||
                            ...
                            this.page<ceil(this.battle.cardManagers[this.player].reserve.finalPosition/15)-1&&(
                                this.args[0]==119
                            )||
                            this.page<ceil(this.battle.cardManagers[this.player].discard.finalPosition/15)-1&&(
                                this.args[0]==121||this.args[0]==128
                            )
                        )){
                            this.page++
                    ...
                    switch(this.args[0]){
                        ...
                        case 109: case 110: case 113: case 115: case 116: case 117: case 118: case 123: case 125: case 126:
                            switch(this.args[0]){
                                case 3: case 17: case 43: case 75: case 89: case 91: case 116: case 117:
                                    this.card=new card(this.layer,this.battle,this.player,-100,-100,0,0,variants.mtg?[]:0,0)
                                break
                            }
                            for(let a=0,la=this.battle.cardManagers[this.player].deck.cards.length;a<la;a++){
                                ...
                                if(pointInsideBox({position:inputs.rel},base)&&base.size>0.5&&base.select&&!base.spec.includes(81)&&
                                    ...
                                    !((this.args[0]==43||this.args[0]==116)&&base.base.cost<=0)&&
                                    !(this.args[0]==36&&base.rarity!=0)&&
                                    !((this.args[0]==50||this.args[0]==66)&&!base.basic)&&
                                    !(this.args[0]==51&&base.colorless())&&
                                    ...
                                    switch(this.args[0]){
                                        ...
                                        case 4: case 67: case 81: case 87: case 92: case 98:
                                            ...
                                            if(this.battle.cardManagers[this.player].deck.remove(a)){
                                                ...
                                                switch(this.args[2]){
                                                    case 1:
                                                        this.battle.eventManagers[this.player].page=cardClass==6?7:basic?3:rarity==2?6:rarity==1?5:4
                                                    break
                                                    case 2:
                                                    ...
                                                    break
                                                    case 5:
                                                        if(base.rarity>=0&&base.rarity<=3&&base.list>=0){
                                                            this.battle.overlayManager.overlays[3][this.player].active=true
                                                            this.battle.overlayManager.overlays[3][this.player].activate([0,[14,base.list,base.rarity],57,[],[]])
                                                        }else if(base.rarity==-2){
                                                            this.battle.overlayManager.overlays[3][this.player].active=true
                                                            this.battle.overlayManager.overlays[3][this.player].activate([0,[15,['Filler','Strike','Defend','Step','Bash','Shield']],57,[],[]])
                                                        }
                                                    break
                                                }
                                            }else{
                                        ...
                                        case 116:
                                            base.costDown(3,[1])
                                            this.battle.cardManagers[this.player].deck.costDownListing.push(base.id)
                                            this.battle.overlayManager.overlays[177][this.player].active=true
                                            this.battle.overlayManager.overlays[177][this.player].activate()
                                        break
                                        case 117:
                                            base.costUp(3,[1])
                                        break
                                        ...
                                        break
                                        case 125:
                                            if(this.battle.cardManagers[this.player].deck.cards.some((card,index)=>
                                                card.name==this.battle.cardManagers[this.player].deck.cards[a].name&&index!=a
                                            )){
                                                la--
                                                a--
                                                base.edition=this.args[1]
                                            }else{
                                                complete=false
                                            }
                                        break
                                    ...
                                    if(pointInsideBox({position:inputs.rel},base)&&base.size>0.5&&this.active&&!base.spec.includes(81)&&
                                        ...
                                        switch(this.args[0]){
                                            ...
                                            case 117:
                                                ...
                                                this.card.page=this.page
                                                this.card.size=1
                                                this.card.costUp(3,[1])
                                                this.card.anim.costUp=1
                                            break
                        ...
                        case 52: case 77: case 79: case 99: case 101: case 102: case 111: case 112: case 121: case 128:
                            switch(this.args[0]){
                                case 77: case 101:
                                    this.card=new card(this.layer,this.battle,this.player,-100,-100,0,0,variants.mtg?[]:0,0)
                                break
                        ...
                        case 103: case 104: case 114: case 119: case 120: case 122: case 124: case 127:
                            for(let a=0,la=this.battle.cardManagers[this.player].reserve.cards.length;a<la;a++){
                                switch(this.args[0]){
                                    case 100: case 122:
                                        this.card=new card(this.layer,this.battle,this.player,-100,-100,0,0,variants.mtg?[]:0,0)
                                ...
                                if(
                                    ...
                                    !(this.args[0]==122&&this.battle.cardManagers[this.player].reserve.cards[a].base.cost<=0)
                                ){
                                    this.battle.cardManagers[this.player].reserve.cards[a].select=false
                                    let complete=true
                                    switch(this.args[0]){
                                        case 6: case 13: case 14: case 15: case 16: case 62: case 119: case 124:
                                            if(this.args[1]==1){
                                        ...
                                        break
                                        case 122:
                                            this.battle.cardManagers[this.player].reserve.cards[a].costDown(3,[1])
                                            this.battle.cardManagers[this.player].reserve.costDownListing.push(this.battle.cardManagers[this.player].reserve.cards[a].id)
                                        break
                                        case 127:
                                            this.battle.cardManagers[this.player].reserve.send(this.battle.cardManagers[this.player].hand.cards,a,a+1,1)
                                            this.battle.cardManagers[this.player].hand.cards[this.battle.cardManagers[this.player].hand.cards.length-1].edition=2
                                ...
                                if(a>=0&&a<la&&this.activeTimer<=0){
                                    ...
                                    if(
                                        ...
                                        switch(this.args[0]){
                                            ...
                                            break
                                            case 122:
                                                this.card=copyCard(this.battle.cardManagers[this.player].reserve.cards[a])
                                                this.card.nonCalc=true
                                                this.card.page=this.page
                                                this.card.size=1
                                                this.card.costDown(3,[1])
                        ...
                        if((pointInsideBox({position:inputs.rel},this.cards[a])||this.battle.relicManager.hasRelic(173,this.player)&&pointInsideBox({position:inputs.rel},{position:{x:this.layer.width/2,y:this.layer.height/2+170+(this.options>=8?75:0)},width:120,height:40}))&&!this.cards[a].deSize){
                            ...
                            for(let b=0,lb=lists.length;b<lb;b++){
                                if(this.setupArgs[2]==50){
                                    ...
                                    }else if(this.setupArgs[3].includes(5)){
                                        this.battle.cardManagers[this.player][lists[b]].addAbstract(this.cards[a].type,this.cards[a].level,this.cards[a].color,this.cards[a].edition,[4],[[1,2,4]])
                                    }else if(this.setupArgs[3].includes(6)){
                                        this.battle.cardManagers[this.player][lists[b]].addAbstract(this.cards[a].type,this.cards[a].level,this.cards[a].color,this.cards[a].edition,[4],[[1,4,57]])
                                    }else if(this.setupArgs[1][0]==14||this.setupArgs[1][0]==15){
                                        this.battle.cardManagers[this.player][lists[b]].addAbstract(this.cards[a].type,this.cards[a].level,this.cards[a].color,this.cards[a].edition,[],[])
                                    }else{
                ...
                case 21:
                    ...
                    for(let a=0,la=constants.playerNumber;a+jump<la;a++){
                        ...
                        if(pointInsideBox({position:inputs.rel},{position:{x:this.layer.width/2-300+a%5*150,y:this.layer.height/2-80+floor(a/5)*40},width:160,height:30})/*&&a+1!=this.battle.player[this.player]*/){
                            ...
                            switch(this.args[0]){
                                case 0:
                                    this.battle.relicManager.detail[458][this.player].push(a+1+jump)
                                break
                            }
                        }
                    }
                ...
                case 30:
                    for(let a=0,la=this.sets.length;a<la;a++){
                        if(pointInsideBox({position:inputs.rel},{position:{x:this.layer.width/2-150+a%4*100,y:this.layer.height/2-130+floor(a/4)%3*130},width:90,height:120})){
                            if(!this.pick.includes(a)&&!this.held.includes(a)&&this.pick.length<2){
                                this.pick.push(a)
                    ...
                    if(pointInsideBox({position:inputs.rel},{position:{x:this.layer.width/2,y:this.layer.height/2+125},width:120,height:40})&&this.timer<=0){
                        this.active=false
                        this.cards.forEach(card=>card.deSize=true)
                    }
                break
                case 31:
                    this.relics.forEach(relic=>{
                        if(dist(inputs.rel.x,inputs.rel.y,relic.position.x,relic.position.y)<20){
                            this.battle.relicManager.addRelic(relic.type,this.player)
                            this.active=false
                        }
                    })
                    if(pointInsideBox({position:inputs.rel},{position:{x:this.layer.width/2,y:this.layer.height/2+60},width:120,height:40})){
    ...
    onKey(key,code){
        if(this.active&&this.activeTimer<=0){
            switch(this.type){
                ...
                case 3:
                    for(let a=0,la=this.cards.length;a<la;a++){
                        if((key==inputs.hexadec[a]||this.battle.relicManager.hasRelic(173,this.player)&&(key=='t'||key=='T'))&&!this.cards[a].deSize){
                            if(this.setupArgs[2]==22){
                                this.battle.combatantManager.combatants[this.battle.combatantManager.getPlayerCombatantIndex(this.player)].statusEffect(['Strength','Dexterity'][a%2],this.setupArgs[4+a%2])
                            }
                            let lists=[]
