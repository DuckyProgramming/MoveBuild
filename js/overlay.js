            ...
            switch(this.type){
                ...
                case 2:
                    switch(this.args[0]){
                        ...
                        case 107: case 108: case 109: case 110: case 113: case 116: case 117: case 118: case 125:
            ...
            switch(this.type){
                ...
                case 2:
                    if(this.args[0]==24){
                        ...
                        if(pointInsideBox({position:inputs.rel},{position:{x:this.layer.width/2-285,y:this.layer.height/2},width:40,height:40})&&this.page>0){
                            ...
                            this.page<ceil(this.battle.cardManagers[this.player].reserve.cards.length/15)-1&&(
                                ...
                                this.args[0]==103||this.args[0]==104||this.args[0]==114||this.args[0]==122
                            )||
                    ...
                    switch(this.args[0]){
                        ...
                        case 109: case 110: case 113: case 115: case 116: case 117: case 118: case 123: case 125:
                            switch(this.args[0]){
                        ...
                        case 103: case 104: case 114: case 119: case 120: case 122: case 124:
                            for(let a=0,la=this.battle.cardManagers[this.player].reserve.cards.length;a<la;a++){
                                switch(this.args[0]){
                                    case 100: case 122:
                                        this.card=new card(this.layer,this.battle,this.player,-100,-100,0,0,variants.mtg?[]:0,0)
