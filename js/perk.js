class perk{
    ...
    display(){
        ...
        let color=mergeColor([25,25,25],[50,255,50],this.anim.complete)
        switch(this.type){
            case 0:
            ...
            case 1:
                ...
                this.layer.text('200 Currency',0,60-this.player*120)
            break
            case 2:
                this.layer.stroke(...color,this.fade)
                this.layer.strokeWeight(3)
            ...
            case 16:
                ...
                this.layer.fill(...color,this.fade*max(this.anim.complete,this.anim.description))
                this.layer.textSize(24)
                this.layer.text('Full Items',0,60-this.player*120)
            break
            case 17:
                this.layer.stroke(...color,this.fade)
                this.layer.strokeWeight(3)
                this.layer.noFill()
                this.layer.ellipse(0,0,75,75)
                this.layer.ellipse(-15,5,10)
                this.layer.ellipse(15,5,10)
                this.layer.line(-7.5,-2.5,-20,-7.5)
                this.layer.line(7.5,-2.5,20,-7.5)
                this.layer.line(0,-37.5,4,-27.5)
                this.layer.line(-6,-22.5,4,-27.5)
                this.layer.line(-6,-22.5,-4,-12.5)
                this.layer.line(2,-32.5,10,-30)
                this.layer.line(10,-30,8,-20)
                this.layer.line(-2,-24.5,-10,-29.5)
                this.layer.line(-12,-22,-10,-29.5)
                this.layer.noStroke()
                this.layer.fill(...color,this.fade*max(this.anim.complete,this.anim.description))
                this.layer.textSize(24)
                this.layer.text('Weak Elite',0,60-this.player*120)
            break
            case 18:
                this.layer.stroke(...color,this.fade)
                this.layer.strokeWeight(3)
                this.layer.noFill()
                this.layer.ellipse(-24,-15,36,36)
                this.layer.ellipse(12,-15,36,36)
                this.layer.ellipse(-24,-15,6,6)
                this.layer.ellipse(12,-15,6,6)
                this.layer.line(-36,3,24,3)
                this.layer.line(-36,3,-36,33)
                this.layer.line(24,3,24,33)
                this.layer.line(-36,33,24,33)
                this.layer.line(24,7,36,3)
                this.layer.line(24,29,36,33)
                this.layer.line(36,3,36,33)
                for(let a=0,la=5;a<la;a++){
                    let dir=a/la*360+44
                    this.layer.line(-24+lsin(dir)*7.5,-15+lcos(dir)*7.5,-24+lsin(dir)*13.5,-15+lcos(dir)*13.5)
                    dir=a/la*360+4
                    this.layer.line(12+lsin(dir)*7.5,-15+lcos(dir)*7.5,12+lsin(dir)*13.5,-15+lcos(dir)*13.5)
                }
                this.layer.noStroke()
                this.layer.fill(...color,this.fade*max(this.anim.complete,this.anim.description))
                this.layer.textSize(24)
                this.layer.text('Pick Boss',0,60-this.player*120)
            break
            case 19:
                this.layer.stroke(...color,this.fade)
                this.layer.strokeWeight(3)
                this.layer.noFill()
                this.layer.rect(0,0,60,80,5)
                this.layer.quad(-22,0,0,-27.5,22,0,0,27.5)
                this.layer.beginShape()
                this.layer.vertex(-10,0)
                this.layer.vertex(-4,0)
                this.layer.vertex(-4,-10)
                this.layer.vertex(4,-10)
                this.layer.vertex(4,0)
                this.layer.vertex(10,0)
                ...
                this.layer.fill(...color,this.fade*max(this.anim.complete,this.anim.description))
                this.layer.textSize(24)
                this.layer.text('Cheapen',0,60-this.player*120)
            break
            case 20:
                this.layer.stroke(...color,this.fade)
                this.layer.strokeWeight(3)
                ...
                plus(this.layer,10)
                this.layer.translate(-80,-80)
                this.layer.rect(-20,-80/3,20,80/3,5/3)
                this.layer.rect(0,-80/3,20,80/3,5/3)
                this.layer.rect(20,-80/3,20,80/3,5/3)
                this.layer.rect(-20,0,20,80/3,5/3)
                this.layer.rect(0,0,20,80/3,5/3)
                this.layer.rect(20,0,20,80/3,5/3)
                this.layer.rect(-20,80/3,20,80/3,5/3)
                this.layer.rect(0,80/3,20,80/3,5/3)
                this.layer.rect(20,80/3,20,80/3,5/3)
