        ...
        case 'Menessa':
            ...
            switch(type){
                ...
                case 2:
                    ...
                    this.layer.rotate(-150)
                    this.layer.quad(0,0,1.6,-0.8,1.28,0,1.6,0.8)
                    this.layer.rotate(150)
                    this.layer.quad(0,0,1.6,-0.8,1.28,0,1.6,0.8)
                    ...
                    this.layer.rotate(-150)
                    this.layer.quad(0,0,1.44,-0.4,1.28,0,1.44,0.4)
                    this.layer.rotate(150)
                    this.layer.quad(0,0,1.44,-0.4,1.28,0,1.44,0.4)
                    ...
                    this.layer.image(graphics.minor[40],-1.2,-1.2,2.4,2.4)
                    this.layer.pop()
                break
            }
        break
