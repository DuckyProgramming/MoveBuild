combatant.prototype.setupGraphics=function(direction){
    switch(this.name){
        ...
        case 'Meri':
            ...
            this.parts={eyeLevel:-75.75,mouth:-71.75,
                minor:15,
                legs:[
                    {top:{x:3,y:-32.5},middle:{x:0,y:0},bottom:{x:0,y:0}},
                    {top:{x:3,y:-32.5},middle:{x:0,y:0},bottom:{x:0,y:0}}
                ],arms:[
                    {top:{x:3.25,y:-57.5},middle:{x:0,y:0},bottom:{x:0,y:0}},
                    {top:{x:3.25,y:-57.5},middle:{x:0,y:0},bottom:{x:0,y:0}}
                ],}
        ...
        break
        case 'Menessa':
            if(graphics.combatant[12]==-1){
                setupCombatantGraphics(12)
                graphics.combatant.splice(12,1,graphics.combatant[graphics.combatant.length-1])
                delete graphics.combatant[graphics.combatant.length-1]
                graphics.combatant.splice(graphics.combatant.length-1,1)
            }
            ...
            this.spin={
                legs:[{top:-60,bottom:-120},{top:60,bottom:120}],
                arms:[{top:-93,bottom:-75,lock:0},{top:93,bottom:75,lock:0}],
                eye:[-18,18],button:0,mouth:27,
                hair:{bow:[-108,108],pin:54},bow:0}
            ...
            this.parts={eyeLevel:-77.25,mouth:-72.75,
                ...
                legs:[
                    ...
                    {top:{x:3.45,y:-58.5},middle:{x:0,y:0},bottom:{x:0,y:0}},
                    {top:{x:3.45,y:-58.5},middle:{x:0,y:0},bottom:{x:0,y:0}}
                ],}
...
combatant.prototype.minorDisplay=function(type,key){
    ...
    switch(this.name){
            ...
            switch(type){
                case 0:
                    ...
                    for(let a=0,la=set.length;a<la;a++){
                        this.layer.vertex(
                            this.graphics.arms[key].top.x*(1-set[a][0])+
                            this.graphics.arms[key].middle.x*set[a][0]+
                            (2.15+1.75*set[a][0])*set[a][1]*sin(dir+90),
                            this.graphics.arms[key].top.y*(1-set[a][0])+
                            this.graphics.arms[key].middle.y*set[a][0]+
                            (2.15+1.75*set[a][0])*set[a][1]*cos(dir+90)
                        )
                    }
                    this.layer.endShape()
                    this.layer.noStroke()
                    ...
                    for(let a=0,la=set.length;a<la;a++){
                        this.layer.vertex(
                            this.graphics.arms[key].top.x*(1-set[a][0])+
                            this.graphics.arms[key].middle.x*set[a][0]+
                            (2.2+2*set[a][0])*set[a][1]*sin(dir+90),
                            this.graphics.arms[key].top.y*(1-set[a][0])+
                            this.graphics.arms[key].middle.y*set[a][0]+
                            (2.2+2*set[a][0])*set[a][1]*cos(dir+90)
                        )
                    }
                    this.layer.endShape()
                break
        ...
        case 'Menessa':
            ...
            switch(type){
                case 0:
                    this.minorDisplay(5,key)

                    dir=atan2(this.graphics.arms[key].top.x-this.graphics.arms[key].middle.x,this.graphics.arms[key].top.y-this.graphics.arms[key].middle.y)
                    trig=[sin(dir+90),cos(dir+90)]
                    this.layer.ellipse(this.graphics.arms[key].middle.x,this.graphics.arms[key].middle.y,4.2)
                    this.layer.quad(
                        this.graphics.arms[key].middle.x-2.1*trig[0],
                        this.graphics.arms[key].middle.y-2.1*trig[1],
                        this.graphics.arms[key].middle.x+2.1*trig[0],
                        this.graphics.arms[key].middle.y+2.1*trig[1],
                        this.graphics.arms[key].top.x+2.2*trig[0],
                        this.graphics.arms[key].top.y+2.2*trig[1],
                        this.graphics.arms[key].top.x-2.2*trig[0],
                        this.graphics.arms[key].top.y-2.2*trig[1]
                    )
                    this.layer.fill(...this.flashColor(mergeColor(this.color.dress.sleeve,this.color.dress.sleeveOver,0.5)),this.fade*this.fades.dress.main*0.8)
                    for(let a=0,la=11;a<la;a++){
                        if(lcos(a/la*360+this.anim.direction)>0){
                            this.layer.quad(
                                this.graphics.arms[key].middle.x*0.1+this.graphics.arms[key].top.x*0.9+2.19*trig[0]*lsin(a/la*360+this.anim.direction),
                                this.graphics.arms[key].middle.y*0.1+this.graphics.arms[key].top.y*0.9+2.19*trig[1]*lsin(a/la*360+this.anim.direction),
                                this.graphics.arms[key].middle.x*0.5+this.graphics.arms[key].top.x*0.5+2.15*trig[0]*lsin(a/la*360+this.anim.direction)+trig[0]*lcos(a/la*360+this.anim.direction)*0.25,
                                this.graphics.arms[key].middle.y*0.5+this.graphics.arms[key].top.y*0.5+2.15*trig[1]*lsin(a/la*360+this.anim.direction)-trig[1]*lcos(a/la*360+this.anim.direction)*0.25,
                                this.graphics.arms[key].middle.x*0.9+this.graphics.arms[key].top.x*0.1+2.11*trig[0]*lsin(a/la*360+this.anim.direction),
                                this.graphics.arms[key].middle.y*0.9+this.graphics.arms[key].top.y*0.1+2.11*trig[1]*lsin(a/la*360+this.anim.direction),
                                this.graphics.arms[key].middle.x*0.5+this.graphics.arms[key].top.x*0.5+2.15*trig[0]*lsin(a/la*360+this.anim.direction)-trig[0]*lcos(a/la*360+this.anim.direction)*0.25,
                                this.graphics.arms[key].middle.y*0.5+this.graphics.arms[key].top.y*0.5+2.15*trig[1]*lsin(a/la*360+this.anim.direction)+trig[1]*lcos(a/la*360+this.anim.direction)*0.25,
                            )
                        }
                    ...
                    this.minorDisplay(9,key)
                break
                case 1:
                    this.minorDisplay(6,key)

                    dir=atan2(this.graphics.arms[key].top.x-this.graphics.arms[key].middle.x,this.graphics.arms[key].top.y-this.graphics.arms[key].middle.y)
                    this.layer.fill(...this.flashColor(mergeColor(this.color.dress.back,this.color.dress.main,0.25)),this.fade*this.fades.dress.sleeve)
                    this.layer.push()
                    this.layer.translate(
                        this.graphics.arms[key].middle.x*0.4+this.graphics.arms[key].top.x*0.6,
                        this.graphics.arms[key].middle.y*0.4+this.graphics.arms[key].top.y*0.6
                    )
                    this.layer.rotate(-dir)
                    ang=atan2(4,dist(this.graphics.arms[key].middle.x,this.graphics.arms[key].middle.y,this.graphics.arms[key].top.x,this.graphics.arms[key].top.y)*0.6)
                    this.layer.fill(...this.flashColor(mergeColor(this.color.dress.back,this.color.dress.main,0.25)),this.fade*this.fades.dress.sleeve*0.8)
                    for(let a=0,la=11;a<la;a++){
                        if(lcos((a-0.5)/la*360+this.anim.direction)<=0&&lcos((a+0.5)/la*360+this.anim.direction)<=0){
                            this.layer.push()
                            this.layer.translate(
                                lsin((a-0.5)/la*360+this.anim.direction)*1.5+lsin((a+0.5)/la*360+this.anim.direction)*1.5,
                                -abs(lcos((a-0.5)/la*360+this.anim.direction)+lcos((a+0.5)/la*360+this.anim.direction))/3
                            )
                            this.layer.rotate(ang*lsin((a+0.5)/la*360+this.anim.direction))
                            this.layer.ellipse(0,0,sqrt(
                                (3*abs(lsin((a+0.5)/la*360+this.anim.direction)-lsin((a-0.5)/la*360+this.anim.direction)))**2+
                                (abs(abs(lcos((a+0.5)/la*360+this.anim.direction))-abs(lcos((a-0.5)/la*360+this.anim.direction))))**2
                            ),1)
                            this.layer.pop()
                        }
                    }
                ...
                case 2:
                    ...
                    this.layer.fill(...this.flashColor(this.color.shoe.bow),this.fade*this.fades.shoe)
                    this.layer.rotate(-160)
                    hexagon(this.layer,
                        0,0,
                        1.6,-0.8,
                    ...
                    this.layer.fill(...this.flashColor([this.color.shoe.bow[0]*1.4,this.color.shoe.bow[1]*1.4,this.color.shoe.bow[2]*1.4]),this.fade*this.fades.shoe)
                    this.layer.rotate(-160)
                    this.layer.quad(0,0,1.6,-0.8,1.44,0,1.6,0.8)
                    this.layer.rotate(160)
                    this.layer.quad(0,0,1.6,-0.8,1.44,0,1.6,0.8)
                    this.layer.fill(...this.flashColor([this.color.shoe.bow[0]*0.8,this.color.shoe.bow[1]*0.8,this.color.shoe.bow[2]*0.8]),this.fade*this.fades.shoe)
                    this.layer.rotate(-160)
                    this.layer.quad(0,0,1.52,-0.4,1.44,0,1.52,0.4)
                    this.layer.rotate(160)
                    this.layer.quad(0,0,1.52,-0.4,1.44,0,1.52,0.4)
                    this.layer.rotate(-170)
                    this.layer.fill(...this.flashColor([this.color.shoe.bow[0]*0.6,this.color.shoe.bow[1]*0.6,this.color.shoe.bow[2]*0.6]),this.fade*this.fades.shoe)
                    hexagon(
                        this.layer,
                        -0.4,-0.1,
                        -0.3,0.075,
                ...
                case 3:
                    ...
                    this.layer.rotate(160)
                    this.layer.quad(0,0,6,-3,4.8,0,6,3)
                    this.layer.fill(...this.flashColor(this.color.dress.bow),this.fade*this.fades.dress.main)
                    this.layer.rotate(-160)
                    this.layer.quad(0,0,5.55,-2.775,4.44,0,5.55,2.775)
                    this.layer.rotate(160)
                    this.layer.quad(0,0,5.55,-2.775,4.44,0,5.55,2.775)
                    this.layer.fill(...this.flashColor([this.color.dress.bow[0]*1.4,this.color.dress.bow[1]*1.4,this.color.dress.bow[2]*1.4]),this.fade*this.fades.dress.main)
                    this.layer.rotate(-160)
                    this.layer.quad(0,0,4.8,-2.4,3.84,0,4.8,2.4)
                    this.layer.rotate(160)
                    this.layer.quad(0,0,4.8,-2.4,3.84,0,4.8,2.4)
                    this.layer.fill(...this.flashColor([this.color.dress.bow[0]*0.8,this.color.dress.bow[1]*0.8,this.color.dress.bow[2]*0.8]),this.fade*this.fades.dress.main)
                    this.layer.rotate(-160)
                    this.layer.quad(0,0,4.32,-1.2,3.84,0,4.32,1.2)
                    this.layer.rotate(160)
                    this.layer.quad(0,0,4.32,-1.2,3.84,0,4.32,1.2)
                    this.layer.rotate(-170)
                    this.layer.fill(...this.flashColor([this.color.dress.bow[0]*0.6,this.color.dress.bow[1]*0.6,this.color.dress.bow[2]*0.6]),this.fade)
                    hexagon(
                        this.layer,
                        -1.2,-0.3,
                        -0.9,0.225,
                ...
                case 4:
                    ...
                    this.layer.fill(...this.flashColor(this.color.hair.bow),this.fade)
                    this.layer.quad(0,0,7.4,-3.7,5.92,0,7.4,3.7)
                    this.layer.fill(...this.flashColor([this.color.hair.bow[0]*1.4,this.color.hair.bow[1]*1.4,this.color.hair.bow[2]*1.4]),this.fade)
                    this.layer.quad(0,0,6.4,-3.2,5.12,0,6.4,3.2)
                    this.layer.fill(...this.flashColor([this.color.hair.bow[0]*1.1,this.color.hair.bow[1]*1.1,this.color.hair.bow[2]*1.1]),this.fade)
                    this.layer.quad(0,0,5.92,-2,5.12,0,5.92,2)
                    this.layer.fill(...this.flashColor([this.color.hair.bow[0]*0.8,this.color.hair.bow[1]*0.8,this.color.hair.bow[2]*0.8]),this.fade)
                    this.layer.quad(0,0,5.6,-1.2,5.12,0,5.6,1.2)
                    this.layer.scale(1/scalar,1)

                    this.layer.rotate(180+20*scalar)
                    this.layer.scale(scalar,1)
                    this.layer.fill(...this.flashColor([this.color.hair.bow[0]*0.4,this.color.hair.bow[1]*0.4,this.color.hair.bow[2]*0.4]),this.fade)
                    this.layer.quad(0,0,8,-4,6.4,0,8,4)
                    this.layer.fill(...this.flashColor(this.color.hair.bow),this.fade)
                    ...
                    this.layer.rotate(-180-10*scalar)
                    this.layer.scale(scalar,1)
                    ...
                    this.layer.rotate(60)
                    this.layer.fill(...this.flashColor([this.color.hair.bow[0]*0.6,this.color.hair.bow[1]*0.6,this.color.hair.bow[2]*0.6]),this.fade)
                    hexagon(
                        this.layer,
                        -1.6,-0.7+scalar*0.3,
                        -1.2,scalar*0.3,
                ...
                case 5:
                    ...
                    hexagon(
                        ...
                        this.graphics.arms[key].middle.x+2.1*sin(dir+90),
                        this.graphics.arms[key].middle.y+2.1*cos(dir+90),
                        this.graphics.arms[key].middle.x*0.9+this.graphics.arms[key].bottom.x*0.1+2.1*sin(dir+90),
                        this.graphics.arms[key].middle.y*0.9+this.graphics.arms[key].bottom.y*0.1+2.1*cos(dir+90),
                        this.graphics.arms[key].middle.x*0.25+this.graphics.arms[key].bottom.x*0.75+6*sin(dir+90),
                        this.graphics.arms[key].middle.y*0.25+this.graphics.arms[key].bottom.y*0.75+6*cos(dir+90),
                        this.graphics.arms[key].middle.x*0.25+this.graphics.arms[key].bottom.x*0.75-6*sin(dir+90),
                        this.graphics.arms[key].middle.y*0.25+this.graphics.arms[key].bottom.y*0.75-6*cos(dir+90),
                        this.graphics.arms[key].middle.x*0.9+this.graphics.arms[key].bottom.x*0.1-2.1*sin(dir+90),
                        this.graphics.arms[key].middle.y*0.9+this.graphics.arms[key].bottom.y*0.1-2.1*cos(dir+90),
                    ...
                    this.layer.fill(...this.flashColor(this.color.dress.sleeve),this.fade*this.fades.dress.sleeve*0.8)
                    ang=atan2(6,dist(this.graphics.arms[key].middle.x,this.graphics.arms[key].middle.y,this.graphics.arms[key].bottom.x,this.graphics.arms[key].bottom.y)*0.75)
                    for(let a=0,la=17;a<la;a++){
                        if(lcos(a/la*360+this.anim.direction)>0){
                            ...
                            this.layer.push()
                            this.layer.translate(
                                lsin((a-0.5)/la*360+this.anim.direction)*3+lsin((a+0.5)/la*360+this.anim.direction)*3,
                                -abs(lcos((a-0.5)/la*360+this.anim.direction)+lcos((a+0.5)/la*360+this.anim.direction))*0.5
                            )
                            this.layer.rotate(ang*lsin((a+0.5)/la*360+this.anim.direction))
                            this.layer.ellipse(0,0,sqrt(
                                (6*abs(lsin((a+0.5)/la*360+this.anim.direction)-lsin((a-0.5)/la*360+this.anim.direction)))**2+
                                (abs(abs(lcos((a+0.5)/la*360+this.anim.direction))-abs(lcos((a-0.5)/la*360+this.anim.direction))))**2
                            ),2.4)
                            this.layer.pop()
                        }
                    ...
                    let len=dist(
                        this.graphics.arms[key].middle.x*0.9+this.graphics.arms[key].bottom.x*0.1,
                        this.graphics.arms[key].middle.y*0.9+this.graphics.arms[key].bottom.y*0.1,
                        this.graphics.arms[key].middle.x*0.25+this.graphics.arms[key].bottom.x*0.75,
                        this.graphics.arms[key].middle.y*0.25+this.graphics.arms[key].bottom.y*0.75
                    )
                    this.layer.push()
                    ...
                    this.layer.rotate(-dir)
                    this.layer.fill(...this.flashColor(this.color.dress.sleeveOver),this.fade*this.fades.dress.main*0.8)
                    for(let a=0,la=17;a<la;a++){
                ...
                case 8:
                    ...
                    this.layer.beginShape()
                    this.layer.vertex(this.graphics.arms[key].top.x,this.graphics.arms[key].top.y)
                    this.layer.vertex(this.graphics.arms[key].middle.x,this.graphics.arms[key].middle.y)
                    this.layer.vertex(this.graphics.arms[key].bottom.x,this.graphics.arms[key].bottom.y)
                    this.layer.endShape()
                    if(this.trigger.display.dress.sleeve){
                        this.minorDisplay(0,key)
                    }
                    this.layer.noFill()
                ...
                case 9:
                    ...
                    for(let a=0,la=set.length;a<la;a++){
                        this.layer.vertex(
                            this.graphics.arms[key].top.x*(1-set[a][0])+
                            this.graphics.arms[key].middle.x*set[a][0]+
                            (2.4+3*set[a][0])*set[a][1]*trig[0],
                            this.graphics.arms[key].top.y*(1-set[a][0])+
                            this.graphics.arms[key].middle.y*set[a][0]+
                            (2.4+3*set[a][0])*set[a][1]*trig[1]
                        )
                    }
                    this.layer.endShape()*/
                    this.layer.quad(
                        this.graphics.arms[key].top.x-2.4*trig[0],
                        this.graphics.arms[key].top.y-2.4*trig[1],
                        this.graphics.arms[key].top.x+2.4*trig[0],
                        this.graphics.arms[key].top.y+2.4*trig[1],
                        this.graphics.arms[key].middle.x*0.4+this.graphics.arms[key].top.x*0.6+3*trig[0],
                        this.graphics.arms[key].middle.y*0.4+this.graphics.arms[key].top.y*0.6+3*trig[1],
                        this.graphics.arms[key].middle.x*0.4+this.graphics.arms[key].top.x*0.6-3*trig[0],
                        this.graphics.arms[key].middle.y*0.4+this.graphics.arms[key].top.y*0.6-3*trig[1]
                    )
                    this.layer.fill(...this.flashColor(this.color.dress.main),this.fade*this.fades.dress.sleeve)
                    ...
                    ang=atan2(0.6,dist(this.graphics.arms[key].middle.x,this.graphics.arms[key].middle.y,this.graphics.arms[key].top.x,this.graphics.arms[key].top.y)*0.6)
                    this.layer.fill(...this.flashColor(this.color.dress.main),this.fade*this.fades.dress.sleeve*0.8)
                    for(let a=0,la=11;a<la;a++){
                        if(lcos(a/la*360+this.anim.direction)>0){
                            this.layer.push()
                            this.layer.translate(
