function draw(){
    ...
    graphics.main.push()
    switch(stage.scene){
        case 'title': case 'menu': case 'menu2': case 'variants': case 'custom': case 'tutorial':  case 'collection': case 'query': case 'listQuery':
        ...
        case 'graphic': case 'tier': case 'histogram':
