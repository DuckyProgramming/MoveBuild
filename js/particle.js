class particle{
    constructor(layer,x,y,type,args){
        ...
        switch(this.type){
            ...
            case 225: case 244: case 252: case 268: case 269: case 273: case 283: case 284:
                this.size=args[0]
                this.fade=1
                this.scale=0
            break
            ...
            break
            case 81: case 231: case 246: case 247: case 251:
                this.direction=args[0]
                this.timer=args[1]
                this.color=random(0,1)
                this.speed=this.type==251?15:15*random(0.6,1.5)
                this.fade=0
                this.trigger=false
                this.size=1
                this.scale=1
            ...
            case 210:
                ...
                this.velocity={x:lsin(this.direction)*this.speed,y:lcos(this.direction)*this.speed}
            break
            case 211: case 228: case 259: case 266:
                this.size=args[0]
                this.color=args[1]
                this.direction=random(0,360)
                this.fade=1
    ...
    display(){
        if(this.size>0&&this.scale>0){
            ...
            switch(this.type){
                ...
                break
                case 252:
                    this.layer.rotate(3*this.time)
                    this.layer.noFill()
                    this.layer.stroke(0,0,40,this.fade)
                    this.layer.strokeWeight(1)
                    this.layer.ellipse(0,0,14)
                    for(let a=0,la=8;a<la;a++){
                        this.layer.line(lsin(a*45)*7,lcos(a*45)*7,lsin(a*45)*10,lcos(a*45)*10)
                    }
                    this.layer.noStroke()
                    this.layer.fill(255,255,200,this.fade)
                    this.layer.arc(0,0,10,10,-180,0)
                    this.layer.fill(0,0,40,this.fade)
                    this.layer.arc(0,0,10,10,0,180)
                    this.layer.ellipse(2.5,0,5)
                    this.layer.fill(255,255,200,this.fade)
                    this.layer.arc(-2.5,0,5,5,0,180)
                    this.layer.ellipse(2.5,0,1.5)
                    this.layer.fill(0,0,40,this.fade)
                    this.layer.ellipse(2.5,0,1.5)
                break
                case 253:
                    this.layer.rotate(this.time*-10)
                    this.layer.fill(255,this.fade*0.25)
                    this.layer.arc(0,0,40,40,-180,0)
                    this.layer.fill(175,215,225,this.fade*0.25)
                    this.layer.arc(0,0,40,40,0,180)
                    this.layer.arc(10,0,20,20,-180,0)
                    this.layer.fill(255,this.fade*0.25)
                    this.layer.arc(-10,0,20,20,0,180)
                    this.layer.ellipse(10,0,6)
                    this.layer.fill(100,175,200,this.fade*0.25)
                    this.layer.ellipse(-10,0,6)
                    this.layer.rotate(this.time*5)
                    this.layer.fill(255,this.fade)
                    this.layer.arc(0,0,20,20,-180,0)
                    this.layer.fill(100,175,200,this.fade)
                    this.layer.arc(0,0,20,20,0,180)
                    this.layer.ellipse(5,0,10)
                    this.layer.fill(255,this.fade)
                    this.layer.ellipse(-5,0,10)
                ...
                case 254:
                    ...
                    switch(this.color){
                        case 0:
                            this.layer.stroke(255,0,125,this.fade)
                        break
                        case 1:
                            this.layer.stroke(255,0,0,this.fade)
                        break
                        case 2:
                            this.layer.stroke(255,100,175,this.fade)
                        break
                        case 3:
                            this.layer.stroke(255,100,100,this.fade)
                        break
                    ...
                    this.layer.strokeWeight(2)
                    this.layer.rect(0,0,16,20)
                    this.layer.line(-4,-6,-4,6)
                    this.layer.line(-4,6,4,6)
                    this.layer.line(4,-6,4,6)
                ...
                case 284:
                    this.layer.rotate(this.time*2)
                    this.layer.noFill()
                    this.layer.stroke(150,120,90,this.fade)
                    this.layer.strokeWeight(2.5)
                    for(let a=0,la=26;a<la;a++){
                        this.layer.rotate(360/la)
                        this.layer.arc(16,4,8,8,-90,-15)
                    }
                    this.layer.stroke(165,135,105,this.fade)
                    this.layer.strokeWeight(1.5)
                    for(let a=0,la=26;a<la;a++){
                        this.layer.rotate(360/la)
                        this.layer.arc(16,4,8,8,-90,-15)
                    ...
                    for(let a=0,la=5;a<la;a++){
                        ...
                        for(let b=0,lb=7;b<lb;b++){
                            this.layer.line(
                                this.position2.x,
                                this.position2.y,
                                this.position2.x+lsin(b/lb*360+this.time*2)*(10+a*10),
                                this.position2.y+lcos(b/lb*360+this.time*2)*(10+a*10)
                            )
                        }
                    }
                break
    ...
    update(parent){
        ...
        switch(this.type){
            ...
            break
            case 81: case 94: case 102: case 127: case 178: case 231: case 246: case 247: case 251:
                this.position.x+=lsin(this.direction)*this.speed
                this.position.y-=lcos(this.direction)*this.speed-10/this.timer
            ...
            break
            case 135: case 163: case 164: case 284:
                this.fade-=0.05
            ...
            case 265:
                ...
                if(this.time<480){
                    ...
                    for(let a=0,la=this.loops.length;a<la;a++){
                        this.loops[a].fade-=0.1
                        if(this.loops[a].fade<=0){
                            this.loops.splice(a,1)
                            a--
                            la--
                        }
                    }
