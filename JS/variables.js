types={
    combatant:[
        ...
        {name:'Defense Juice',id:16,rarity:0,list:0,menu:false,temp:false,description:'Gain 2 Dexterity'},
        ...
        {name:'Blank Paper',id:21,rarity:0,list:0,menu:false,temp:false,description:'Choose a Colorless\nCard to Add to Hand'},
        ...
        {name:'Ash',id:24,rarity:0,list:0,menu:false,temp:false,description:'Apply 3 Frail'},
        {name:'Decaf',id:25,rarity:0,list:0,menu:false,temp:false,description:'Draw 3 Cards'},
        {name:'Rusted Gear',id:26,rarity:0,list:0,menu:false,temp:false,description:'Gain 1 Control'},
        {name:'Spike Pads',id:27,rarity:0,list:0,menu:false,temp:false,description:'Place Spikes on\nAll Adjacent Tiles'},
        {name:'Metal Plating',id:28,rarity:1,list:0,menu:false,temp:false,description:'Gain 10 Armor'},
        {name:'Rigged Die',id:29,rarity:0,list:0,menu:false,temp:false,description:'Redraw Your Hand'},
        {name:'Lifesprig',id:30,rarity:0,list:0,menu:false,temp:false,description:'Gain 8 Regeneration'},
        {name:'Attack Powder',id:31,rarity:1,list:0,menu:false,temp:false,description:'Gain 1 Strength\nEvery Turn'},
        {name:'Defense Powder',id:32,rarity:1,list:0,menu:false,temp:false,description:'Gain 1 Dexterity\nEvery Turn'},
        {name:'Memory Pearl',id:33,rarity:1,list:0,menu:false,temp:false,description:'Put a Card From Discard Pile\nin Your Hand, it Costs 0'},
        {name:'Shiny Cube',id:34,rarity:1,list:0,menu:false,temp:false,description:'Add 3 Miracles\nto Your Hand'},
        {name:'Berlin Key',id:35,rarity:1,list:0,menu:false,temp:false,description:'Duplicate the Next\n2 Cards Played'},
        {name:'Distilled Chaos',id:36,rarity:1,list:0,menu:false,temp:false,description:'Draw 3 Cards,\nThey Cost 0'},
        {name:'Melted Steel',id:37,rarity:0,list:0,menu:false,temp:false,description:'Retain Block\nFor 10 Turns'},
        {name:'Flashbang',id:38,rarity:1,list:0,menu:false,temp:false,description:'Randomize Enemy Directions,\nActivate All Enemies'},
        {name:'Buggy Horn',id:39,rarity:0,list:0,menu:false,temp:false,description:'Push 1 Tile\nin All Directions\nRange 1-2'},
        {name:'Orange Juice',id:40,rarity:1,list:0,menu:false,temp:false,description:'Remove All Fatigues'},
        {name:'Bag of Knives',id:41,rarity:1,list:0,menu:false,temp:false,description:'Add 5 Shivs\nto Your Hand'},
        {name:'Time Crystal',id:42,rarity:2,list:0,menu:false,temp:false,description:'Take an Extra Turn'},
        {name:'Trash Can',id:43,rarity:2,list:0,menu:true,temp:false,description:'Remove a Card\nFrom Your Deck'},
        ...
        {name:'Spiked Glove',id:53,rarity:0,list:0,menu:false,temp:false,description:'Next Attack Deals\nDouble Damage'},
        {name:'Floppy Disc',id:54,rarity:0,list:0,menu:false,temp:false,description:'Put a Card\nFrom Your Deck\nInto Hand'},
        {name:'Red Pill',id:55,rarity:0,list:0,menu:false,temp:false,description:'Put a Card in Discard\nPile in Your Hand'},
        {name:'Blue Pill',id:56,rarity:0,list:0,menu:false,temp:false,description:'Put a Card in Draw\nPile in Your Hand'},
        {name:'Booster Shot',id:57,rarity:1,list:0,menu:true,temp:false,description:'Upgrade a Random\nCard in Your Deck'},
        {name:'Contained Boundary',id:58,rarity:1,list:0,menu:false,temp:false,description:'Gain 3 Energy, Draw 5 Cards,\nLose 3 Health'},
        {name:'Jeweled Branch',id:59,rarity:2,list:0,menu:false,temp:false,description:'Gain 5 Energy, Retain Unspent\nEnergy For the Next 5 Turns'},
        ...
        {name:'Hypergrowth',id:61,rarity:2,list:0,menu:false,temp:false,description:'Gain 1 Base Energy This Combat'},
        {name:'Offense Tonic',id:62,rarity:1,list:0,menu:false,temp:false,description:'Gain 1 Energy,\nRedraw All Non-Attack Cards'},
        {name:'Defense Tonic',id:63,rarity:1,list:0,menu:false,temp:false,description:'Gain 1 Energy,\nRedraw All Non-Defense Cards'},
        {name:'Deuterium',id:64,rarity:1,list:0,menu:false,temp:false,description:'Your Next 3 Exhausts\nDiscard the Card Instead'},
        {name:'Anaglyph Pill',id:65,rarity:1,list:0,menu:false,temp:false,description:'Put a Card in Exhaust\nPile in Your Hand'},
        {name:'Golden Camera',id:66,rarity:1,list:0,menu:true,temp:false,description:'Duplicate a Random\nOther Owned Item'},
        {name:'Hummingbird Feather',id:67,rarity:1,list:0,menu:false,temp:false,description:'Take Half Damage For 2 Turns'},
        {name:'Surplus Voucher',id:68,rarity:0,list:0,menu:false,temp:false,description:'Gain a Relic and Destroys itself\nAfter a Completed Boss Combat\n(No Effect Otherwise)'},
        {name:'Grimoire Page',id:69,rarity:2,list:0,menu:true,temp:false,description:'Choose an Uncommon Card From Any\nCharacter to Add to Deck'},
        {name:'Oracle',id:70,rarity:2,list:0,menu:false,temp:false,description:'Choose ANY Character or Colorless\nCard to Add to Hand'},
        {name:'Blinkseal',id:71,rarity:2,list:0,menu:false,temp:false,description:'Deal 24 Damage, Take Another Turn\nAll Cards Cost 1 More on That Turn\nRange 1-6'},
        {name:'Vacuum Collapse',id:72,rarity:2,list:0,menu:false,temp:false,description:'Deal 35 Damage, Add 2\nPrismatic Bombs to Draw Pile\nRange 1-6'},
        ...
        {name:'Surprise Coupon',id:76,rarity:2,list:0,menu:true,temp:false,description:'Make 3 Things Free\nat the Next Shop'},
        ...
        {name:'Cup of Water',id:80,rarity:1,list:0,menu:false,temp:false,description:'Discard Your Hand, Add 5 Block Per\nCard Discarded, Add a Miracle to Hand'},
        {name:'Fuel Cell',id:81,rarity:0,list:0,menu:false,temp:false,description:'The Next Item Used This Combat\nHas its Effect Doubled'},
        {name:'Bumper Sticker',id:82,rarity:0,list:0,menu:false,temp:false,description:'Tick Statuses'},
        {name:'Tape Roll',id:83,rarity:0,list:0,menu:false,temp:false,description:'All Enemies Cannot\nMove This Turn'},
        {name:'Confetti',id:84,rarity:0,list:0,menu:false,temp:false,description:'Deal 1 Damage to All Enemies'},
        ...
        {name:'Giant Scissors',id:92,rarity:0,list:0,menu:false,temp:false,description:'Exhaust Up to 5 Cards\nFrom Draw Pile'},
        {name:'Falling Stick',id:93,rarity:0,list:0,menu:false,temp:false,description:'Deal 8 Damage\nto any Enemy'},
        {name:'Catalytic Converter',id:94,rarity:0,list:0,menu:false,temp:false,description:'Transform All Cards\nin Your Hand'},
        {name:'Large Speaker',id:95,rarity:0,list:0,menu:false,temp:false,description:'Push to End\nRange 1-1'},
        {name:'Tree Sapling',id:96,rarity:1,list:0,menu:false,temp:false,description:'In 3 Turns, Gain 3 Strength\nand 3 Dexterity'},
        {name:'Mobile Tonic',id:97,rarity:1,list:0,menu:false,temp:false,description:'Gain 1 Energy,\nRedraw All Non-Movement Cards'},
        {name:'Skillful Tonic',id:98,rarity:1,list:0,menu:false,temp:false,description:'Gain 1 Energy,\nRedraw All Non-Skill Cards'},
        {name:'Powerful Tonic',id:99,rarity:1,list:0,menu:false,temp:false,description:'Gain 1 Energy,\nRedraw All Non-Power Cards'},
        {name:'Two-Sided Mirror',id:100,rarity:1,list:0,menu:false,temp:false,description:'Duplicate Your Hand'},
        {name:'Bottled Cement',id:101,rarity:1,list:0,menu:false,temp:false,description:'Remove All Block of Target\nDeal 25 Damage\nRange 1-3'},
        ...
        {name:'Molten Metal',id:1006,rarity:-1,list:-1,menu:false,temp:true,description:'Add 10 Block\nTemporary'},
        {name:'Caffeine Pill',id:1007,rarity:-1,list:-1,menu:false,temp:true,description:'Draw 2 Cards\nTemporary'},
        {name:'Attack Dust',id:1008,rarity:-1,list:-1,menu:false,temp:true,description:'Gain 1 Strength\nTemporary'},
