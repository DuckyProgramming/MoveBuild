types={
    combatant:[
        ...
        {name:'Magic Consuming Duck',internal:'Power Cost Reduce',id:20,rarity:2,list:0,description:'When You Play a Power\n, a Random Card Costs 1 Less'},
        ...
        {name:'Movement Magazine',internal:'Upgrade Random Movement',id:34,rarity:0,list:0,description:'When Taken, Upgrade\n2 Random Movements'},
        {name:'Power Magazine',internal:'Upgrade Random Powers',id:35,rarity:0,list:0,description:'When Taken, Upgrade\n2 Random Powers'},
        {name:'Metal Pipe',internal:'Starting Block',id:36,rarity:0,list:0,description:'Add 10 Block\nat the Start of Combat'},
        ...
        {name:'Psuedograph',internal:'No Card Draw',id:54,rarity:2,list:0,description:'If You Have No Cards in\nYour Hand, Draw 1 Card'},
        {name:'Origami Paper',internal:'Damage Decrease',id:55,rarity:2,list:0,description:'Reduce All Damage\nAbove 1 By 1'},
        {name:'Picture Frame',internal:'Damage Threshold',id:56,rarity:2,list:0,description:'If You Take 5 or Less\nDamage, Reduce it to 1'},
        ...
        {name:'Gluestick',internal:'Unblocked Weaken',id:74,rarity:1,list:0,description:'When an Enemy Deals Unblocked\nDamage to You, Apply 1 Weak'},
        ...
        {name:'Swear Jar',internal:'No Shop Currency',id:91,rarity:0,list:0,description:'Gain 20 Currency Every Node\nUntil Your Enter a Shop'},
        ...
        {name:'Coal Ball',internal:'Death Strength',id:94,rarity:0,list:0,description:'When an Enemy Dies,\nGain 1 Strength'},
        {name:'Snowball',internal:'Death Dexterity',id:95,rarity:0,list:0,description:'When an Enemy Dies,\nGain 1 Dexterity'},
        {name:'Tax Paperwork',internal:'Weak Elites',id:96,rarity:0,list:0,description:'Enemies in Elite\nCombats Lose 20% HP'},
        ...
        {name:'AAAA Battery',internal:'Energy/Electrocuted',id:144,rarity:4,list:0,description:'Gain 1 Base Energy, Shuffle 1 Electrocuted\nInto Draw at the Start of Combat'},
        {name:'Purple Cape',internal:'Energy/Range',id:145,rarity:4,list:0,description:'Gain 1 Base Energy\nCan Only Attack at Range 1'},
        {name:'Euphorbia',internal:'Energy/Counter',id:146,rarity:4,list:0,description:'Gain 1 Base Energy,\nAll Enemies Counter 1 All'},
        ...
        {name:'Stocks',internal:'Currency Per Node',id:166,rarity:-1,list:0,description:'Gain 10 Currency Every Node'},
        ...
        {name:'Diamond Burger',internal:'Energy/Card Size',id:170,rarity:4,list:0,description:'Gain 1 Base Energy,\nAll Cards are Wide'},
        {name:'Big Game Guide',internal:'Elite Relic',id:171,rarity:4,list:0,description:'You Get +2 Relics Per Elite'},
        {name:'Cheap Disguise',internal:'Offcolor Card',id:172,rarity:1,list:0,description:'You Get a Card Option From Another Color'},
        ...
        {name:'Smith Business Card',internal:'Boss Deluxe Upgrade',id:177,rarity:2,list:0,description:'Deluxe Upgrade a Card\nAfter Every Boss'},
        {name:'Purple Sunflower',internal:'Discard Over Draw Energy',id:178,rarity:2,list:0,description:'Gain 1 Energy Per Turn When Discard Pile\nHas More Cards Than Draw Pile'},
        ...
        {name:'Glow Up',internal:'More Editions',id:180,rarity:4,list:0,description:'Cards are 4x More\nLikely to be Editions'},
        ...
        {name:'Credit Card',internal:'Go Into Debt',id:187,rarity:0,list:0,description:'Go Into Up to 200\nCurrency of Debt\nWithout Debt Curse'},
        {name:'Tauball',internal:'Fragile Strength',id:188,rarity:0,list:0,description:'Gain 3 Strength at the Start of Combat\n10% Chance to Break Each Battle'},
        {name:'Hallucinogen Pills',internal:'Purchase Item',id:189,rarity:0,list:0,description:'After Purchasing From the Shop,\nGain an Item'},
        ...
        {name:'Rough Gem',internal:'Extra Energy Block',id:198,rarity:1,list:0,description:'Extra Energy is Converted\nto 4 Block Per Energy'},
        {name:'Dirt Bucket',internal:'Remove Card Upgrade',id:199,rarity:-1,list:0,description:'After Removing a Card,\nUpgrade a Random Card'},

        {name:'Abstract Duck',internal:'Relic Strength',id:200,rarity:1,list:0,description:'Gain 1 Strength Per 10 Relics\nYou Own at the Start of Combat'},
        {name:'Popcorn',internal:'Deprecating Damage',id:201,rarity:1,list:0,description:'First Attack Deals\n16 More Damage\nDecreases by 1 Each Battle'},
        {name:'Certificate of Authenticity',internal:'Boss Edition',id:202,rarity:1,list:0,description:'Edition a Card\nAfter Every Boss'},
        {name:'Triple Helix',internal:'Boss Duplicate',id:203,rarity:2,list:0,description:'Duplicate a Card\nAfter Every Boss'},
        {name:'Anaglyph Glasses',internal:'No Attack Double',id:204,rarity:2,list:0,description:'When You Do Not Attack,\nFirst Attack Next Turn\nDeals Double Damage'},
        ...
        {name:'To The Moon',internal:'1000 Currency Currency Per Node',id:210,rarity:3,list:0,description:'Gain 40 Currency Every Node\nWhen You Have 1000 Currency or More'},
        {name:'Brainstorm',internal:'Copy First Relic',id:211,rarity:3,list:0,description:'When Sold, Copy Your\nFirst Owned Relic'},
        {name:'Faceless Face',internal:'Movement Remove Currency',id:212,rarity:1,list:0,description:'Gain 400 Currency When\na Movement Card is Removed'},
        ...
        {name:'Paper Snowflake',internal:'Last Card Free',id:223,rarity:-1,list:0,description:'When Taken, Make the\nLast Card in Deck Free'},
        ...
        {name:'Painted Deck',internal:'Compact/Lose First Relic',id:230,rarity:-1,list:0,description:'Compact Cards in Your Hand\nWhen Taken, Lose Your First Relic'},
        ...
        {name:'MS Paint',internal:'Starting Draw Retain',id:237,rarity:1,list:0,description:'Draw a Card at the Start of Combat\nand Retain it Until Played'},
        {name:'Orange Stake',internal:'Booster Pack Choice',id:238,rarity:0,list:0,description:'Booster Packs Contain 2 More Choices'},
        {name:'Loaded Disk',internal:'Paper Items',id:239,rarity:2,list:0,description:'Gain a Cream Paper or Pink\nPaper Item at the Start of Combat'},

        {name:'Enlightened Duck',internal:'Boss Spectral Pack',id:240,rarity:2,list:0,description:'Open a Spectral Pack After Every Boss'},
        {name:'Jester Duck',internal:'Random Enemy Statuses',id:241,rarity:0,list:0,description:'All Enemies Start Combat With\nRandomly 1 Burn, Freeze, or Shock'},
        {name:'Asphalt Block',internal:'Energy/Miss',id:242,rarity:4,list:0,description:'Gain 1 Base Energy,\nGain 2 Miss at the Start of Combat'},
        {name:'Radioscope',internal:'Energy/View',id:243,rarity:4,list:0,description:'Gain 1 Base Energy,\nCannot See Draw and Discard Piles'},
        ...
        {name:'Chameleon',internal:'Random Polychrome Colorless',id:247,rarity:-1,list:0,description:'When Taken, Add a Random Polychrome\nCommon Colorless Card to Deck'},
        ...
        {name:'Blood Diamond',internal:'Health Loss Currency',id:253,rarity:0,list:0,description:'When You Lose Health,\nGain 3 Currency Per HP Lost'},
        ...
        {name:'Block Toys',internal:'Standard Card Reward',id:260,rarity:2,list:0,description:'Gain an Extra Card Reward\nFrom Normal Combats'},
        ...
        {name:'Common Colorless Voucher',internal:'Cheap Common Colorless',id:269,rarity:3,list:0,description:'Common Colorless Cards in the\nShop Cost 50% Less'},
        ...
        {name:'Perpetual Library',internal:'Any 5 Rare Cards',id:291,rarity:4,list:0,description:'When Taken, Choose and Add\n5 Double Upgraded Rare Cards\nFrom Any Character to Deck'},
        ...
        {name:'Rare Colorless Voucher',internal:'Cheap Rare Colorless',id:301,rarity:3,list:0,description:'Rare Colorless Cards in the\nShop Cost 50% Less'},
        ...
        {name:'Kinetic Converter',internal:'Low Play Energy',id:332,rarity:2,list:0,description:'When You Play Less Than 3 Cards,\nGain 1 Energy Next Turn'},
        {name:'Double Decker',internal:'Booster Pack Upgrade',id:333,rarity:1,list:0,description:'Cards in Booster Packs are\nMore Likely to be Upgraded'},
        {name:'Questions and Replies',internal:'First Defense Free',id:334,rarity:2,list:0,description:'The First Defense\nEach Combat is Free'},
        {name:'Laevateinn',internal:'Energy/Power Vulnerable',id:335,rarity:4,list:0,description:'Gain 1 Base Energy,\nGain 1 Vulnerable When\nYou Play a Power'},
        {name:'5D Multiverse Time Travel',internal:'Backwards Move',id:336,rarity:2,list:0,description:'You Can Move Backwards on the Map\n3 Uses'},
        {name:'The Solo',internal:'Energy/Duplicate Cards',id:337,rarity:4,list:0,description:'Gain 1 Base Energy, Remove\nAll Duplicate Non-Basic Cards in Deck\nRemove All Future Added Duplicate Cards'},
        {name:'Jankman',internal:'Special Draw',id:338,rarity:0,list:0,description:'Draw 2 Cards When You\nPlay an Arcana or Spectral Card'},
        {name:'Chainlink',internal:'Energy/Event Options',id:339,rarity:4,list:0,description:'Gain 1 Base Energy,\nCan Only Choose First Option in Events'},
        
        {name:'Horizon Diamond',internal:'Energy/Invisible',id:340,rarity:4,list:0,description:'Gain 1 Base Energy\nAll Enemies are Invisible Until Hit'},
        {name:'Old Key',internal:'Extra Map Path',id:341,rarity:1,list:0,description:'Extra Paths are Available in the Map'},
        {name:'Beanstalk',internal:'Boss Extra Relic',id:342,rarity:1,list:0,description:'Gain a Normal Relic Reward\nAfter Every Boss'},
        {name:'Ladle',internal:'8 Skill Draw',id:343,rarity:2,list:0,description:'Every 8 Skills Played,\nDraw 2 Cards'},
        {name:'Rainbow Lotus',internal:'1 Cost Down Per Turn Energy Gain Block',id:344,rarity:4,list:0,description:'Each Turn, a Random Card Costs 1 Less\nAdd 4 Block When You Gain Energy'},
        {name:'Corrugated Fiberboard',internal:'Energy/Shop Relics',id:345,rarity:4,list:0,description:'Gain 1 Base Energy\nAll Relics in the Shop Cost 2x More'},
        {name:'Item Canister',internal:'No Shop Items',id:346,rarity:0,list:0,description:'Gain an Item Every Node\nUntil You Enter a Shop'},
        {name:'Sugar Cube',internal:'Energy/Leftover Energy',id:347,rarity:4,list:0,description:'Gain 1 Base Energy,\nLose 2 Health at End of Turn\nFor Each Extra Energy'},
        {name:'Medicine Cabinet',internal:'Turn 1 Energy/Turn 2 Heal/Turn 3 Temporary Strength',id:348,rarity:2,list:0,description:'Gain 1 Energy on Turn 1\nHeal 2 Health on Turn 2\nGain 3 Temporary Strength on Turn 3'},
        {name:'Chondrule',internal:'Double Foil',id:349,rarity:0,list:0,description:'Foil Editions Add Double Block'},

        {name:'Exponentia',internal:'Energy Gain Draw',id:350,rarity:2,list:0,description:'Draw 1 Card When You Gain Energy'},
        {name:'Traffic Cone',internal:'Replenish Card',id:351,rarity:3,list:0,description:'When Taken, Make a Card Replenish'},
        {name:'Boredom',internal:'3 Turn Duplicate',id:352,rarity:2,list:0,description:'Duplicate the Next Card\nPlayed Every 3 Turns'},
        {name:'Big Cube',internal:'25 Block Draw',id:353,rarity:0,list:0,description:'Draw a Card When You\nAdd 25 or More Block'},
        {name:'Breccia',internal:'Double Silver',id:354,rarity:0,list:0,description:'Silver Editions Heal Double Health'},
        {name:'Virtuous Duck',internal:'Double First Attack',id:355,rarity:2,list:0,description:'The First Attack Each Combat\nDeals Double Damage'},
        {name:'Congestion Control',internal:'Protocol',id:356,rarity:4,list:0,description:'Shuffle 1 Protocol Into\nDraw at the Start of Combat'},
        {name:'Tactical Conductor',internal:'Cheap Skills',id:357,rarity:2,list:0,description:'Skills Have a 10%\nChance to Cost 1 Less\nTemporarily When Drawn'},
        {name:'Blackened Nebula',internal:'Energy/Colorless',id:358,rarity:4,list:0,description:'Gain 1 Base Energy,\nAll Colorless Cards Cost 1 More'},
        {name:'Malicious Flame',internal:'Power Draw',id:359,rarity:1,list:0,description:'When a Power is Played,\nDraw a Card'},
