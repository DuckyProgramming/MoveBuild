types={
    card:[
...

        {
            ...
            name:'McDucknolds\nCard',rarity:1,list:0,
            levels:[
                {effect:[100,10],attack:1329,cost:0,target:[0],spec:[1],class:0},
                {effect:[160,10],attack:1329,cost:0,target:[0],spec:[1],class:0},
                {effect:[200,10],attack:1329,cost:0,target:[0],spec:[1],class:0},
            ],
        },{
...
Is removed when damage taken, but doubles the damage.`,
        ...
        {name:'Management Prototype',desc:'Enemies With a P in Their Name Get 50% More Health'},
        {name:'Management Robot',desc:'Enemies With an R in Their Name Get 50% More Health'},
        {name:'Management Soldier',desc:'Enemies With an S in Their Name Get 50% More Health'},
        {name:'Management Officer',desc:'Enemies With a C in Their Name Get 50% More Health'},
        {name:'Manageemnt Special Forces',desc:'Enemies With an F in Their Name Get 50% More Health'},
        ...
        {name:'Prisoner',desc:'Fatigues Become Unplayable'},
        ...
        {name:'Flying Rock',desc:'Add a Rock to Your Hand Every 2 Turns, Replacing a Card'},
        {name:'Repulsor',desc:'Take 3x Damage From Push Collision'},
        {name:'Champion',desc:'Normal Enemies Appear as Elites, But Are Buffed'},
        {name:'Management Autoduck',desc:'All Statuses Are Unplayable'},//70
        ...
        {name:'Councilman',desc:'Enemies Heal When They Block'},
        ...
        {name:'Soviet Union',desc:'All Cards Become Classless'},
        {name:'Planet X',desc:'Destroy All Duplicate Cards'},
    ],deckmode:[
        {name:'Standard Deck'},
        {name:'Draft Deck'},
        {name:'Basic Deck'},
