types={
    combatant:[
        ...
        {name:'Drumstick',internal:'Extra Draw',id:2,rarity:0,list:0,mtg:0,description:'Draw 2 More Cards\non Turn 1'},
        {name:'Lantern',internal:'First Turn Energy',id:3,rarity:0,list:0,mtg:1,description:'Gain 1 Energy\non Turn 1'},
        {name:'Silver Ring',internal:'5 Turn Energy',id:4,rarity:0,list:0,mtg:1,description:'Gain 1 Energy\nEvery 5th Turn'},
        ...
        {name:'Alarm Clock',internal:'Emergency Move',id:8,rarity:2,list:0,mtg:0,description:'Add an Emergency Move\non Turn 1'},
        {name:'Double Blank Card',internal:'Redraw',id:9,rarity:0,list:0,mtg:0,description:'Add a Redraw\non Turn 1'},

        {name:'Clean Water',internal:'Miracle',id:10,rarity:1,list:0,mtg:0,description:'Add a Miracle\non Turn 1'},
        ...
        {name:'Green Ribbon',internal:'Upgrade All Movement',id:14,rarity:1,list:0,mtg:0,description:'Upgrade All Movements Added'},
        {name:'Yellow Ribbon',internal:'Upgrade All Powers',id:15,rarity:-1,list:0,mtg:0,description:'Upgrade All Powers Added'},
        {name:'Orange',internal:'10 Max HP',id:16,rarity:1,list:0,mtg:0,description:'When Taken,\nGain 10 Max HP'},
        {name:'Sickle',internal:'Death Boost',id:17,rarity:2,list:0,mtg:1,description:'When an Enemy Dies,\nGain 1 Energy and Draw 1 Card'},
        {name:'Mobius Strip',internal:'15 Card Draw',id:18,rarity:1,list:0,mtg:0,description:'Every 15 Cards Played,\nDraw 1 Card'},
        {name:'Dubious Steak',internal:'Emergency Heal',id:19,rarity:1,list:0,mtg:0,description:'At the End of Combat, If Your\nHP is Below 50%, Heal 12 HP'},
        ...
        {name:'Bauxite',internal:'Starting Buffer',id:21,rarity:2,list:0,mtg:0,description:'Gain 1 Buffer\non Turn 1'},
        {name:'Poker Chip',internal:'Selective Redraw',id:22,rarity:1,list:0,mtg:0,description:'Add 1 Selective Redraw\non Turn 1'},
        ...
        {name:'Attack Magazine',internal:'Upgrade Random Attacks',id:32,rarity:0,list:0,mtg:0,description:'When Taken, Upgrade\n2 Random Attacks'},
        {name:'Defense Magazine',internal:'Upgrade Random Defense',id:33,rarity:0,list:0,mtg:0,description:'When Taken, Upgrade\n2 Random Defenses'},
        {name:'Movement Magazine',internal:'Upgrade Random Movement',id:34,rarity:0,list:0,mtg:0,description:'When Taken, Upgrade\n2 Random Movements'},
        {name:'Power Magazine',internal:'Upgrade Random Powers',id:35,rarity:-1,list:0,mtg:0,description:'When Taken, Upgrade\n2 Random Powers'},
        {name:'Metal Pipe',internal:'Starting Block',id:36,rarity:0,list:0,mtg:0,description:'Add 10 Block\non Turn 1'},
        {name:'Soda Bottle',internal:'No Attack Energy',id:37,rarity:0,list:0,mtg:1,description:'When You Do Not Attack,\nGain 1 Energy Next Turn'},
        {name:'Regal Pillow',internal:'Rest Energy',id:38,rarity:0,list:0,mtg:1,description:'Gain 2 Energy\nAfter Resting'},
        {name:'Red Card',internal:'Damage Taken Draw',id:39,rarity:0,list:0,mtg:0,description:'Draw 3 Cards the First\nTime You Take Damage Each Combat'},

        {name:'Yellow Card',internal:'Card Add Currency',id:40,rarity:0,list:0,mtg:0,description:'Gain 20 Currency\nWhen a Card is Added'},
        {name:'Glitched Projector',internal:'Turn 2 Block',id:41,rarity:1,list:0,mtg:0,description:'Add 16 Block at\nthe Start of Turn 2'},
        {name:'Hot Hand',internal:'8 Attack Strength',id:42,rarity:1,list:0,mtg:0,description:'Every 8 Attacks Played,\nGain 1 Strength'},
        {name:'Fluid Pose',internal:'8 Attack Dexterity',id:43,rarity:1,list:0,mtg:0,description:'Every 8 Attacks Played,\nGain 1 Dexterity'},
        {name:'Shield Ram',internal:'3 Attack Block',id:44,rarity:1,list:0,mtg:0,description:'Every 3 Attacks Played,\nGain 4 Block'},
        ...
        {name:'Muffin Mix',internal:'Max HP Rest',id:47,rarity:1,list:0,mtg:0,description:'Can Gain 8 Max\nHP When Resting'},
        ...
        {name:'Mortar and Pestle',internal:'Remove Rest',id:59,rarity:2,list:0,mtg:0,description:'Can Remove Cards\nWhen Resting'},

        {name:'Dumbbell',internal:'Strength Rest',id:60,rarity:2,list:0,mtg:0,description:'Can Gain Strength\nWhen Resting, 3 Uses'},
        {name:'Tiny Cactus',internal:'Always Counter',id:61,rarity:0,list:0,mtg:0,description:'Counter 3 All\nAt All Times'},
        {name:'Dreamcatcher',internal:'Card Rest',id:62,rarity:1,list:0,mtg:0,description:'Can Add a Rare Card\nWhen Resting'},
        {name:'Shuriken',internal:'12 Attack Damage',id:63,rarity:0,list:0,mtg:0,description:'Every 12th Attack Played\nDeals Double Damage'},
        {name:'Orchid',internal:'12 Attack Energy',id:64,rarity:0,list:0,mtg:1,description:'Every 12 Attacks Played,\nGain 1 Energy'},
        ...
        {name:'Duality Charm',internal:'Attacking Defense',id:71,rarity:1,list:0,mtg:0,description:'When You Play an Attack,\nGain 1 Temporary Dexterity'},
        {name:'Diode',internal:'Turn 2 Energy',id:72,rarity:1,list:0,mtg:1,description:'Gain 2 Energy at\nthe Start of Turn 2'},
        {name:'Ornamental Fan',internal:'3 Defense Metallicize',id:73,rarity:-1,list:0,mtg:0,description:'Every 3 Defenses Played,\nGain 2 Metallicize'},
        ...
        {name:'Hexachoron',internal:'Per Enemy Block',id:88,rarity:1,list:0,mtg:0,description:'Gain 1 Block Per Enemy\nat the Start of Your Turn'},
        ...
        {name:'Gold Foil',internal:'Skip Card Currency',id:101,rarity:1,list:0,mtg:0,description:'Gain 10 Currency\nWhen You Skip a Card'},
        {name:'Sticky Hand',internal:'Take 2 Cards',id:102,rarity:1,list:0,mtg:0,description:'You Can Take 2\nCards From Rewards'},
        ...
        {name:'Oil Can',internal:'Early Initiative',id:107,rarity:0,list:0,mtg:0,description:'Start Each Combat With 2 Initiative'},
        ...
        {name:'Gold Ribbon',internal:'Upgrade Purchases',id:110,rarity:1,list:0,mtg:0,description:'Upgrade All Cards\nBought at the Shop'},
        {name:'Azure Blessing',internal:'3 Enemy 1 HP',id:111,rarity:-1,list:0,mtg:0,description:'Next 3 Non-Boss Combats,\nEnemies Have 1 HP'},
        {name:'Bucket Helmet',internal:'Turn 3 Block',id:112,rarity:2,list:0,mtg:0,description:'Add 24 Block at\nthe Start of Turn 3'},
        {name:'Unhelpful Duck',internal:'Exhaust Random',id:113,rarity:-1,list:0,mtg:0,description:'When a Card is Exhausted,\nAdd a Random Card to Your Hand'},
        {name:'Whisper Loop',internal:'Reuse Card',id:114,rarity:-1,list:0,mtg:0,description:'At the Start of Turn 2,\nPut a Random Card From Your\nDiscard Pile in Your Hand'},
        {name:'Peacock Feather',internal:'Always Back Up',id:115,rarity:-1,list:0,mtg:0,description:'At the Start of Your Turn,\nAdd a Back Up to Your Hand'},
        {name:'Bounty Hunter',internal:'Death Currency',id:116,rarity:2,list:0,mtg:0,description:'Gain 20 Currency\nWhen an Enemy Dies'},
        {name:'Sleep Powder',internal:'Double Rest',id:117,rarity:2,list:0,mtg:0,description:'Can Pick 2 Different\nEffects When Resting'},
        {name:'Happy Hour',internal:'Buy One Get One',id:118,rarity:2,list:0,mtg:0,description:'After Purchasing a Card or a\nRelic (Cap 1 Relic Per Shop),\nAnother Becomes Free'},
        ...
        {name:'Rusty Gear',internal:'Starting Control',id:122,rarity:0,list:0,mtg:0,description:'Gain 1 Control\non Turn 1'},
        ...
        {name:'Coffee Filter',internal:'Energy/Rest Heal',id:132,rarity:4,list:0,mtg:1,description:'Gain 1 Base Energy,\nCannot Heal at Rest'},
        {name:'Diffused Anvil',internal:'Energy/Rest Upgrade',id:133,rarity:4,list:0,mtg:1,description:'Gain 1 Base Energy,\nCannot Upgrade at Rest'},
        {name:'Darkstone',internal:'Energy/Curses',id:134,rarity:4,list:0,mtg:1,description:'Gain 1 Base Energy,\nAdd 2 Curses to Deck'},
        {name:'Bilingual Print',internal:'Energy/Currency',id:135,rarity:4,list:0,mtg:1,description:'Gain 1 Base Energy,\nGain 50% Less Currency'},
        {name:'Red-Tinted Glasses',internal:'Energy/Intent',id:136,rarity:4,list:0,mtg:1,description:'Gain 1 Base Energy,\nCannot See Enemy Intent Values'},
        {name:`Philosopher's Stone`,internal:'Energy/Strength',id:137,rarity:4,list:0,mtg:1,description:'Gain 1 Base Energy,\nEnemies Start Combat With 2 Strength'},
        {name:'Sozu',internal:'Energy/Items',id:138,rarity:4,list:0,mtg:1,description:'Gain 1 Base Energy,\nCannot Obtain Items'},
        {name:'Rainbow Flame',internal:'Energy/Draw',id:139,rarity:4,list:0,mtg:1,description:'Gain 1 Base Energy,\nDraw 1 Less Card Every 2 Turns'},

        {name:'Barrous Armband',internal:'Energy/Card Limit',id:140,rarity:4,list:0,mtg:1,description:'Gain 1 Base Energy,\nCannot Play More Than 7 Cards Every Turn'},
        {name:'Rhombic Rock',internal:'Energy/Initiative',id:141,rarity:4,list:0,mtg:1,description:'Gain 1 Base Energy,\nYou No Longer Start With Initiative'},
        {name:'Bipolar Dust',internal:'Energy/Fatigue',id:142,rarity:4,list:0,mtg:1,description:'Gain 1 Base Energy,\nFatigue Costs 2'},
        {name:'Durian',internal:'Energy/Max HP',id:143,rarity:4,list:0,mtg:1,description:'Gain 1 Base Energy,\nLose 10 Max HP'},
        {name:'AAAA Battery',internal:'Energy/Electrocuted',id:144,rarity:4,list:0,mtg:1,description:'Gain 1 Base Energy, Shuffle 1 Electrocuted\nInto Draw on Turn 1'},
        {name:'Purple Cape',internal:'Energy/Range',id:145,rarity:4,list:0,mtg:1,description:'Gain 1 Base Energy,\nYou Can Only Attack at Range 1'},
        ...
        {name:'Mandelbox',internal:'Rarer Rewards',id:164,rarity:-1,list:0,mtg:0,description:'Card Rewards Are Rarer'},
        {name:'Gold Bar',internal:'More Currency',id:165,rarity:-1,list:0,mtg:0,description:'Gain 25% More Currency'},
        {name:'Stocks',internal:'Currency Per Node',id:166,rarity:-1,list:0,mtg:0,description:'Gain 10 Currency Every Node'},
        {name:'Survival Notes',internal:'Random Fatigue Cost Decrease',id:167,rarity:-1,list:0,mtg:0,description:'25% of Fatigue is Cheaper'},
        {name:'Menger Square',internal:'No Effect',id:168,rarity:-1,list:-1,mtg:0,description:'Ran Out of Relics to Spawn'},
        {name:'Placeholder Relic',internal:'Placeholder',id:169,rarity:-1,list:-1,mtg:0,description:'${description()}'},

        {name:'Diamond Burger',internal:'Energy/Card Size',id:170,rarity:4,list:0,mtg:1,description:'Gain 1 Base Energy,\nAll Cards are Wide'},
        {name:'Big Game Guide',internal:'Elite Relic',id:171,rarity:4,list:0,mtg:1,description:'You Get +2 Relics Per Elite'},
        {name:'Cheap Disguise',internal:'Offcolor Card',id:172,rarity:1,list:0,mtg:1,description:'You Get a Card Option From Another Color'},
        {name:'Card Box',internal:'Take All Cards',id:173,rarity:1,list:0,mtg:0,description:'You Get The Option to Take All Cards'},
        {name:'Calendar',internal:'Turn 7 Bomb',id:174,rarity:2,list:0,mtg:0,description:'On Turn 7,\nDeal 52 Damage to All Enemies'},
        {name:'Crack Shot',internal:'Range Damage',id:175,rarity:0,list:0,mtg:0,description:'Deal 3 More Damage\nat Range 2+'},
        ...
        {name:'Golf Club',internal:'Rare Draw',id:194,rarity:1,list:0,mtg:0,description:'Draw 1 Card When You\nPlay a Rare Card'},
        ...
        {name:'Even Rock',internal:'Even Turn Block',id:197,rarity:1,list:0,mtg:0,description:'On Even Turns, Gain 5 Block'},
        {name:'Rough Gem',internal:'Extra Energy Block',id:198,rarity:1,list:0,mtg:1,description:'Extra Energy is Converted\nto 4 Block Per Energy'},
        {name:'Dirt Bucket',internal:'Remove Card Upgrade',id:199,rarity:-1,list:0,mtg:0,description:'After Removing a Card,\nUpgrade a Random Card'},

        {name:'Abstract Duck',internal:'Relic Strength',id:200,rarity:1,list:0,mtg:0,description:'Gain 1 Strength Per 10 Relics\nYou Own on Turn 1'},
        ...
        {name:'Boiler Plate',internal:'Item Card Draw',id:220,rarity:-1,list:0,mtg:0,description:'Draw 1 Card on Turn 1\nFor Every Item You Have'},
        {name:'Treasure Map',internal:'World 3 Currency',id:221,rarity:2,list:0,mtg:0,description:'Gain 1000 Currency if or When\nit is World 3 or Later'},
        {name:'Expired Coupon',internal:'Energy/Enemy Buffer',id:222,rarity:4,list:0,mtg:1,description:'Gain 1 Base Energy,\nEnemies That Hit You\nGain 1 Buffer'},
        {name:'Paper Snowflake',internal:'Last Card Free',id:223,rarity:-1,list:0,mtg:0,description:'When Taken, Make the\nLast Card in Deck Free'},
        {name:'SSh36',internal:'Starting Conditioning',id:224,rarity:0,list:0,mtg:0,description:'Gain 1 Conditioning\non Turn 1'},
        {name:'Purple Leaf',internal:'Uncommon Attack Heal',id:225,rarity:-1,list:0,mtg:0,description:'When You Play an Uncommon\nAttack, Heal 1 HP'},
        ...
        {name:'Clownfish',internal:'Edition Block',id:235,rarity:0,list:0,mtg:0,description:'Add 2 Block When You Play\na Card With an Edition'},        
        {name:'Philosophical Duck',internal:'Sell Relic',id:236,rarity:0,list:0,mtg:0,description:'When Sold, Gain a Relic'},
        {name:'MS Paint',internal:'Starting Draw Retain',id:237,rarity:1,list:0,mtg:0,description:'Draw 1 Card on Turn 1\nand Retain it Until Played'},
        ...
        {name:'Spearmint',internal:'25 Damage Draw',id:246,rarity:0,list:0,mtg:0,description:'Draw 1 Card When You\nDeal 25 or More Damage'},
        ...
        {name:'Rosemary',internal:'Fatigue Draw',id:251,rarity:2,list:0,mtg:0,description:'Draw 1 Card When You Play a Fatigue'},
        {name:'Frozen Frog',internal:'Extra Energy Double Damage',id:252,rarity:2,list:0,mtg:1,description:'When You End Your Turn With\n2 or More Energy, Your Next\nAttack Played Deals Double Damage'},
        {name:'Blood Diamond',internal:'Health Loss Currency',id:253,rarity:0,list:0,mtg:0,description:'When You Lose Health,\nGain 3 Currency Per HP Lost'},
        {name:'Managerial Banner',internal:'Rest Cost Down',id:254,rarity:2,list:0,mtg:0,description:'You May Reduce the Cost of a\nCard By 1 When Resting, 3 Uses'},
        {name:'Quartz Cube',internal:'3 Enemy Stun',id:255,rarity:1,list:0,mtg:0,description:'On Turn 1 Combats With 3 or More\nEnemies, Apply 2 Stun to a Random Enemy'},
        {name:'House of Cards',internal:'Fragile Damage Up',id:256,rarity:1,list:0,mtg:0,description:'Gain 2 Fragile Damage Up\non Turn 1'},
        {name:'Insanity Torch',internal:'Starting Madness',id:257,rarity:-1,list:0,mtg:0,description:'Add 1 Madness\non Turn 1'},
        {name:'Wand of Exorcism',internal:'Elite Max HP',id:258,rarity:2,list:0,mtg:0,description:'Gain 5 Max HP After Elite Combats'},
        ...
        {name:'Rare Voucher',internal:'Free Rare',id:268,rarity:3,list:0,mtg:0,description:'Rare Cards in the\nShop are Free'},
        {name:'Common Colorless Voucher',internal:'Cheap Common Colorless',id:269,rarity:3,list:0,mtg:0,description:'Common Colorless Cards in the\nShop Cost 50% Less'},

        {name:'Standard Pack Voucher',internal:'Standard Pack Discount',id:270,rarity:3,list:0,mtg:0,description:'Standard Packs in the\nShop Cost 50% Less'},
        ...
        {name:'Bottled Jasmine',internal:'Innate Power',id:278,rarity:3,list:0,mtg:0,description:'When Taken, Make a Power Innate'},
        {name:'Black Armor',internal:'Fatigue Block',id:279,rarity:0,list:0,mtg:0,description:'Gain 3 Block When\nYou Play a Fatigue'},

        {name:'Shiny Die',internal:'Energy/Chance',id:280,rarity:4,list:0,mtg:1,description:'Gain 1 Base Energy,\n1/6 Chance to Lose 1 Energy Each Turn'},
        {name:'Sparkler',internal:'Energy/Hard Elites',id:281,rarity:4,list:0,mtg:1,description:'Gain 1 Base Energy, Enemies in Elite\nCombats Start Combat With 5 Strength'},
        {name:'Sunglasses',internal:'Energy/Blind',id:282,rarity:4,list:0,mtg:1,description:'Gain 1 Base Energy, Cannot See\nMore Than 3 Map Nodes Ahead'},
        {name:'Calcite Rod',internal:'Energy/Immediate Currency',id:283,rarity:4,list:0,mtg:1,description:'Gain 1 Base Energy,\nWhen Taken, Lose 600 Currency'},
        {name:'Tobasco Sauce',internal:'Energy/Healing',id:284,rarity:4,list:0,mtg:1,description:'Gain 1 Base Energy,\nAll Healing is 50% Less Effective'},
        {name:'Setminus',internal:'Energy/Trough',id:285,rarity:4,list:0,mtg:1,description:'Gain 1 Base Energy, Shuffle 1 Trough\nInto Draw on Turn 1'},
        {name:'Gas Pipe',internal:'Energy/Fatigue Draw',id:286,rarity:4,list:0,mtg:1,description:'Gain 1 Base Energy, Fatigues Shuffle\nInto Draw Pile Instead of Discard Pile'},
        {name:'Duck Food',internal:'Energy/Ducks',id:287,rarity:4,list:0,mtg:1,description:'Gain 1 Base Energy, Spawn a Duck at the\nStart of Combat (Type Varies by World)'},
        {name:'Runic D20',internal:'Energy/Crit Fail',id:288,rarity:4,list:0,mtg:1,description:'Gain 1 Base Energy,\nAll Cards Have a 5% Chance to Fail'},
        {name:'Grey Star',internal:'Energy/Elite Relics',id:289,rarity:4,list:0,mtg:1,description:'Gain 1 Base Energy,\nElites Drop 1 Less Relic'},

        {name:'Solitaire',internal:'Always Deluxe Upgrade',id:290,rarity:4,list:0,mtg:1,description:'You May Deluxe\nUpgrade at Rest Sites'},
        ...
        {name:'Stopwatch',internal:'6 Turn Turn',id:298,rarity:4,list:0,mtg:1,description:'Every 6 Turns,\nTake Another Turn'},
        {name:'Assembly Line',internal:'Duplicate Per Turn',id:299,rarity:4,list:0,mtg:1,description:'The First Card Played\nEach Turn is Duplicated'},

        {name:'Uncommon Colorless Voucher',internal:'Cheap Uncommon Colorless',id:300,rarity:3,list:0,mtg:0,description:'Uncommon Colorless Cards in the\nShop Cost 50% Less'},
        {name:'Rare Colorless Voucher',internal:'Cheap Rare Colorless',id:301,rarity:3,list:0,mtg:0,description:'Rare Colorless Cards in the\nShop Cost 50% Less'},
        {name:'Common Relic Voucher',internal:'Common Relic Discount',id:302,rarity:3,list:0,mtg:0,description:'Common Relics in the\nShop Cost 50% Less'},
        ...
        {name:'Bedroll',internal:'Rest Free Card',id:310,rarity:1,list:0,mtg:0,description:'Gain a Card Reward\nWhenever You Rest'},
        {name:'Purple Ribbon',internal:'Upgrade All Skills',id:311,rarity:1,list:0,mtg:0,description:'Upgrade All Skills Added'},
        {name:'Skill Magazine',internal:'Upgrade Random Skills',id:312,rarity:0,list:0,mtg:0,description:'When Taken, Upgrade\n2 Random Skills'},
        {name:'Bottled Amaranth',internal:'Innate Skill',id:313,rarity:3,list:0,mtg:0,description:'When Taken, Make a Skill Innate'},
        {name:'Energized Jade',internal:'2 Cost Down Per Turn',id:314,rarity:-1,list:0,mtg:0,description:'Each Turn, 2 Random\nCards Cost 1 Less'},
        {name:'Proof of Donation',internal:'Normal Spectrals',id:315,rarity:-1,list:0,mtg:0,description:'Spectral Cards Have a Chance to\nAppear in Normal Card Rewards'},
        {name:'Miracle Blessing',internal:'Shuffle Miracle',id:316,rarity:-1,list:0,mtg:0,description:'Add a Miracle to Hand When\nYou Shuffle Your Draw Pile'},
        {name:'Call Button',internal:'Click to Swap',id:317,rarity:-1,list:0,mtg:0,description:'Click to Draw 1 Card and Discard a Card\n1 Use Per Encounter'},
        {name:'A Brief History of Time',internal:'Turn 10 Turn',id:318,rarity:-1,list:0,mtg:0,description:'On Turn 10, Take Another Turn'},
        {name:'The Road to Reality',internal:'Turn 5 Buffer',id:319,rarity:-1,list:0,mtg:0,description:'On Turn 5, Gain 1 Buffer'},

        {name:'Hina Charm',internal:'Curse Strength',id:320,rarity:-1,list:0,mtg:0,description:'Gain 1 Strength Per Curse\non Turn 1'},
        {name:'Barbcoin',internal:'Random Value',id:321,rarity:-1,list:0,mtg:0,description:'The Sell Value of This\nRelic is Dynamic'},
        {name:'Gaming Console',internal:'Glitched Cards',id:322,rarity:-1,list:0,mtg:0,description:'Glitched Cards Can Appear'},
        {name:'SCT Parts',internal:'Click to Block',id:323,rarity:-1,list:0,mtg:0,description:'Click to Add 15 Block\n1 Use Per Encounter'},
        {name:'Managerial History',internal:'Click For Energy',id:324,rarity:-1,list:0,mtg:1,description:'Click to Gain 2 Energy\n1 Use Per Encounter'},
        ...
        {name:'Jankman',internal:'Special Draw',id:338,rarity:0,list:0,mtg:0,description:'Draw 2 Cards When You\nPlay an Arcana or Spectral Card'},
        {name:'Chainlink',internal:'Energy/Event Options',id:339,rarity:4,list:0,mtg:1,description:'Gain 1 Base Energy,\nCan Only Choose First Option in Events'},
        ...
        {name:'Big Cube',internal:'25 Block Draw',id:353,rarity:0,list:0,mtg:0,description:'Draw 1 Card When You\nAdd 25 or More Block'},
        ...
        {name:'Lantern',internal:'First Turn Mana',id:360,rarity:0,list:0,mtg:2,description:'Gain (K) (K) on\nTurn 1'},
        {name:'Silver Ring',internal:'5 Turn Mana',id:361,rarity:0,list:0,mtg:2,description:'Gain (G) (G) Every 5th Turn'},
        {name:'Sickle',internal:'Death Boost (M)',id:362,rarity:2,list:0,mtg:2,description:'When an Enemy Dies,\nGain (R) (R) and Draw 1 Card'},
        {name:'Glass Sphere',internal:'Retain Mana',id:363,rarity:1,list:0,mtg:2,description:'1 Random Mana Can be\nRetained Between Turns'},
        {name:'Soda Bottle',internal:'No Attack Mana',id:364,rarity:0,list:0,mtg:2,description:'When You Do Not Attack,\nGain (B) (B) Next Turn'},
        {name:'Regal Pillow',internal:'Rest Mana',id:365,rarity:0,list:0,mtg:2,description:'Gain (W) (B) (K) (G) (R)\nAfter Resting'},
        {name:'Keystone',internal:'Damage Taken Energy',id:366,rarity:0,list:0,mtg:1,description:'Gain 1 Energy the First\nTime You Take Damage Each Combat'},
        {name:'Keystone',internal:'Damage Taken Mana',id:367,rarity:0,list:0,mtg:2,description:'Gain (W) (W) the First\nTime You Take Damage Each Combat'},
        {name:'Orchid',internal:'8 Attack Mana',id:368,rarity:0,list:0,mtg:2,description:'Every 8 Attacks\nPlayed, Gain (W)'},
        {name:'Diode',internal:'Turn 2 Mana',id:369,rarity:1,list:0,mtg:2,description:'Gain (N) (N) (N) at\nthe Start of Turn 2'},
        
        {name:'Top Hat',internal:'Shop Mana',id:370,rarity:0,list:0,mtg:2,description:'Gain (W) (B) (K) (G) (R) After\nEntering a Shop'},
        {name:'Purple Sunflower',internal:'Discard Over Draw Mana',id:371,rarity:2,list:0,mtg:2,description:'Gain (G) Each Turn When Discard Pile\nHas More Cards Than Draw Pile'},
        ...
        {name:'The Duo',internal:'Same Card Mana',id:374,rarity:1,list:0,mtg:2,description:'Gain (N) When You Play\n2 of the Same Card in a Row\nThat Costs 1 or More Mana'},
        ...
        {name:'Ice Cube',internal:'First Block Mana',id:384,rarity:2,list:0,mtg:2,description:'Gain (B) the First Time\nYou Gain Block Each Turn'},
        ...
        {name:'Vinyl',internal:'Status Draw Mana',id:386,rarity:1,list:0,mtg:2,description:'Gain (K) When You Draw a\nStatus Card Other Than Fatigue'},
        {name:'Ticket to Hell',internal:'Health Loss Draw',id:387,rarity:2,list:0,mtg:0,description:'When You Lose Health,\nDraw 1 Card'},
        {name:'Super Mushroom',internal:'Random Rare Items',id:388,rarity:1,list:0,mtg:0,description:'When Taken, Fill All Item\nSlots With Rare Items'},
        {name:'Bass Drum',internal:'Same Color Temporary Strength',id:389,rarity:1,list:0,mtg:2,description:'When You Play a Card That is the\nSame Color as the Last One Played,\nGain 2 Temporary Strength'},

        {name:'Auto Arm',internal:'Neutral Mana/Upgrade',id:390,rarity:4,list:0,mtg:2,description:'Add (N) to Base Mana,\nWhen Taken, Upgrade 5 Random Cards',manaColor:0},
        {name:'Toolbox',internal:'Neutral Mana/Colorless Cards',id:391,rarity:4,list:0,mtg:2,description:'Add (N) to Base Mana,\nGain a Colorless Card Reward\nAfter Elite and Boss Combats',manaColor:0},
        {name:'Pure Nebula',internal:'Neutral Mana/Pristine',id:392,rarity:4,list:0,mtg:2,description:'Add (N) to Base Mana,\nAdd a Pristine on Turn 1',manaColor:0},
        {name:'Normallium Z',internal:'Neutral Mana/Neutral Basic',id:393,rarity:4,list:0,mtg:2,description:'Add (N) to Base Mana,\nImprove Effects of Basic Attacks and\nDefenses by 100% Per (N) Spent',manaColor:0},
        {name:'Lunar Gateway',internal:'Neutral Mana/Exhaust Mana',id:394,rarity:4,list:0,mtg:2,description:'Add (N) to Base Mana,\nGain (N) When a Card That\nCosts 1 or More Exhausts',manaColor:0},
        {name:'Golden Horn',internal:'White Mana/Extra Mana Barrier',id:395,rarity:4,list:0,mtg:2,description:'Add (W) to Base Mana,\nEach Turn, Add 3 Barrier If\nYou Have Leftover Mana',manaColor:1},
        {name:'Platinum Spoon',internal:'White Mana/Items',id:396,rarity:4,list:0,mtg:2,description:'Add (W) to Base Mana,\nGain an Item After Every Combat',manaColor:1},
        {name:'Beautiful Plate',internal:'White Mana/Upgrade',id:397,rarity:4,list:0,mtg:2,description:'Add (W) to Base Mana,\nUpgrade 3 Cards on Turn 1',manaColor:1},
        {name:'Cloud Fertilizer',internal:'White Mana/Immunity',id:398,rarity:4,list:0,mtg:2,description:'Add (W) to Base Mana,\nYou Cannot Become Weak,\nVulnerable or Frail',manaColor:1},
        {name:'Mask of Hope',internal:'White Mana/3 Attack Cleanse',id:399,rarity:4,list:0,mtg:2,description:'Add (W) to Base Mana,\nEvery 3 Attacks Played,\nRemove 1 Fatigue',manaColor:1},

        {name:'Aquamarine',internal:'Blue Mana/Free Card',id:400,rarity:4,list:0,mtg:2,description:'Add (B) to Base Mana,\nThe First Card Played\nEvery Combat is Free',manaColor:3},
        {name:'Magic Poker',internal:'Blue Mana/Early Draw',id:401,rarity:4,list:0,mtg:2,description:'Add (B) to Base Mana,\nDraw 1 More Card on the First\n3 Turns Each Combat',manaColor:3},
        {name:'Telescope',internal:'Blue Mana/Astrology',id:402,rarity:4,list:0,mtg:2,description:'Add (B) to Base Mana,\nAdd 2 Astrologies on Turn 1',manaColor:3},
        {name:'Icy Scale',internal:'Blue Mana/Power Mana',id:403,rarity:4,list:0,mtg:2,description:'Add (B) to Base Mana,\nWhen You Play a Power, Gain (B)',manaColor:3},
        {name:'Capillary Cup',internal:'Blue Mana/Stride',id:404,rarity:4,list:0,mtg:2,description:'Add (B) to Base Mana,\nAdd a Stride to Hand Each Turn\nif You Draw No Movement Cards',manaColor:3},
        {name:'Rejector 3000',internal:'Black Mana/Remove 2',id:405,rarity:4,list:0,mtg:2,description:'Add (K) to Base Mana,\nWhen Taken, Remove 2 Cards',manaColor:2},
        {name:'Coffee Filter',internal:'Black Mana/Better Rest Heal',id:406,rarity:4,list:0,mtg:2,description:'Add (K) to Base Mana,\nHeal to Full When Resting',manaColor:2},
        {name:'Lævateinn',internal:'Black Mana/Vulnerable',id:407,rarity:4,list:0,mtg:2,description:'Add (K) to Base Mana,\nVulnerable Enemies Take\nDouble Damage Instead',manaColor:2},
        {name:'Asphalt Block',internal:'Black Mana/Triple Damage',id:408,rarity:4,list:0,mtg:2,description:'Add (K) to Base Mana,\nThe First Attack Each Combat\nDeals Triple Damage',manaColor:2},
        {name:'Galaxy Marble',internal:'Black Mana/Turn 5 Strength/Turn 5 Dexterity',id:409,rarity:4,list:0,mtg:2,description:'Add (K) to Base Mana,\nOn Turn 5, Gain 2 Strength\nand 2 Dexterity',manaColor:2},

        {name:'Watermelon',internal:'Green Mana/10 Max HP',id:410,rarity:4,list:0,mtg:2,description:'Add (G) to Base Mana,\nGain 10 Max HP',manaColor:4},
        {name:'Sozu',internal:'Green Mana/Item Slots',id:411,rarity:4,list:0,mtg:2,description:'Add (G) to Base Mana,\nWhen Taken, Gain 3 Item Slots',manaColor:4},
        {name:'Fern Seeds',internal:'Green Mana/Armor',id:412,rarity:4,list:0,mtg:2,description:'Add (G) to Base Mana,\nGain 3 Armor on Turn 1',manaColor:4},
        {name:'Colias Eurytheme',internal:'Green Mana/Quick Heal',id:413,rarity:4,list:0,mtg:2,description:'Add (G) to Base Mana,\nHeal 4 HP at the End of Combat',manaColor:4},
        {name:'Helicogyre',internal:'Green Mana/3 Turn Dodge',id:414,rarity:4,list:0,mtg:2,description:'Add (G) to Base Mana,\nGain 1 Dodge Every 3 Turns',manaColor:4},
        {name:'Bilingual Print',internal:'Red Mana/Currency',id:415,rarity:4,list:0,mtg:2,description:'Add (R) to Base Mana,\nGain 25% More Currency',manaColor:5},
        {name:'Shattered Chains',internal:'Red Mana/Difficulty Mana',id:416,rarity:4,list:0,mtg:2,description:'Add (R) to Base Mana,\nGain (R) Every Turn on\nElite and Boss Combats',manaColor:5},
        {name:'Red Paperclip',internal:'Red Mana/Rare Relic',id:417,rarity:4,list:0,mtg:2,description:'Add (R) to Base Mana,\nWhen Taken, Gain a Rare Relic',manaColor:5},
        {name:'Tiny Lava Dome',internal:'Red Mana/Strength/Burns',id:418,rarity:4,list:0,mtg:2,description:'Add (R) to Base Mana,\nGain 2 Strength and Shuffle 2 Burns\ninto Draw Pile on Turn 1',manaColor:5},
        {name:'Cantor Dust',internal:'Red Mana/Transform',id:419,rarity:4,list:0,mtg:2,description:'Add (R) to Base Mana,\nWhen Taken, Transform 2 Cards',manaColor:5},

        {name:'Concave Star',internal:'Rainbow Mana/Card Choice',id:420,rarity:4,list:0,mtg:2,description:'Add (E) to Base Mana,\nCard Rewards Have 1 More Choice',manaColor:6},
        {name:'Perpetual Library',internal:'Rainbow Mana/Any Rare Card',id:421,rarity:4,list:0,mtg:2,description:'Add (E) to Base Mana,\nWhen Taken, Choose and Add a\nDouble Upgraded Rare Card to Deck',manaColor:6},
        {name:'Rainbow Lotus',internal:'Rainbow Mana/Mana Gain Block',id:422,rarity:4,list:0,mtg:2,description:'Add (E) to Base Mana,\nAdd 6 Block When You Gain Mana',manaColor:6},
        {name:'Magatama',internal:'Rainbow Mana/5 Cost Mana',id:423,rarity:4,list:0,mtg:2,description:'Add (E) to Base Mana,\nCards Costing 5 or More\nGive (E) When Played',manaColor:6},
        {name:'Opus Magnum',internal:'Rainbow Mana/Rainbow Retain',id:424,rarity:4,list:0,mtg:2,description:'Add (E) to Base Mana,\nRetain Up to 1 Unspent (E) Each Turn',manaColor:6},
        {name:'Pentaxon',internal:'Random Mana/Random',id:425,rarity:4,list:0,mtg:2,description:'Gain a Random Mana Each Turn,\nWhen Taken, Gain 200 Currency,\n5 Max HP, and Upgrade a Random Card',manaColor:7},
        {name:'Big Game Guide',internal:'Random Mana/Elite Relic',id:426,rarity:4,list:0,mtg:2,description:'Gain a Random Mana Each Turn,\nYou Get +1 Relic Per Elite',manaColor:7},
        {name:'Glow Up',internal:'Random Mana/Editions',id:427,rarity:4,list:0,mtg:2,description:'Gain a Random Mana Each Turn,\nCards are 2x More Likely\nto Have Editions',manaColor:7},
        ...
        {name:'Radio Receiver',internal:'Emergency Push',id:433,rarity:0,list:0,mtg:0,description:'Add 1 Emergency Push\non Turn 1'},
        ...
        {name:'Preserved Insect',internal:'Boss Debuff',id:447,rarity:0,list:0,mtg:0,description:'Enemies in Boss Combats Gain\n2 Weak, Vulnerable, and Frail\non Turn 1'},
        ...
        {name:'Curious Eye',internal:'Starting Pull',id:456,rarity:2,list:0,mtg:0,description:'On Turn 1,\nPut a Card in Your\nDraw Pile in Your Hand'},
        ...
        {name:'Green Pentachoron',internal:'No Fatigue',id:471,rarity:4,list:0,mtg:1,description:'Never Get Fatigued Again'},
        ...
        {name:'Bristle',internal:'Block Auto Counter',id:478,rarity:0,list:0,mtg:0,description:'When You Gain Block,\nCounter 1 All'},
        {name:'Broken Radio',internal:'Combat Farsight',id:479,rarity:0,list:0,mtg:0,description:'You Can See Enemies in Combats\nFarther Away on the Map'},

        {name:'Roller Bearing',internal:'Shuffle Damage',id:480,rarity:0,list:0,mtg:0,description:'When You Shuffle Your Draw Pile,\nDeal 5 Damage to a Random Enemy'},
        {name:'Ice Tray',internal:'Draw Damage',id:481,rarity:0,list:0,mtg:0,description:'When You Draw a Card\nOther Than During the Draw Step,\nDeal 1 Damage to a Random Enemy'},
        {name:'Schlafli Symbol',internal:'Injured Weak',id:482,rarity:1,list:0,mtg:0,description:'When an Enemy Goes Below 25% Health,\nIt Becomes Indefinitely Weak'},
        {name:'Dumpling',internal:'Stash Heal',id:483,rarity:0,list:0,mtg:0,description:'When You Enter a Stash,\nHeal 20 Health'},
        {name:'Opaque Marble',internal:'Same Card Triplicate',id:484,rarity:2,list:0,mtg:0,description:'When You Play 2 of\nthe Same Card in a Row,\nAdd an Ethereal Third Copy to Hand\n1 Use Per Turn'},
        {name:'Walkie Talkie',internal:'Emergency Draw',id:485,rarity:2,list:0,mtg:0,description:'Add an Emergency Draw\non Turn 1'},
        {name:'Dulled Axe',internal:'Bypass Defense',id:486,rarity:1,list:0,mtg:0,description:'Remove All Enemy Buffer, Dodge,\nand Fractional Damage Reduction\nWhen You Hit Them'},
        ...
        {name:'White Ribbon',internal:'Upgrade All Offcolor',id:491,rarity:1,list:0,mtg:0,description:'Upgrade All Offcolor Cards Added'},
        ...
        {name:'Invis Watch',internal:'Starting Temporary Speed Down',id:496,rarity:2,list:0,mtg:0,description:'On Turn 1,\nApply 1 Temporary Speed Down\nto All Enemies'},
        {name:'Typewriter Key',internal:'Letter Card',id:497,rarity:2,list:0,mtg:0,description:'When Taken, Choose and Add\nAny Card to Deck That Starts\nWith a Randomly Generated Letter'},
        ...
        {name:'Sod',internal:'Unupgraded Block',id:499,rarity:0,list:0,mtg:0,description:'Add 1 Block When You Play\nan Unupgraded Card'},

        {name:'Protectorate Projection',internal:'Starting Intangible',id:500,rarity:2,list:0,mtg:0,description:'Gain 1 Intangible\non Turn 1'},
        {name:'Twisted Wire',internal:'Starting Cheap Power',id:501,rarity:2,list:0,mtg:0,description:'On Turn 1,\nDraw a Power, it Costs 1 Less'},
        {name:'Bottled Wish',internal:'Starting Random Reward',id:502,rarity:2,list:0,mtg:0,description:'At the Start of Combat,\nRandomly Gain 3 Strength,\n10 Armor, or 50 Currency'},
        {name:'Honeycomb',internal:'Extended Starting Draw',id:503,rarity:2,list:0,mtg:0,description:'Draw 1 More Card Per Turn\nFor the First 5 Turns'},
        {name:'Bleach',internal:'Colorless Deck',id:504,rarity:3,list:0,mtg:0,description:'Replace a Card Reward\nOption With a Colorless One'},
        {name:'Shop Phone',internal:'Heal Anytime',id:505,rarity:3,list:0,mtg:0,description:'Click to Use the Shop Food Heal Anytime'},
        {name:'Immoral Elixir',internal:'Energy/Turn 6 Health',id:506,rarity:4,list:0,mtg:1,description:'Gain 1 Base Energy,\nLose 6 Health on Turn 6'},
        {name:'Ochre Slime',internal:'Energy/Stuck',id:507,rarity:4,list:0,mtg:1,description:'Gain 1 Base Energy, Shuffle 1 Stuck\nInto Draw on Turn 1'},
        {name:`Prince Rupert's Drop`,internal:'Safe Energy',id:508,rarity:4,list:0,mtg:1,description:'Gain 1 Base Energy,\nUntil You Lose Health Each Combat'},
        {name:'600-Cell',internal:'Free Innate',id:509,rarity:4,list:0,mtg:1,description:'When Taken,\nMake a Card Innate and Free'},

        {name:'Transformer 5000',internal:'Transform 10',id:510,rarity:4,list:0,mtg:1,description:'When Taken, Transform 10 Cards'},
        {name:'Replicating Cake',internal:'Random Boss Relic/10 Max HP',id:511,rarity:4,list:0,mtg:1,description:'When Taken, Gain a Random Boss Relic\nand Gain 10 Max HP'},
        {name:'Draft Card',internal:'Draw Up/Draft 10',id:512,rarity:4,list:0,mtg:1,description:'Draw 1 More Card Per Turn\nWhen Taken, Receive 10 Card Rewards'},
        {name:'Capstone',internal:'Leftmost Energy',id:513,rarity:4,list:0,mtg:1,description:'Each Turn, Gain 1 Energy if\nYou Play the Leftmost Card First'},
        {name:'Flow Limiter',internal:'Energy/Kill Limit',id:514,rarity:4,list:0,mtg:1,description:'Gain 1 Base Energy,\nOnly 1 Enemy Can Die Per Turn'},
        {name:'Taraxis',internal:'Extra Mana Temporary Dexterity',id:515,rarity:2,list:0,mtg:2,description:'Extra Mana is Converted\nto Temporary Dexterity'},
