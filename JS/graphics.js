	...
	switch(type){
		...
		case 11:
			...
			for(let a=0,la=9;a<la;a++){
				layer.rect(layer.width/2-350,layer.height/2-360+a*90,350,80)
				layer.rect(layer.width/2+350,layer.height/2-360+a*90,350,80)
			}
			layer.fill(0)
			layer.rect(layer.width/2,layer.height*0.6,100,100)
			...
			for(let a=0,la=9;a<la;a++){
				layer.rect(layer.width/2-382.5,layer.height/2-360+a*90,260,55)
				layer.rect(layer.width/2+317.5,layer.height/2-360+a*90,260,55)
				layer.rect(layer.width/2-215,layer.height/2-360+a*90,55,55)
				layer.rect(layer.width/2+485,layer.height/2-360+a*90,55,55)
			}
			layer.fill(120)
			regTriangle(layer,layer.width/2-5,layer.height*0.6,40,40,-30)
			layer.fill(255)
			...
			layer.text('-1 DRAW',layer.width/2-382.5,layer.height*0.5-360)
			layer.text('CYCLIC DRAW',layer.width/2-382.5,layer.height*0.5-270)
			layer.text('CARD SLOT DRAW',layer.width/2-382.5,layer.height*0.5-180)
			layer.text('CHOOSE OR LOSE DRAW',layer.width/2-382.5,layer.height*0.5-90)
			layer.text('20% HP',layer.width/2-382.5,layer.height*0.5)
			layer.text('SHORT MAP',layer.width/2-382.5,layer.height*0.5+90)
			layer.text('QUICK MODE',layer.width/2-382.5,layer.height*0.5+180)
			layer.text('PRISM',layer.width/2-382.5,layer.height*0.5+270)
			layer.text('ALL VANISHING',layer.width/2-382.5,layer.height*0.5+360)
			layer.text('DECKBUILD DEFENDS',layer.width/2+317.5,layer.height*0.5-360)
			layer.text('BLACKJACK DRAW',layer.width/2+317.5,layer.height*0.5-270)
			layer.text('CARD TECHIFY MODE',layer.width/2+317.5,layer.height*0.5-180)
			layer.text('COMPRESSION DRAW',layer.width/2+317.5,layer.height*0.5-90)
			layer.text('50% HP',layer.width/2+317.5,layer.height*0.5)
			layer.text('SHORTER MAP',layer.width/2+317.5,layer.height*0.5+90)
			layer.text('MINIMIZE ANIMATION',layer.width/2+317.5,layer.height*0.5+180)
			layer.text('ULTRAPRISM',layer.width/2+317.5,layer.height*0.5+270)
			layer.text('SILENT CARDS',layer.width/2+317.5,layer.height*0.5+360)
		break
		case 12:
			menuBackground(layer)
			layer.fill(120)
