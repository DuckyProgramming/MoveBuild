...
function setupBackground(type,layer){
	switch(type){
		...
		case 9:
			...
			layer.rect(layer.width/2,layer.height-60,415,80)
			layer.rect(layer.width/2,layer.height-137.5,225,55)
			layer.fill(0)
			...
			layer.rect(layer.width/2,layer.height-60,120,55)
			layer.rect(layer.width/2-135,layer.height-60,120,55)
			layer.rect(layer.width/2+135,layer.height-60,120,55)
			layer.rect(layer.width/2,layer.height-137.5,200,30)
			layer.fill(120)
			regTriangle(layer,layer.width/2+295,layer.height*0.6,40,40,-30)
			regTriangle(layer,layer.width/2-135,layer.height-60,22.5,22.5,-30)
			regTriangle(layer,layer.width/2-15,layer.height-60,22.5,22.5,-30)
			regTriangle(layer,layer.width/2+15,layer.height-60,22.5,22.5,-30)
			regTriangle(layer,layer.width/2+105,layer.height-60,22.5,22.5,-30)
			regTriangle(layer,layer.width/2+135,layer.height-60,22.5,22.5,-30)
			regTriangle(layer,layer.width/2+165,layer.height-60,22.5,22.5,-30)
			layer.fill(255)
			layer.textSize(20)
			for(let a=0,la=types.ascend.length;a<la;a++){
				layer.text(a,25+(layer.width-50)*(0.5+a)/la,240)
			}
			layer.text('ANIMATION SPEED',layer.width/2,layer.height-137.5)
