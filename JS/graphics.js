	...
	switch(type){
		case 0:
			...
			for(let g=0;g<graphics.combatant[graphics.combatant.length-1].sprites.genAmount;g++){
				...
				generateSprite(graphics.combatant[graphics.combatant.length-1].sprites.kimono.main.front[g],4,g*graphics.combatant[graphics.combatant.length-1].sprites.detail)
				...
				generateSprite(graphics.combatant[graphics.combatant.length-1].sprites.kimono.main.back[g],5,g*graphics.combatant[graphics.combatant.length-1].sprites.detail)
			...
			for(let g=0;g<graphics.combatant[graphics.combatant.length-1].sprites.genAmount;g++){
				...
				generateSprite(graphics.combatant[graphics.combatant.length-1].sprites.kimono.outside.front[g],2,g*graphics.combatant[graphics.combatant.length-1].sprites.detail)
				...
				generateSprite(graphics.combatant[graphics.combatant.length-1].sprites.kimono.outside.back[g],3,g*graphics.combatant[graphics.combatant.length-1].sprites.detail)
