	...
	switch(type){
		...
		case 11:
			...
			for(let a=0,la=8;a<la;a++){
				...
				layer.rect(layer.width/2-215,layer.height/2-315+a*90,55,55)
				layer.rect(layer.width/2+485,layer.height/2-315+a*90,55,55)
			}
			layer.fill(120)
			regTriangle(layer,layer.width/2-5,layer.height*0.6,40,40,-30)
			layer.fill(255)
			...
			layer.text('50% HP',layer.width/2-382.5,layer.height*0.5-45)
			layer.text('SHORT MAP',layer.width/2-382.5,layer.height*0.5+45)
			layer.text('QUICK MODE',layer.width/2-382.5,layer.height*0.5+135)
			layer.text('PRISM',layer.width/2-382.5,layer.height*0.5+225)
			layer.text('ALL VANISHING',layer.width/2-382.5,layer.height*0.5+315)
			...
			layer.text('CHOOSE OR LOSE DRAW',layer.width/2+317.5,layer.height*0.5-135)
			layer.text('20% HP',layer.width/2+317.5,layer.height*0.5-45)
			layer.text('SHORTER MAP',layer.width/2+317.5,layer.height*0.5+45)
			layer.text('MINIMIZE ANIMATION',layer.width/2+317.5,layer.height*0.5+135)
			layer.text('ULTRAPRISM',layer.width/2+317.5,layer.height*0.5+225)
			layer.text('SILENT CARDS',layer.width/2+317.5,layer.height*0.5+315)
		break
		case 12:
			menuBackground(layer)
			layer.fill(120)
