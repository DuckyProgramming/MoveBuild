class attack{
    ...
    update(){
        ...
        switch(this.type){
            ...
            case 783: case 794: case 800: case 809: case 810: case 811: case 831:
            ...
            case 583: case 584: case 600: case 671: case 672: case 673: case 767: case 785:
                if(variants.nobasicanim){
                    this.selfCall(12)
                    this.remove=true
                }else{
