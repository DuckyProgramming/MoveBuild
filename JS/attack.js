class attack{
    constructor(type,battle,player,effect,attackClass,user,level,color,energy,target,targetDistance,targetClass,combo,replayData,amplify,relPos,limit){
        this.type=type
        this.battle=battle
        this.player=player
        this.effect=effect
    ...
    base(){
        ...
        switch(this.attackClass){
            case 1:
                this.clearAttack=[false,false,false,false]
        ...
        switch(this.type){
            ...
            case 1097: case 1100: case 1111: case 1123: case 1126: case 1128: case 1133: case 1135: case 1139:
        ...
        switch(type){
            case 0:
                ...
                switch(this.type){
                    ...
                    break
                    case 779:
                        this.userManager.reserve.addShuffle(findName('End\nUp',types.card),0,0)
                    break
                    case 784:
            ...
            case 1:
                ...
                switch(this.type){
                    ...
                    break
                    case 735:
                        this.userManager.reserve.addShuffle(findName('Insight',types.card),0,0)
                    break
                    case 745:
            ...
            case 4:
                switch(this.type){
                    ...
                    case 605:
                        for(let a=0,la=this.effect[0];a<la;a++){
                            this.userManager.addRandomAllClass(2,0,7)
                        }
                    break
                    case 607:
                    ...
                    break
                    case 790:
                        this.userManager.reserve.addShuffle(findName('Beta',types.card),0,0)
                    break
                    case 791:
                        this.userManager.reserve.addShuffle(findName('Omega',types.card),0,0)
                    break
                    case 797:
                        this.userManager.drawPrice(this.effect[0],0)
                        if(this.battle.counter.turnPlayed[0]==1){
                    ...
                    break
                    case 970:
                        this.userManager.exhaust(this.effect[0])
                        for(let a=0,la=this.effect[1];a<la;a++){
                    ...
                    case 1096:
                        ...
                        this.userManager.reserve.add(findName('Magic\nTrick Card',types.card),this.level,0)
                    break
                    case 1098:
            ...
            case 7:
                switch(this.type){
                    ...
                    break
                    case 865:
                        this.targetClass.takeDamage(this.amplify?this.battle.energy.main[this.player]*this.effect[0]:this.userManager.hand.cards.length+this.effect[0],this.user)
                    break
                    case 877:
                    ...
                    break
                    case 1071:
                        this.battle.combatantManager.summonConstruct(this.targetTile.tilePosition,findName('AllyMonkey',types.combatant),this.userCombatant.team,this.direction,this.user)
                    break
                    case 1075:
                        this.targetCombatant.takeDamage(this.effect[0],this.user)
            ...
            case 10:
                switch(this.type){
                    ...
                    break
                    case 792:
                        this.userManager.reserve.addShuffleEffect_1(findName('Expunger',types.card),0,0,this.energy+this.effect[0])
                    break
                    case 845:
                        for(let a=0,la=this.effect[0];a<la;a++){
                            this.battle.dropDraw(this.player,findName('Dark Matter',types.card),0,this.color)
                        }
                    break
                    case 888:
                        this.targetCombatant.takeDamage(this.effect[0],this.user)
                    ...
                    case 1140:
                        this.userCombatant.ammo+=this.effect[0]
                        this.userCombatatn.statusEffect('Regeneration',this.effect[1])
                        this.battle.attackManager.endAfter=true
                    break
                    case 1142:
                        this.userCombatant.ammo+=this.effect[0]
    ...
    update(){
        ...
        switch(this.type){
            ...
            case 1087: case 1089: case 1090: case 1091: case 1092: case 1100: case 1123: case 1133: case 1135:
                if(this.type==780){
                    let failed=false
                    for(let a=0,la=this.userManager.hand.cards.length;a<la;a++){
            ...
            break
            case 5: case 121: case 764: case 987:
            ...
            case 1074: case 1079: case 1093: case 1094: case 1108: case 1124: case 1125: case 1138:
            ...
            case 1095: case 1096: case 1098: case 1109: case 1110: case 1120: case 1121: case 1134:
            ...
            case 1034: case 1036: case 1047: case 1052: case 1126:
                if(variants.nobasicanim){
                    this.selfCall(9)
                    this.remove=true
                }else{
            ...
            case 854: case 856: case 879: case 894: case 956: case 971: case 1000: case 1056: case 1060: case 1103:
