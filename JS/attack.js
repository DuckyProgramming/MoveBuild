class attack{
    ...
    base(){
        ...
        switch(this.type){
            ...
            case 2487: case 2492: case 2493: case 2494: case 2496: case 2497: case 2498:
                //mark 1
        ...
        switch(type){
            case 0:
                ...
                switch(this.type){
                    ...
                    break
                    case 42: case 1354: case 1561: case 1770: case 2128:
                        this.userManager.draw(this.effect[1])
                    break
                    case 53:
                    ...
                    case 2428:
                        ...
                        this.battle.overlayManager.overlays[10][this.player].activate([0,2,13])
                    break
                    case 2430:
                        if(this.targetCombatant.life>0){
                            this.userCombatant.addBlock(this.effect[1])
            ...
            case 3:
                switch(this.type){
                    ...
                    break
                    case 2394:
                        this.userManager.discard.randomEffect(35,[this.userManager.hand.cards])
                    break
                    case 2407:
                        this.userCombatant.statusEffect('Luck Guarantee',1)
