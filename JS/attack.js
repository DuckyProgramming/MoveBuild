class attack{
    constructor(type,battle,player,effect,attackClass,user,level,color,energy,target,targetDistance,targetClass,combo,replayData,amplify,relPos,limit,id,edition,drawn){
        this.type=type
        this.battle=battle
        this.player=player
        this.effect=effect
    ...
    base(){
        ...
        switch(this.type){
            ...
            case 2800: case 2803: case 2806: case 2808: case 2810: case 2811: case 2813:
                //mark 1
        ...
        switch(type){
            case 0:
                ...
                switch(this.type){
                    ...
                    break
                    case 115:
                        this.battle.dropDraw(this.player,findName('Anger',types.card),this.level,this.color,this.edition)
                    break
                    case 123:
                    ...
                    break
                    case 273: case 2135: case 2235: case 2378: case 2770:
                        this.userCombatant.addBlock(this.effect[1])
                    break
                    case 274:
                    ...
                    break
                    case 2723:
                        if(this.userManager.hand.deStatus(1)==1){
                            this.userCombatant.statusEffect('Knowledge',this.effect[1])
                        }
                    break
                    case 2728:
                    ...
                    case 2739:
                        this.userCombatant.addBlock(this.effect[1])
                        this.userManager.deFatigue(this.effect[2])
                    break
                    case 2746:
                        if(this.targetCombatant.blocked<=1){
                            this.userCombatant.addBlock(this.effect[1])
            ...
            case 1:
                ...
                switch(this.type){
                    ...
                    break
                    case 43: case 2200: case 2425: case 2804:
                        this.userManager.draw(this.effect[1])
                    break
                    case 50:
                    ...
                    break
                    case 2767:
                        if(this.energy>this.battle.energy.base[this.player]){
                            this.battle.energy.main[this.player]+=this.effect[1]
                        }
                    break
                    case 2769:
            ...
            case 12:
                switch(this.type){
                    ...
                    case 2674:
                        this.targetCombatant.takeDamage(this.effect[0],this.user)
                        this.battle.energy.main[this.player]+=this.userCombatant.getStatus('Awakening')
                    break
                    case 2693:
                        this.targetCombatant.takeDamage(this.effect[0],this.user)
                        this.targetCombatant.statusEffect('Vulnerable',this.effect[1])
