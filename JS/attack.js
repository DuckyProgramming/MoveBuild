class attack{
    ...
    base(){
        ...
        switch(this.type){
            ...
            case 3505: case 3506: case 3509: case 3511: case 3513: case 3516: case 3519: case 3520: case 3527: case 3530: case 3532: case 3535: case 3545: case 3554:
                //mark 1
        ...
        switch(type){
            ...
            case 0:
                ...
                switch(this.type){
                    ...
                    break
                    case 273: case 2135: case 2378: case 2770: case 3519:
                        this.userCombatant.addBlock(this.effect[1])
                    break
                    case 274:
                    ...
                    break
                    case 1656:
                        this.userCombatant.base.loseHealth(this.effect[1])
            ...
            case 3:
                switch(this.type){
                    ...
                    case 3551:
                        if(variants.mtg){
                            for(let a=0,la=this.effect[0];a<la;a++){
                                this.battle.addSpecificEnergy(1,this.player,floor(random(0,6)))
                            }
                        }else{
