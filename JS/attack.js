class attack{
    ...
    base(){
        ...
        switch(this.type){
            ...
            case 1755: case 1762: case 1763: case 1764: case 1765: case 1766:
                //mark 1
    ...
    selfCall(type){
        switch(type){
            case 0:
                switch(this.type){
                    case 12: case 719: case 1213: case 1733:
                    ...
                    break
                    case 1661:
                        this.targetCombatant.takeDamage(this.effect[0]*(this.targetCombatant.block>0?1/this.effect[1]:1),this.user)
                    break
                    case 1686:
            ...
            case 2:
                switch(this.type){
                    ...
                    break
                    case 1582:
                        this.battle.combatantManager.statusAreaIDBlock('Poison',this.effect[1],this.userCombatant.id,this.targetTile.tilePosition)
                    break
                    case 1583:
