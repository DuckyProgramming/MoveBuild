class attack{
    ...
    base(){
        ...
        switch(this.type){
            ...
            case 3292: case 3293: case 3294: case 3332: case 3378:
        ...
        switch(type){
            ...
            case 0:
                switch(this.type){
                    ...
                    break
                    case 101:
                        this.targetCombatant.takeDamage(this.effect[0]*(this.userManager.hand.turnPlayed[this.player]<=1?2:1),this.user)
                    break
                    case 117:
                    ...
                    break
                    case 3304:
                        this.targetCombatant.takeDamage(this.effect[0]*(this.battle.tileManager.getArea(this.userCombatant.tilePosition,1).length==0?2:1),this.user)
                    break
                    case 3364:
                ...
                switch(this.type){
                    ...
                    break
                    case 111:
                        if(this.userManager.hand.turnPlayed[this.player]<=this.effect[1]+1){
                            this.userManager.draw(this.effect[2])
                        }
                    break
                    case 115:
                    ...
                    break
                    case 3352:
                        this.userManager.drawSetCost(this.effect[1],9)
                    break
                    case 3363:
                        if(this.userManager.reserve.cards.length>0){
            ...
            case 1:
                switch(this.type){
                    case 13: case 235: case 968: case 2289: case 2778: case 3278:
                        this.userCombatant.addBlock(this.effect[0]*this.energy)
                    break
                    case 141:
                    ...
                    case 3022:
                        if(this.energy%2==1){
                            this.battle.combatantManager.damageAreaID(this.effect[1]*this.energy,this.user,this.userCombatant.id,this.userCombatant.tilePosition)
                        }else{
                    ...
                    break
                    case 3184:
                        this.userCombatant.addBlock(this.effect[0]+this.effect[1]*this.userManager.hand.numberAbstract(5,[0]))
                    break
                    case 3189:
                ...
                switch(this.type){
                    ...
                    break
                    case 3211:
                        this.battle.combatantManager.randomEffect(3,[999])
            ...
            case 3:
                switch(this.type){
                    ...
                    break
                    case 2312:
                        this.battle.addEnergy(this.effect[0],this.player)*this.userManager.hand.numberAbstract(4,[[4]])
                    break
                    case 2321:
                        this.battle.addEnergy(this.effect[0],this.player)
                        for(let a=0,la=this.effect[1];a<la;a++){
                    ...
                    case 3348:
                        ...
                        this.userManager.discard.sendNameShuffle(this.userManager.reserve.cards,'Fatigue')
                    break
                    case 3362:
            ...
            case 4:
                switch(this.type){
                    ...
                    break
                    case 3217:
                        this.userCombatant.statusEffect('Orb Overload Buffer',999)
                    break
                    case 3230:
                        for(let a=0;a<min(this.effect[0]*this.energy+this.effect[1],100);a++){
                    ...
                    case 3281:
                        ...
                        if(result3281.length>0){
                            this.userManager.drawClass(this.effect[1],result3281[0].class)
                        }
                    break
                    case 3307:
            ...
            case 7:
                switch(this.type){
                    ...
                    break
                    case 3183:
                        this.targetCombatant.takeDamage(this.effect[0]+this.effect[1]*this.userManager.hand.numberAbstract(5,[0]),this.user)
                    break
                    case 3187:
                        this.targetCombatant.takeDamage(this.effect[0],this.user)
                        if(this.targetCombatant.blocked<=1){
                    ...
                    case 3319:
                        this.targetCombatant.takeDamage(this.effect[0],this.user)
                        if(this.userManager.hand.lastTurnPlayed[1]>0){
                            this.userManager.draw(this.effect[1])
                        }
            ...
            case 10:
                switch(this.type){
                    ...
                    case 3174:
                        for(let a=0,la=this.effect[0];a<la;a++){
                            this.userManager.hand.addCost(findName('Strike',types.card),this.level,this.color,1,floor(random(1,7)))
                        }
                    break
                    case 3180:
                    ...
                    case 3273:
                        for(let a=0,la=this.effect[0];a<la;a++){
                            this.userManager.hand.addCost(findName('Defend',types.card),this.level,this.color,1,floor(random(1,7)))
                        }
                    break
                    case 3286:
                    ...
                    break
                    case 3287:
                        this.userManager.hand.addEffectUp(findName('Knife\nExpress',types.card),0,0,0,this.effect[0]*this.userManager.exhaust.numberAbstract(0,['Shiv','Broken\nShiv','Deluxe\nShiv']))
                    break
                    case 3288:
                ...
                switch(this.type){
                    ...
                    case 3382:
                        if(this.cost>=12){
                            ...
                            for(let a=0,la=this.effect[0];a<la;a++){
                                this.userManager.hand.addCostSpec(findName('Strike',types.card),0,this.color,1,0,[1])
                            }
                            for(let a=0,la=this.effect[1];a<la;a++){
            ...
            case 13:
                switch(this.type){
                    ...
                    break
                    case 2490:
                        this.battle.combatantManager.damageAreaID(this.effect[0]*this.userManager.hand.totalCost(),this.user,this.userCombatant.id,this.userCombatant.tilePosition)
                    break
                    case 2681:
                        this.battle.combatantManager.damageAreaID(this.effect[0]*(this.userCombatant.elemental?3:1),this.user,this.userCombatant.id,this.userCombatant.tilePosition)
                    break
                    case 2700:
                        this.battle.combatantManager.damageAreaID(this.effect[0]+this.effect[1]*this.userCombatant.getStatus('Knowledge'),this.user,this.userCombatant.id,this.userCombatant.tilePosition)
                    break
                    case 3130:
                ...
                switch(this.type){
                    ...
                    break
                    case 434:
                        this.battle.combatantManager.intentNerfArea(1,this.effect[1],this.userCombatant.team,this.userCombatant.tilePosition)
                    break
                    case 698:
                        for(let a=0,la=this.effect[1];a<la;a++){
                            this.userManager.randomEffect(2,0,[])
