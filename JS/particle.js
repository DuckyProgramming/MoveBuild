class particle{
    constructor(layer,x,y,type,args){
        ...
        switch(this.type){
            ...
            case 168: case 169: case 170: case 173:
                this.size=args[0]
                this.fade=1
                this.scale=0
            break
            ...
            break
            case 61: case 62: case 63: case 64: case 96: case 100: case 171: case 172:
                this.direction=args[0]
                this.speed=args[1]
            ...
            case 94: case 102: case 127:
                ...
                this.scale=1
            break
            case 108: case 140: case 142: case 157:
                this.direction=args[0]
                this.timer=args[1]
    ...
    update(parent){
        ...
        switch(this.type){
            ...
            break
            case 81: case 94: case 102: case 127:
                this.position.x+=lsin(this.direction)*this.speed
                this.position.y-=lcos(this.direction)*this.speed-10/this.timer
                        ...
                        case 142:
                            ...
                            for(let a=0,la=18;a<la;a++){
                                parent.particles.push(new particle(this.layer,this.position.x,this.position.y,
                                    146,[this.direction+(a+0.5)/la*360,120,7,8+a%2*4,2+a%2*0.5]))
                            }
                        break
                    }
                }
