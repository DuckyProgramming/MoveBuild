class card{
    constructor(layer,battle,player,x,y,type,level,color,id,cost,additionalSpec,name,list,effect,attack,target,spec,cardClass,limit,falsed,retain2=false,colorful=false,edition,baseCost,drawn,editedCost,editedCostComplete,nonCalc,costDownTrigger,costUpTrigger){
        this.layer=layer
        this.battle=battle
        this.player=player
    ...
    description(attack,effect,spec,target){
        ...
        switch(attack){
            ...
            case -20: string+=`When Drawn,\nAll Movement Cards\nCost ${effect[0]} More Temporarily`; break
            ...
            case -35: string+=`${variants.mtg?`Lose All Mana`:`Set Energy to 0`}`; break
            ...
            case -84: string+=`Must be Played\nWithin ${effect[0]} Seconds or\nTake ${effect[1]} Damage${stage.scene=='battle'&&this.player>=0&&this.player<this.battle.players&&!this.nonCalc?`\n(Currently ${floor(this.time/60)}s)`:``}`; break
            ...
            case -93: string+=`Lose ${effect[0]} Health\nWhen You Play a Skill`; break
            case -94: string+=`After a Boss Combat,\nBecomes Playable`; break
            ...
            case 219: string+=`Add ${effect[0]} Shiv${pl(effect[0])} to Hand\nEvery Turn`; break
            case 220: case 594:
                string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nDiscard When a\nCard is Played`; break
            ...
            case 243: string+=`Advance to Range 2\nPull Target 1 Tile\nTarget Will Face User`; break
            ...
            case 276: string+=`Next ${effect[0]!=1?`${effect[0]} `:``}Card${pl(effect[0])}\nPlayed ${effect[0]!=1?`are`:`is`} Duplicated\nDiscard ${effect[0]} Random Card${pl(effect[0])}`; break
            ...
            case 345: string+=`Deal Damage Equal to\nNumber of Cards in\nYour Deck${this.player>=0&&this.player<this.battle.players&&!this.nonCalc?` (${this.battle.cardManagers[this.player].deck.cards.length})`:``}`; break
            ...
            case 718: string+=`Deal ${this.calculateEffect(effect[0],2)} Damage\nWhere X = Number\nof Destroyed\nConstructs${effect[1]!=0?` +${effect[1]}`:``}${this.player>=0&&this.player<this.battle.players&&!this.nonCalc?` (${this.battle.combatantManager.numberAbstract(0,[])+this.effect[1]})`:``}`; break
            ...
            case 845: string+=`Add ${effect[0]} Black Matter${pl(effect[0])}\nto Draw Pile\nWhen Etherealed,\nAdd ${this.calculateEffect(effect[1],1)} Block`; break
            case 846: string+=`Exhaust the Top ${effect[0]}\nCard${pl(effect[0])} of Your Draw Pile\nDeal ${this.calculateEffect(effect[0],2)} Damage\nWhere X = Number\nof Attacks Exhausted`; break
            ...
            case 850: string+=`Deal ${this.calculateEffect(effect[0],0)}+${this.calculateEffect(effect[1],11)} Damage\nWhere X = Number of\nExhausted Cards${stage.scene=='battle'&&this.player>=0&&this.player<this.battle.players&&!this.nonCalc?` (${this.battle.cardManagers[this.player].exhaust.cards.length})`:``}`; break
            ...
            case 1103: string+=`Heafunl ${this.calculateEffect(effect[0],4)} Health\nto Everything`; break
            ...
            case 1175: case 4761:
                string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\n${variants.mtg?`Basic Attacks\n`:`Strikes`} Gain ${effect[1]} Effect`; break
            case 1176: case 4762:
                string+=`Add ${this.calculateEffect(effect[0],1)} Block\n${variants.mtg?`Basic Defenses\n`:`Defends`} Gain ${effect[1]} Effect`; break
            ...
            case 1227: string+=`Put ${effect[0]} Random Card${pl(effect[0])}\nFrom Draw Pile\nin Your Hand`; break
            ...
            case 1284: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nEvery 3 Lucky 7s\nPlayed${this.player>=0&&this.player<this.battle.players&&!this.nonCalc?` (${this.battle.cardManagers[this.player].hand.playedSpecific[0]%3})`:``},\nGain ${effect[1]} Currency`; break
            ...
            case 1333: string+=`Draw ${effect[0]} Card${pl(effect[0])}\nDiscards to Hand\nCosts 5 Taken Damage${this.player>=0&&this.player<this.battle.players&&stage.scene=='battle'&&!this.nonCalc?`\n(Currently ${this.battle.combatantManager.combatants[this.battle.combatantManager.getPlayerCombatantIndex(this.player)].compression})`:``}`; break
            ...
            case 1418: string+=`4 or More Energy:\nDeal ${this.calculateEffect(effect[0],0)} Damage\nDraw ${effect[1]} More\nCard${pl(effect[1])} Next Turn`; break
            ...
            case 1423: string+=`Exhaust a Card\nGain ${variants.mtg?`Mana`:`Energy`} Equal\nto its Cost`; break
            ...
            case 1491: string+=`Next ${effect[0]!=1?`${effect[0]} `:``}Card${pl(effect[0])}\nPlayed ${effect[0]!=1?`are`:`is`} Free\nNext ${effect[1]!=1?`${effect[1]} `:``}Card${pl(effect[1])}\nPlayed ${effect[1]!=1?`are`:`is`} Duplicated`; break
            ...
            case 1527: string+=`Next ${effect[0]!=1?`${effect[0]} `:``}Card${pl(effect[0])}\nPlayed ${effect[0]!=1?`are`:`is`} Duplicated\nLose ${effect[1]} Health`; break
            ...
            case 1690: string+=`Apply ${effect[0]!=1?`${effect[0]}`:``}X${effect[1]!=0?`+${effect[1]}`:``} Shock\nWhere X = Number\nof Cards in Hand\nDiscard Your Hand`; break
            ...
            case 1764: string+=`4 or More Energy:\n\nDeal ${this.calculateEffect(effect[0],0)} Damage\nApply ${effect[1]} Fade`; break
            ...
            case 2015: string+=`Double ${variants.mtg?`Existing Mana`:`Your Energy`}\nOverdrive ${effect[0]}:\nTriple It`; break
            ...
            case 2052: case 4764:
                string+=`Add ${this.calculateEffect(effect[0],1)} Block\n${variants.mtg?`Basic Defenses`:`Defends`} Lose ${effect[1]} Effect`; break
            ...
            case 2106: string+=`Deal ${this.calculateEffect(max(0,effect[0]+(stage.scene=='battle'&&this.player>=0&&this.player<this.battle.players&&!this.nonCalc?this.battle.cardManagers[this.player].greenDiff:0)),0)} Damage\nIncreases by 1\nWhen You Play a Card\nDecreases by 1\nWhen Card Discarded\nThis Combat`; break
            ...
            case 2232: string+=`Add Any Random\n${effect[0]} 2 ${variants.mtg?`Total `:``}Cost Card${effect[0]!=1?`s`:``}\nof Equivalent Level\nto Hand\n${effect[0]!=1?`They Cost`:`It Costs`} 0 Temporarily`; break
            ...
            case 2260: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nReturn ${effect[1]} 0 ${variants.mtg?`Total `:``}Cost\nCard${pl(effect[1])} From Discard Pile`; break
            ...
            case 2265: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nIf You Have At Least\n5 Exhausted Cards${stage.scene=='battle'&&this.player>=0&&this.player<this.battle.players&&!this.nonCalc?` (${this.battle.cardManagers[this.player].exhaust.cards.length})`:``}`; break
            ...
            case 2328: string+=`Turn 6 or Earlier:\nDeal ${this.calculateEffect(effect[0],0)} Damage`; break
            case 2329: string+=`Turn 6 Or Earlier:\nAdd ${this.calculateEffect(effect[0],1)} Block`; break
            case 2330: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nTurn 0:\nTake Another Turn`; break
            case 2331: string+=`Turn Divisible by 4:\nDeal ${this.calculateEffect(effect[0],0)} Damage`; break
            case 2332: string+=`Turn Divisible by 4:\nMove ${effect[0]} Tile${pl(effect[0])}\nGain ${effect[1]} Energy\nand Draw ${effect[2]} Card${pl(effect[2])}`; break
            ...
            case 2434: string+=`Target Takes ${effect[0]} Damage\nWhen You Play a Power`; break
            ...
            case 2550: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nIf Your Deck Has\n50+${this.player>=0&&this.player<this.battle.players&&!this.nonCalc?` (${this.battle.cardManagers[this.player].deck.cards.length})`:``} Cards`; break
            ...
            case 2566: string+=`Choose a Card of\nEquivalent Level That\nCosts Your Energy\nto Add to Hand`; break
            ...
            case 2573: string+=`Add Block Equal to\nNumber of Unique Cards\nin Your Deck${this.player>=0&&this.player<this.battle.players&&!this.nonCalc?` (${this.battle.cardManagers[this.player].deck.uniqueNumber()})`:``}`; break
            ...
            case 2583: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nEvery 3 Edicts\nPlayed${this.player>=0&&this.player<this.battle.players&&!this.nonCalc?` (${this.battle.cardManagers[this.player].hand.playedSpecific[1]%3})`:``},\nDeals Double Damage`; break
            ...
            case 2768: string+=`Double ${variants.mtg?`Existing Mana`:`Your Energy`}\nLose ${effect[0]} ${variants.mtg?`Random Mana`:`Energy`}\nNext Turn`; break
            ...
            case 2874: string+=`Shuffle ${effect[0]} Prismatic\nBomb${pl(effect[0])} Into Draw Pile`; break
            ...
            case 2879: string+=`Shuffle ${effect[0]} Prismatic\nBomb${pl(effect[0])} Into Draw Pile\nAdd a Void\nto Discard Pile`; break
            ...
            case 2915: string+=`Draw ${effect[0]} Card${pl(effect[0])}\nDeal ${this.calculateEffect(effect[1],0)} Damage\nFor Each One\nThat is An Attack`; break
            case 2916: string+=`Draw ${effect[0]} Card${pl(effect[0])}\nAdd ${this.calculateEffect(effect[1],1)} Block\nFor Each One\nThat is A Defense`; break
            ...
            case 3151: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nEvery 2 Graphites\nPlayed${this.player>=0&&this.player<this.battle.players&&!this.nonCalc?` (${this.battle.cardManagers[this.player].hand.playedSpecific[2]%2})`:``},\nAdd a Graphene to Hand`; break
            case 3152: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nEvery 2 Graphenes\nPlayed${this.player>=0&&this.player<this.battle.players&&!this.nonCalc?` (${this.battle.cardManagers[this.player].hand.playedSpecific[3]%2})`:``},\nAdd a Diamond to Hand`; break
            ...
            case 3230: string+=`Add ${effect[0]!=1?`${effect[0]}`:``}X${effect[1]>0?`+${effect[1]}`:``} Random\nCommon Colorless\nCards to Hand\nThey Cost 0 Temporarily`; break
            ...
            case 3319: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nPlayed Last Turn:\nAttack${this.player>=0&&this.player<this.battle.players&&!this.nonCalc?` (${this.battle.cardManagers[this.player].hand.lastTurnPlayed[1]})`:``}:\nDraw ${effect[1]} Card${pl(effect[1])}\nDefense${this.player>=0&&this.player<this.battle.players&&!this.nonCalc?` (${this.battle.cardManagers[this.player].hand.lastTurnPlayed[2]})`:``}:\nGain ${effect[2]} Energy`; break
            ...
            case 3402: string+=`Shuffle ${effect[0]} Prismatic\nBomb${pl(effect[0])} Into Draw Pile\nAdd ${effect[1]} Void${pl(effect[1])}\nto Discard Pile`; break
            ...
            case 3570: string+=`Leftmost Card in Hand:\nPut a Card in Discard\nPile in Your Hand\nRightmost Card in Hand:\nPut a Card in Draw\nPile in Your Hand`; break
            ...
            case 3710: string+=`Gain ${effect[0]!=1?`${effect[0]}`:``}X${effect[1]!=0?`+${effect[1]}`:``} Temporary\nStrength Where\nX = Number of Cards\nPlayed Last Turn${stage.scene=='battle'&&this.player>=0&&this.player<this.battle.players&&!this.nonCalc?` (${this.battle.cardManagers[this.player].hand.lastTurnPlayed[0]*effect[0]+effect[1]})`:``}`; break
            ...
            case 4099: string+=`Next ${effect[0]!=1?`${effect[0]} `:``}Attack${pl(effect[0])}\nPlayed ${effect[0]!=1?`are`:`is`} Duplicated`; break
            ...
            case 4321: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nRemove All Mana\nGain (K) (N)`; break
            case 4322: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nRemove All Mana\nGain (K) (K)`; break
            case 4323: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nRemove All Mana\nGain (E) (E)`; break
            ...
            case 4337: string+=`Move ${effect[0]} Tile${pl(effect[0])}\n10%: Gain (E) (E) (E)`; break
            case 4338: string+=`Move ${effect[0]} Tile${pl(effect[0])}\n10%: Gain (E) (E) (E) (E) (E) (E)`; break
            case 4339: string+=`Move ${effect[0]} Tile${pl(effect[0])}\n10%: Gain (E) (E) (E) (E) (E) (E) (E) (E)`; break
            case 4340: string+=`Deal ${this.diceEffect(1,6,2,effect[0])} Damage\nAdd ${this.diceEffect(1,6,3,effect[1])} Block\n(Uses Same Roll)\nDraw ${effect[2]} Card${pl(effect[2])}`; break
            case 4341: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\n50%: Draw ${effect[1]} Card${pl(effect[1])}\nNext Luck-Based\nCard is Guaranteed`; break
            case 4342: string+=`Gain (W) (G)\nNext Luck-Based Card\nis Guaranteed to Fail`; break
            case 4343: string+=`Gain (E) (W) (G)\nNext Luck-Based Card\nis Guaranteed to Fail`; break
            case 4344: string+=`Gain (E) (E) (E)\nNext Luck-Based Card\nis Guaranteed to Fail`; break
            case 4345: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\n50%: Lose ${effect[1]} Random\nMana Next Turn`; break
            case 4346: string+=`Move ${effect[0]} Tile${pl(effect[0])}\n50%: Lose ${effect[1]} Random\nMana Next Turn`; break
            case 4347: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nRemove All Mana\nGain (K) (N)`; break
            case 4348: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nRemove All Mana\nGain (K) (K)`; break
            case 4349: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nRemove All Mana\nGain (E) (E)`; break
            case 4350: string+=`Even Mana Total:\nDeal ${this.calculateEffect(effect[0],0)} Damage\nAdd ${this.calculateEffect(effect[1],1)} Block`; break
            case 4351: string+=`If You Have Block,\nGain (N) (N) (N)\nDraw ${effect[0]} Card${pl(effect[0])}`; break
            case 4352: string+=`If You Have Block,\nGain (W) (W) (W)\nDraw ${effect[0]} Card${pl(effect[0])}`; break
            case 4353: string+=`If You Have Block,\nGain (E) (E) (E)\nDraw ${effect[0]} Card${pl(effect[0])}`; break
            case 4354: string+=`Gain ${effect[0]} Currency\nGain (N) Next Turn`; break
            ...
            case 4362: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nDownward:\nGain (B)`; break
            case 4363: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nDownward:\nGain (B) (B)`; break
            case 4364: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nDownward:\nGain (E) (E)`; break
            case 4365: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nUpward:\nGain (B)`; break
            case 4366: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nUpward:\nGain (B) (B)`; break
            case 4367: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nUpward:\nGain (E) (E)`; break
            case 4368: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nDiscard ${effect[1]} Card${pl(effect[1])}\n12 or More Cards\nin Discard Pile:\nGain (E)`; break
            case 4369: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nIf Something is Ahead,\nGain (B) (R)`; break
            case 4370: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nIf Something is Ahead,\nGain (E) (B) (R)`; break
            case 4371: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nIf Something is Ahead,\nGain (E) (E) (E)`; break
            case 4372: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nDraw ${effect[1]} Card${pl(effect[1])}\nDiscard ${effect[2]} Random Card${pl(effect[2])}\nFor Each (K) Spent:\nGain (N)`; break
            case 4373: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nto Any Enemy\nFor Each (K) Spent:\nGain (N)`; break
            case 4374: case 4426:
                string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nFor Each (K) Spent:\nDraw ${effect[1]} Card${pl(effect[1])}`; break
            case 4375: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nto Any Enemy\nIf Fatal,\nGain (W) (B)`; break
            case 4376: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nto Any Enemy\nIf Fatal,\nGain (E) (W) (B)`; break
            case 4377: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nto Any Enemy\nIf Fatal,\nGain (E) (E) (E)`; break
            case 4378: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nFor Each (K) Spent:\nDraw ${effect[1]} Card${pl(effect[1])}`; break
            case 4379: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nFor Each (R) Spent:\nDeals ${this.calculateEffect(effect[1],10)} More`; break
            case 4380: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nFor Each (G) Spent:\nApply ${effect[1]} Weak`; break
            case 4381: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nFor Each (W) Spent:\nAdd ${this.calculateEffect(effect[1],1)} Block`; break
            case 4382: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nFor Each (W) Spent:\nGain ${effect[1]} Armor`; break
            case 4383: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nFor Each (W) Spent:\nRemove ${effect[1]} Fatigue${pl(effect[1])}`; break
            case 4384: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nFor Each (K) Spent:\nApply ${effect[1]} Bleed`; break
            case 4385: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nFor Each (K) Spent:\nApply ${effect[1]} Poison`; break
            case 4386: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nFor Each (G) Spent: 10%:\nMake a Card Polychrome\nPermanently`; break
            case 4387: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nFor Each (G) Spent:\nAdd Any ${effect[1]} Random\n4 Total Cost Card${pl(effect[1])} to Hand\n${effect[1]!=1?`They Cost`:`It Costs`} 2 Less`; break
            case 4388: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nFor Each (B) Spent:\nDraw ${effect[1]} Card${pl(effect[1])}\nDiscard ${effect[2]} Card${pl(effect[2])}`; break
            case 4389: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nFor Each (K) Spent:\nApply ${effect[1]} Jinx`; break
            case 4390: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nOdd Energy:\nApply ${effect[1]} Weak`; break
            case 4391: string+=`Draw ${effect[0]} Card${pl(effect[0])}\n${effect[0]!=1?`They Cost`:`It Costs`} 0 Temporarily\nDiscard ${effect[1]} Card${pl(effect[1])}`; break
            case 4392: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nFor Each (K) Spent:\nCounter ${effect[1]}`; break
            case 4393: string+=`When Drawn,\nAdd ${this.calculateEffect(effect[0],1)} Block\nWhen Discarded\nFrom Your Hand,\nGain ${effect[1]} Armor`; break
            case 4394: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nFor Each (K) Spent:\nDraw ${effect[1]} Card${pl(effect[1])}`; break
            case 4395: string+=`Heal ${this.calculateEffect(effect[0],4)} Health\nFor Each (K) Spent:\nDraw ${effect[1]} Card${pl(effect[1])}`; break
            case 4396: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nGain (W)\nNext 2 Turns`; break
            case 4397: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nGain (W)\nNext 2 Turns`; break
            case 4398: string+=`Wrath:\nGain (E) (W)`; break
            case 4399: string+=`Wrath:\nGain (E) (E) (W)`; break
            case 4400: string+=`Wrath:\nGain (E) (E) (W) (W)`; break
            case 4401: string+=`Haste:\nGain (E) (K)`; break
            case 4402: string+=`Haste:\nGain (E) (E) (K)`; break
            case 4403: string+=`Haste:\nGain (E) (E) (K) (K)`; break
            case 4404: string+=`Sturdy: Gain (E) (B)`; break
            case 4405: string+=`Sturdy: Gain (E) (E) (B)`; break
            case 4406: string+=`Sturdy: Gain (E) (E) (B) (B)`; break
            case 4407: string+=`5 or More Mana:\nDeal ${this.calculateEffect(effect[0],0)} Damage\nDraw ${effect[1]} Card${pl(effect[1])}`; break
            case 4408: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nIf Fatal, Purify ${effect[1]}`; break
            case 4409: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nGain (K) Per Dark Orb`; break
            case 4410: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nGain (K) (K) Per Dark Orb`; break
            case 4411: string+=`Gain (E)\nWhen You Lowroll`; break
            case 4412: string+=`Gain (E)\nWhen You Highroll`; break
            case 4413: string+=`No Mana Left:\nDeal ${this.calculateEffect(effect[0],0)} Damage`; break
            case 4414: string+=`50%: Deal ${this.calculateEffect(effect[0],0)} Damage\n50%: Refund Spent Mana`; break
            case 4415: string+=`Gain ${effect[0]} Strength\nGain ${effect[1]} Dexterity\nRemove ${effect[2]} Random Base\nMana This Cmobat`; break
            case 4416: string+=`Gain ${effect[0]} Vulnerable\nGain (E) (E) (E)\nFor Each (K) Spent,\nGain (N)`; break
            case 4417: string+=`Gain ${effect[0]} Vulnerable\nGain (E) (E) (E) (E)\nFor Each (K) Spent,\nGain (N)`; break
            case 4418: string+=`Gain ${effect[0]} Vulnerable\nGain (E) (E) (E) (E)\nFor Each (K) Spent,\nGain (N) (N)`; break
            case 4419: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nIf Target Has\n20 or More Jinx,\nGain (K) (R)`; break
            case 4420: string+=`For Each (K) Spent:\nGain (E)\nDraw ${this.effect[0]} Card${pl(effect[0])}\nFor Each (W) Spent:\nGain (K)\nDraw ${effect[1]} Card${pl(effect[1])}`; break
            case 4421: string+=`Gain ${effect[0]} Dexterity\nWhen Discarded\nFrom Your Hand,\nGain (W) (G) Next Turn`; break
            case 4422: string+=`Gain ${effect[0]} Dexterity\nWhen Discarded\nFrom Your Hand,\nGain (E) (W) (G) Next Turn`; break
            case 4423: string+=`Gain ${effect[0]} Dexterity\nWhen Discarded\nFrom Your Hand,\nGain (E) (E) (E) Next Turn`; break
            case 4424: string+=`All Mana Counts as\n(K) When Activating\nSynergy Effects`; break
            case 4425: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nFor Each (K) Spent:\nNext Attack Deals\n${effect[1]} More Damage`; break
            case 4427: string+=`Deal ${this.calculateEffect(effect[0],0)} Splash Damage\nMay Target Any Tile\nWithin Range ${target[1]}-${target[2]}\nFor Each (K) Spent:\nGain (N)`; break
            case 4428: string+=`Deal ${this.calculateEffect(effect[0],0)}-${this.calculateEffect(effect[1],11)} Damage\nWhere X = (Range-1)\nIf Fatal,\nGain (R) (R) (R)`; break
            case 4429: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nStraight Left:\nGain (E) (N) (N)`; break
            case 4430: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nStraight Left:\nGain (E) (E) (E)`; break
            case 4431: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nStraight Left:\nGain (E) (E) (E) (E)`; break
            case 4432: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nStraight Right:\nGain (E) (N) (N)`; break
            case 4433: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nStraight Right:\nGain (E) (E) (E)`; break
            case 4434: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nStraight Right:\nGain (E) (E) (E) (E)`; break
            case 4435: string+=`Gain (W) (W) (R) (R)\nDraw ${effect[0]} Attack${pl(effect[0])}`; break
            case 4436: string+=`Gain (W) (W) (W) (R) (R) (R)\nDraw ${effect[0]} Attack${pl(effect[0])}`; break
            case 4437: string+=`Gain (E) (E) (E) (E) (W) (R)\nDraw ${effect[0]} Attack${pl(effect[0])}`; break
            case 4438: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nIf Last Card\nPlayed Was a Gun,\nGain (G) (G) and\nDraw ${effect[1]} Card${pl(effect[1])}`; break
            case 4439: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nClaw Up ${effect[1]}\nIf Fatal,\nGain ${effect[2]} Energy`; break
            case 4440: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nClaw Up ${effect[1]}\nIf Fatal,\nGain (W) (B)`; break
            case 4441: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nClaw Up ${effect[1]}\nIf Fatal,\nGain (W) (B) (N)`; break
            case 4442: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nClaw Up ${effect[1]}\nIf Fatal,\nGain (E) (E) (E)`; break
            case 4443: string+=`Apply ${effect[0]} Shock`; break
            case 4444: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nIf Target Has Shock,\nGain (B) (N)\nDraw ${effect[1]} Card${pl(effect[1])}`; break
            case 4445: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nIf Target Has Shock,\nGain (B) (B)\nDraw ${effect[1]} Card${pl(effect[1])}`; break
            case 4446: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nIf Target Has Shock,\nGain (E) (B)\nDraw ${effect[1]} Card${pl(effect[1])}`; break
            case 4447: string+=`Move in a L Shape\nor Move ${effect[0]} Tile${pl(effect[0])}`; break
            case 4448: string+=`Move in a L Shape\nor Move ${effect[0]} Tile${pl(effect[0])}\nWhen Etherealed, Add\nan Operational Star\nof Equivalent Level`; break
            case 4449: string+=`For Each (W) Spent:\nApply ${effect[0]} Weak\nFor Each (K) Spent:\nApply ${effect[1]} Shock`; break
            case 4450: string+=`When Drawn,\nDeal ${this.calculateEffect(effect[0],0)} Damage\nto a Random Enemy\nand Gain ${effect[1]} Energy`; break
            case 4451: string+=`When Drawn,\nDeal ${this.calculateEffect(effect[0],0)} Damage\nto a Random Enemy\nand Gain (E)`; break
            case 4452: string+=`Shuffle ${effect[0]} Prismatic\nBomb${pl(effect[0])} Into Draw Pile\nDraw ${effect[1]} Card${pl(effect[1])}`; break
            case 4453: string+=`Next ${effect[0]!=1?`${effect[0]} `:``}Attack${pl(effect[0])}\nDeal${effect[0]==1?`s`:``} Double Damage\nGain (W) (W) (K) (K)\nIf You Have Shock`; break
            case 4454: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\n${effect[1]} or More\nCards in Hand:\nDeals Triple Damage`; break
            case 4455: string+=`Gain (N) (N) Next Turn\nDraw ${effect[0]} Card${pl(effect[0])}\nCosts 1 Less`; break
            case 4456: string+=`Deal ${this.calculateEffect(effect[0],2)} Damage\nWhere X = Missing Mana`; break
            case 4457: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nIncreases by ${effect[1]}\nGain (N) Next Turn`; break
            case 4458: string+=`Gain (N) For Each\nSkill in Hand\nDraw ${effect[0]} Card${pl(effect[0])}`; break
            case 4459: string+=`Gain (R) For Each\nSkill in Hand\nDraw ${effect[0]} Card${pl(effect[0])}`; break
            case 4460: string+=`Gain (E) For Each\nSkill in Hand\nDraw ${effect[0]} Card${pl(effect[0])}`; break
            case 4461: string+=`Discard Your Hand\nDraw That Many More\nCards Next Turn`; break
            case 4462: string+=`Add ${effect[0]} Random\nPower${pl(effect[0])} to Hand\n${effect[0]!=1?`They Cost`:`It Costs`} 0`; break
            case 4463: string+=`Move ${effect[0]} Tile${pl(effect[0])}\n7 Total Mana:\nGain (E) (N)`; break
            case 4464: string+=`Move ${effect[0]} Tile${pl(effect[0])}\n7 Total Mana:\nGain (E) (E) (N)`; break
            case 4465: string+=`Move ${effect[0]} Tile${pl(effect[0])}\n7 Total Mana:\nGain (E) (E) (E)`; break
            case 4466: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\n7 Total Mana:\nDeals Triple Damage`; break
            case 4467: string+=`Add ${this.calculateEffect(effect[0],1)} Block\n7 Total Mana:\nAdds Triple Block`; break
            case 4468: string+=`Turn 4 Or Later:\nGain (E)\nDraw ${effect[0]} Card${pl(effect[0])}`; break
            case 4469: string+=`Turn 4 Or Later:\nGain (E) (N)\nDraw ${effect[0]} Card${pl(effect[0])}`; break
            case 4470: string+=`Turn 4 Or Later:\nGain (E) (E)\nDraw ${effect[0]} Card${pl(effect[0])}`; break
            case 4471: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nCosts 1 Less Temporarily\nWhen Turn Changes`; break
            case 4473: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nEven Turn:\nGain (B) (N)`; break
            case 4474: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nEven Turn:\nGain (E) (B) (N)`; break
            case 4475: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nEven Turn:\nGain (E) (E) (B)`; break
            case 4476: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nTurn 4 Or Later:\nDraw ${effect[1]} Card${pl(effect[1])}`; break
            case 4477: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nTurn 1: Gain (B) (N)`; break
            case 4478: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nTurn 1: Gain (B) (B) (N)`; break
            case 4479: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nTurn 1: Gain (E) (E) (B)`; break
            case 4480: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nTurn 1: Gain (B) (N)`; break
            case 4481: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nTurn 1: Gain (B) (B) (N)`; break
            case 4482: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nTurn 1: Gain (E) (E) (B)`; break
            case 4483: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nTurn 1:\nGain (B) (N)`; break
            ...
            case 4489: string+=`If You Have a 3+\nTotal Cost Card in Hand,\nGain (K) (K) (K)\nDraw ${effect[0]} Card${pl(effect[0])}`; break
            case 4490: string+=`If You Have a 3+\nTotal Cost Card in Hand,\nGain (E) (K) (K)\nDraw ${effect[0]} Card${pl(effect[0])}`; break
            case 4491: string+=`If You Have a 3+\nTotal Cost Card in Hand,\nGain (E) (E) (K)\nDraw ${effect[0]} Card${pl(effect[0])}`; break
            case 4492: string+=`Gain (G) (N)\nDraw ${effect[0]} Card${pl(effect[0])}\nSlime ${effect[1]} Random Card${pl(effect[1])}`; break
            case 4493: string+=`Gain (G) (G)\nDraw ${effect[0]} Card${pl(effect[0])}\nSlime ${effect[1]} Random Card${pl(effect[1])}`; break
            case 4494: string+=`Gain (E) (G)\nDraw ${effect[0]} Card${pl(effect[0])}\nSlime ${effect[1]} Random Card${pl(effect[1])}`; break
            case 4495: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nTurn Divisible by 4:\nGain (B) (B) (N) (N)\nand Draw ${effect[1]} Card${pl(effect[1])}\n`; break
            case 4496: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nTurn Divisible by 4:\nGain (E) (E) (B) (B) (N) (N)\nand Draw ${effect[1]} Card${pl(effect[1])}\n`; break
            case 4497: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nTurn Divisible by 4:\nGain (E) (E) (E) (E) (B) (B)\nand Draw ${effect[1]} Card${pl(effect[1])}\n`; break
            case 4498: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nGain (N) in 2 Turns`; break
            case 4499: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nGain (N) in 2 Turns`; break
            case 4500: string+=`Apply ${effect[0]} Weak\nGain (N)`; break
            case 4501: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nAdvance\nGain (W)`; break
            case 4502: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nAdvance\nGain (E)`; break
            case 4503: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nChoose a 3 ${variants.mtg?`Total\nCost Card to\n`:`Cost Card\nto `}Add to Hand`; break
            case 4504: string+=`Gain (E) (W) (B)\n(K) (G) (R) (N)\nDraw ${effect[0]} Card${pl(effect[0])}\nAdd an Out of Time\nto Discard Pile`; break
            case 4505: string+=`Gain (E) (E) (E) (E)\n(W) (B) (K) (G) (R)\nDraw ${effect[0]} Card${pl(effect[0])}\nAdd an Out of Time\nto Discard Pile`; break
            case 4506: string+=`Gain (E) (E) (E) (E) (E)\n(E) (E) (E) (E) (E)\nDraw ${effect[0]} Card${pl(effect[0])}\nAdd an Out of Time\nto Discard Pile`; break
            case 4507: string+=`Add ${this.calculateEffect(effect[0],3)} Block\nGain (N)`; break
            case 4508: string+=`When You Play\na 3+ ${variants.mtg?`Total `:``}Cost Card,\nNext Attack Deals\n${effect[0]} More Damage`; break
            case 4509: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nWhen You Play a\n3+ ${variants.mtg?`Total `:``}Cost Card`; break
            case 4510: string+=`Deal ${this.calculateEffect(effect[0],0)} Splash Damage\nLeft of Hand:\nGain (N) (N)`; break
            case 4511: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nOdd Mana Total:\nApply ${effect[1]} Freeze`; break
            case 4512: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nEven Mana Total:\nApply ${effect[1]} Burn`; break
            case 4513: string+=`Add ${this.calculateEffect(effect[0],17)} Barrier\nAdd ${effect[1]} Radiance${pl(effect[1])} to Hand`; break
            ...
            case 4534: string+=`Gain (B) (N) (N)\nDraw ${effect[0]} Card${pl(effect[0])}\nAdd a Defocus\nto Discard Pile`; break
            case 4535: string+=`Gain (B) (N) (N) (N)\nDraw ${effect[0]} Card${pl(effect[0])}\nAdd a Defocus\nto Discard Pile`; break
            case 4536: string+=`Gain (B) (N) (N) (N) (N)\nDraw ${effect[0]} Card${pl(effect[0])}\nAdd a Defocus\nto Discard Pile`; break
            case 4537: string+=`Gain ${effect[0]} Random Mana\nDraw ${effect[1]} Card${pl(effect[1])}`; break
            case 4538: string+=`Gain (K)\nEvery 2 Turns`; break
            case 4539: string+=`Gain (K) at the\nStart of Your Turn\nAll Enemies Gain\n${effect[0]} Strength And\n${effect[1]} Dexterity`; break
            case 4540: string+=`Gain (B) (B)\nLose a Random Item\nIf You Have One`; break
            case 4541: string+=`Gain (B) (B) (B)\nLose a Random Item\nIf You Have One`; break
            case 4542: string+=`Gain (E) (E) (E)\nLose a Random Item\nIf You Have One`; break
            case 4543: string+=`Draw ${effect[0]} Card${pl(effect[0])}\nAll Cards in Hand\nCost ${effect[1]} Less Temporarily\nLose ${effect[2]} Random\nMana Next Turn`; break
            case 4544: string+=`Gain (E) (W) (W)\nIf You Have Less\nTotal Mana Than Base`; break
            case 4545: string+=`Gain (E) (E) (W) (W)\nIf You Have Less\nTotal Mana Than Base`; break
            case 4546: string+=`Gain (E) (E) (E) (E)\nIf You Have Less\nTotal Mana Than Base`; break
            case 4547: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nGain ${effect[1]} Armor\n3 ${variants.mtg?`Total Cost\n`:`Cost `}Attacks in Hand\nCost 0 Temporarily`; break
            case 4548: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nto Any Enemy\nExhaust ${effect[1]} Card${pl(effect[1])}\n3 ${variants.mtg?`Total Cost\n`:`Cost `}Defenses in Hand\nCost 0 Temporarily`; break
            case 4549: string+=`Choose a Card of\nEquivalent Level With\na Total Cost Equal\nto Your Total Mana`; break
            case 4550: string+=`${effect[0]>0?`Deal ${this.calculateEffect(effect[0],0)} Damage\n`:`\n`}Push 1 Tile\nAdd a Pristine to Hand`; break
            case 4551: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nto Any Enemy\nAdd a Pristine or\na Torch to Hand`; break
            ...
            case 4559: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nAdd a 1-Shooter\nto Draw`; break
            case 4560: string+=`Gain${multiplyString(' (E)',this.effect[0])}`; break
            case 4561: string+=`Gain${multiplyString(' (E)',this.effect[0])}\nDraw ${effect[1]} Card${pl(effect[1])}`; break
            case 4562: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\n1 Total Mana:\nDraw ${effect[1]} Card${pl(effect[1])}`; break
            case 4563: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\n50%: Apply ${effect[1]} Shock`; break
            case 4564: string+=`Gain (E)\nA Random Card\nCosts ${effect[0]} Less`; break
            case 4565: string+=`Gain (E) (E)\nA Random Card\nCosts ${effect[0]} Less`; break
            case 4566: string+=`When Drawn,\nGain (G) (G)`; break
            case 4567: string+=`When Drawn,\nGain (G) (G) (G)`; break
            case 4568: string+=`When Drawn,\nGain (G) (G) (G) (G)`; break
            case 4569: string+=`Gain (E) (E) (E)\n(E) (E) (E)`; break
            case 4570: string+=`Gain (E) (E) (E) (E)\n(E) (E) (E) (E)`; break
            case 4571: string+=`Gain (E) (E) (E) (E) (E)\n(E) (E) (E) (E) (E)`; break
            case 4572: string+=`Gain (E) (E) (E) (E)\n(E) (E) (E) (E)\n(E) (E) (E) (E)`; break
            case 4573: string+=`Gain (E) (E) (E) (E)\n(E) (E) (E) (E) (E)\n(E) (E) (E) (E) (E)`; break
            case 4574: string+=`Gain (E) (E) (E) (E) (E)\n(E) (E) (E) (E) (E) (E)\n(E) (E) (E) (E) (E)`; break
            ...
            case 4600: string+=`Draw ${effect[0]!=1?`${effect[0]}`:``}X${effect[1]!=0?`+${effect[1]}`:``} Cards\nExhaust ${effect[2]!=1?`${effect[2]}`:``}X${effect[3]!=0?`+${effect[3]}`:``} Cards\nHeal ${this.calculateEffect(effect[2],9)} Health`; break
            case 4601: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nIf Fatal, Gain (E) (W)\nand Add a Copy of This\nCard to Your Hand`; break
            case 4602: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nStatus in Hand:\nExhaust It\nGain (E) (E)`; break
            case 4603: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nGain (W) (N)\nIf You Have Block`; break
            case 4604: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nGain (E) (W)\nIf You Have Block`; break
            case 4605: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nGain (E) (E)\nIf You Have Block`; break
            case 4606: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nElemental Form:\nGain (G) (N)`; break
            case 4607: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nElemental Form:\nGain (E) (G)`; break
            case 4608: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nElemental Form:\nGain (E) (E)`; break
            case 4609: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nto Any Enemy\nIf Fatal,\nGain (W) (W) (B) (B)`; break
            case 4610: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nto Any Enemy\nIf Fatal,\nGain (E) (E) (W) (W) (B) (B)`; break
            case 4611: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nto Any Enemy\nIf Fatal,\nGain (E) (E) (E) (E) (E) (E)`; break
            case 4612: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\n2 Times\nDeals ${this.calculateEffect(effect[1],10)} More\nFor Each Power\nPlayed This Combat`; break
            case 4613: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nDrawn 2+ Times: (${this.drawn})\nGain (B)`; break
            case 4614: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nGain ${effect[1]} (E)\nMana Gain Increases by\n${effect[2]} Permanently`; break
            case 4615: string+=`Gain ${effect[0]} Vision\nElemental Form:\nGain (E) (E) (E)\nDraw ${effect[1]} Card${pl(effect[1])}`; break
            case 4616: string+=`Gain ${effect[0]} Vision\nElemental Form:\nGain (E) (E) (E) (E)\nDraw ${effect[1]} Card${pl(effect[1])}`; break
            case 4617: string+=`Gain ${effect[0]} Vision\nElemental Form:\nGain (E) (E) (E) (E) (E)\nDraw ${effect[1]} Card${pl(effect[1])}`; break
            case 4618: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nMana Total Divisible by 3:\nGain ${effect[1]} Knowledge\nGain ${effect[2]} History`; break
            case 4619: string+=`Gain (G) at the\nStart of Your Turn\nElemental Form:\nShuffle a Vitality\ninto Draw Pile\nDraw ${effect[0]} Card${pl(effect[0])}`; break
            case 4620: string+=`Choose a Common\nCard to Add to Hand\nIt Costs 0\nDrawn 1 Time: (${this.drawn})\nGain (W)`; break
            case 4621: string+=`Choose a Common\nCard to Add to Hand\nIt Costs 0\nDrawn 1 Time: (${this.drawn})\nGain (W) (W)`; break
            case 4622: string+=`Gain ${effect[0]} Knowledge\nNext 3 Turns\nGain ${effect[1]} Wisdom\nDraw ${effect[2]} Card${pl(effect[2])}`; break
            case 4623: string+=`When You Start Your\nTurn in Elemental Form,\nGain (E) and\nDraw ${effect[0]} Card${pl(effect[0])}`; break
            case 4624: string+=`Add ${this.calculateEffect(effect[0],3)} Block\nGain (E) Next Turn`; break
            case 4625: string+=`Choose an Ally Card\nof Equivalent Level\nto Add to Deck`; break
            case 4626: string+=`+1: Gain (G)\n-3: All Cards in Hand\nCost ${effect[0]} Less\n-6: Heal ${this.calculateEffect(effect[1],4)} Health`; break
                case -1054: string+=`-3: All Cards in Hand\nCost ${effect[0]} Less`; break
                case -1055: string+=`-6: Heal ${this.calculateEffect(effect[1],4)} Health`; break
            case 4627: string+=`+1: Gain ${effect[0]} Temporary Strength\nGain ${effect[1]} Temporary Dexterity\n-2: Gain ${effect[2]} Dodge\nGain ${effect[3]} Temporary Strength\nFor Each Dodge You Have\n-5: Draw to ${effect[4]} Card${pl(effect[4])}\nGain (G) (G) (R) (R)`; break
            case 4628: string+=`+1: Gain ${effect[0]} Temporary Strength\nGain ${effect[1]} Temporary Dexterity\n-2: Gain ${effect[2]} Dodge\nGain ${effect[3]} Temporary Strength\nFor Each Dodge You Have\n-5: Draw to ${effect[4]} Card${pl(effect[4])}\nGain (G) (G) (G) (R) (R) (R)`; break
            case 4629: string+=`+1: Gain ${effect[0]} Temporary Strength\nGain ${effect[1]} Temporary Dexterity\n-2: Gain ${effect[2]} Dodge\nGain ${effect[3]} Temporary Strength\nFor Each Dodge You Have\n-5: Draw to ${effect[4]} Card${pl(effect[4])}\nGain (E) (E) (E) (E) (E) (E)`; break
                case -1056: string+=`-5: Draw to ${effect[4]} Card${pl(effect[4])}\nGain (G) (G) (R) (R)`; break
                case -1057: string+=`-5: Draw to ${effect[4]} Card${pl(effect[4])}\nGain (G) (G) (G) (R) (R) (R)`; break
                case -1058: string+=`-5: Draw to ${effect[4]} Card${pl(effect[4])}\nGain (E) (E) (E) (E) (E) (E)`; break
            case 4630: string+=`+1: Draw ${effect[0]} Card${pl(effect[0])}\nRewind ${effect[1]} Card${pl(effect[1])}\n-4: Put a Card in Discard\nPile in Your Hand\nPut a Card in Draw\nPile in Your Hand\n-9: Discard Your Hand\nGain (E) (E) (E)\nDraw ${effect[2]} Card${pl(effect[2])}`; break
            case 4631: string+=`+1: Draw ${effect[0]} Card${pl(effect[0])}\nRewind ${effect[1]} Card${pl(effect[1])}\n-4: Put a Card in Discard\nPile in Your Hand\nPut a Card in Draw\nPile in Your Hand\n-9: Discard Your Hand\nGain (E) (E) (E) (E)\nDraw ${effect[2]} Card${pl(effect[2])}`; break
            case 4632: string+=`+1: Draw ${effect[0]} Card${pl(effect[0])}\nRewind ${effect[1]} Card${pl(effect[1])}\n-4: Put a Card in Discard\nPile in Your Hand\nPut a Card in Draw\nPile in Your Hand\n-9: Discard Your Hand\nGain (E) (E) (E) (E) (E)\nDraw ${effect[2]} Card${pl(effect[2])}`; break
            ...
            case 4651: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nGain (E) Per ${effect[1]} Card${pl(effect[1])}\nin Your Deck`; break
            case 4652: string+=`Gain (E)\nExhaust ${effect[0]} Card${pl(effect[0])}`; break
            case 4653: string+=`Gain (E) (E)\nExhaust ${effect[0]} Card${pl(effect[0])}`; break
            case 4654: string+=`Convert Charge to (E)`; break
            case 4655: string+=`When Drawn, Gain (E)\nWhen Exhausted,\nDeal ${this.calculateEffect(effect[0],0)} Damage\nto a Random Enemy`; break
            case 4656: string+=`When Drawn, Gain (E)\nWhen Exhausted,\nPut a Copy of\na Card in Draw\nPile in Your Hand`; break
            case 4657: string+=`When Drawn, Gain (E)\nWhen Exhausted,\nPut a Copy of\na Card in Draw\nPile in Your Hand\nand Add ${this.calculateEffect(effect[0],1)} Block`; break
            case 4658: string+=`Gain (E) (E)\nGain ${effect[0]} Charge\nCharge Increases by ${effect[1]}`; break
            case 4659: string+=`Gain (E) Next Turn\nAmplify (E):\nAmplifying is Free\nThis Turn`; break
            case 4660: string+=`Gain (E) (E) Next Turn\nAmplify (E):\nAmplifying is Free\nThis Turn`; break
            case 4661: string+=`Gain (E) (E) (E) Next Turn\nAmplify (E):\nAmplifying is Free\nThis Turn`; break
            case 4662: string+=`Next ${effect[0]!=1?`${effect[0]} `:``}Attack${pl(effect[0])}\nDeal${effect[0]==1?`s`:``} Double Damage\nAmplify (E):\nTriple Damage Instead`; break
            case 4663: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nAmplify (B):\nDraw ${effect[1]} Card${pl(effect[1])}\nRetain ${effect[2]} Card${pl(effect[2])} Once`; break
            case 4664: string+=`Exhaust ${effect[0]} Card${pl(effect[0])}\nIf You Have No Mana,\nGain (E)`; break
            case 4665: string+=`Exhaust ${effect[0]} Card${pl(effect[0])}\nIf You Have No Mana,\nGain (E) (E)`; break
            case 4666: string+=`Exhaust ${effect[0]} Card${pl(effect[0])}\nIf You Have No Mana,\nGain (E) (E) (E)`; break
            case 4667: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nOverdrive ${effect[1]}:\nAdd ${effect[2]} Torch${effect[2]!=1?`es`:``}\nto Hand`; break
            case 4668: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nIf Blocked,\nGain (E) (E) (E)\nOtherwise,\nDeals Damage Again`; break
            case 4669: string+=`Gain (E) at the\nStart of Your Turn\nAfter 2 Turns`; break
            case 4670: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nGain ${effect[1]} Charge\nIf You Have No Charge\nOtherwise,\nGain ${effect[2]} Charge`; break
            case 4671: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nAmplify (E):\nAll Cards in Hand\nCost ${effect[1]} Less Temporarily`; break
            case 4672: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nAmplify (N) (N):\nDeal Triple Damage`; break
            case 4673: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nMana Total Divisible by 3:\nGain (E)\nGain ${effect[1]} Charge`; break
            case 4674: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nMana Total Divisible by 3:\nGain (E) (E)\nGain ${effect[1]} Charge`; break
            case 4675: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nIf Last Card\nPlayed Was Blue,\nDraw ${effect[1]} Card${pl(effect[1])}`; break
            case 4676: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\n2 Times\nIf Last Card\nPlayed Was Red,\nGain ${effect[1]} Charge`; break
            case 4677: string+=`Gain ${effect[0]} Temporary\nStrength\nOverdrive ${effect[1]}:\nGain (E)`; break
            case 4678: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nDraw ${effect[1]} Card${pl(effect[1])}\nAmplify (E):\nPut a Card in Discard\nPile in Your Hand`; break
            case 4679: string+=`Deal ${this.calculateEffect(effect[0],2)} Damage\nFor Each (E) Spent:\nIncrease X by 2`; break
            case 4680: string+=`Gain ${effect[0]} Dexterity\nWhen Discarded\nFrom Your Hand,\nGain (W) (G) (N)\nNext Turn`; break
            case 4681: string+=`Gain ${effect[0]} Dexterity\nWhen Discarded\nFrom Your Hand,\nGain (E) (E) (W) (G)\nNext Turn`; break
            case 4682: string+=`Gain ${effect[0]} Dexterity\nWhen Discarded\nFrom Your Hand,\nGain (E) (E) (E) (E)\nNext Turn`; break
            case 4683: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nCounter ${effect[1]} All\nWhen Discarded\nFrom Your Hand,\nDraw ${effect[2]} Movement${pl(effect[2])}`; break
            case 4684: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nMana Total Divisible by 3:\nApply ${effect[1]} Lock On`; break
            case 4685: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\n${effect[1]} or More\nCards in Hand:\nGain (G) (N)`; break
            case 4686: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\n${effect[1]} or More\nCards in Hand:\nGain (E) (G)`; break
            case 4687: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\n${effect[1]} or More\nCards in Hand:\nGain (E) (E)`; break
            case 4688: string+=`Add ${this.calculateEffect(effect[0],1)} Block\n${effect[1]} or More\nCards in Hand:\nGain (G) (N)`; break
            case 4689: string+=`Add ${this.calculateEffect(effect[0],1)} Block\n${effect[1]} or More\nCards in Hand:\nGain (E) (G)`; break
            case 4690: string+=`Add ${this.calculateEffect(effect[0],1)} Block\n${effect[1]} or More\nCards in Hand:\nGain (E) (E)`; break
            case 4691: string+=`Move ${effect[0]} Tile${pl(effect[0])}\n${effect[1]} or More\nCards in Hand:\nGain (G) (N)`; break
            case 4692: string+=`Move ${effect[0]} Tile${pl(effect[0])}\n${effect[1]} or More\nCards in Hand:\nGain (E) (G)`; break
            case 4693: string+=`Move ${effect[0]} Tile${pl(effect[0])}\n${effect[1]} or More\nCards in Hand:\nGain (E) (E)`; break
            case 4694: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nIf You Have Dodge,\nGain (R) (R) (N)`; break
            case 4695: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nIf You Have Dodge,\nGain (E) (R) (R)`; break
            case 4696: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nIf You Have Dodge,\nGain (E) (E) (R) (R)`; break
            case 4697: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nDraw ${effect[1]} Rare Card${pl(effect[1])}`; break
            case 4698: string+=`Gain (G) When\nYou Dodge an Attack`; break
            ...
            case 4727: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\n2 Times\nIncreases by ${effect[1]}\nReturn on Heal\nReturn on Health Loss`; break
            case 4728: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nIf Target Does\nNot Lose Health,\nGain (W) (W) (W) and\nAdd ${effect[1]} Random\nDefenses to Hand\n${effect[1]!=1?`They Cost`:`It Costs`} 0 Temporarily`; break
            case 4729: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nIf Target Does\nNot Lose Health,\nGain (W) (W) (W) (W) and\nAdd ${effect[1]} Random\nDefenses to Hand\n${effect[1]!=1?`They Cost`:`It Costs`} 0 Temporarily`; break
            case 4730: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nIf Target Does\nNot Lose Health,\nGain (E) (E) (E) (E) and\nAdd ${effect[1]} Random\nDefenses to Hand\n${effect[1]!=1?`They Cost`:`It Costs`} 0 Temporarily`; break
            case 4731: string+=`Choose a 1 Cost,\n2 Cost, 3 Cost,\nor 4 Cost Card\nto Add to Hand`; break
            case 4732: string+=`Choose a 1 Cost,\n2 Cost, 3 Cost,\n4 Cost, or 5 Cost Card\nto Add to Hand`; break
            case 4733: string+=`Gain (E) (E)\nChoose a 1, 2, or 3\nTotal Cost Card\nto Add to Hand`; break
            case 4734: string+=`Gain (E) (E)\nChoose a 1, 2, 3, or 4\nTotal Cost Card\nto Add to Hand`; break
            case 4735: string+=`Gain (E) (E)\nChoose a 1, 2, 3, 4, or 5\nTotal Cost Card\nto Add to Hand`; break
            case 4736: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nPlayed Last Turn:\nAttack${this.player>=0&&this.player<this.battle.players&&!this.nonCalc?` (${this.battle.cardManagers[this.player].hand.lastTurnPlayed[1]})`:``}: Draw ${effect[1]} Card${pl(effect[1])}\nDefense${this.player>=0&&this.player<this.battle.players&&!this.nonCalc?` (${this.battle.cardManagers[this.player].hand.lastTurnPlayed[2]})`:``}: Gain (K) (R)`; break
            case 4737: string+=`Gain (N) at the\nStart of Your Turn\nGain ${effect[0]} Strength\nGain ${effect[1]} Dexterity\nSpawn a Management\nRobot Enemy`; break
            case 4738: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nWhen Exhausted,\nGain (E) (B)`; break
            case 4739: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nWhen Exhausted,\nGain (E) (E) (B)`; break
            case 4740: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nWhen Exhausted,\nGain (E) (E) (B) (B)`; break
            case 4741: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nIncreases by ${effect[1]}\nWhen Incremented With (E)`; break
            case 4742: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nIncreases by ${effect[1]}\nWhen Incremented With (E)`; break
            case 4743: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nIncreases by ${effect[1]}\nWhen Incremented With (E)\nIncreases by ${effect[2]} When\nYou Play a Movement`; break
            case 4744: string+=`Deal ${this.calculateEffect(effect[0],0)} Splash Damage\nNext Turn, Gain (E)\nand a Random\nCard Costs ${effect[1]} More`; break
            case 4745: string+=`Deal ${this.calculateEffect(effect[0],0)} Splash Damage\nNext Turn, Gain (E) (E)\nand a Random\nCard Costs ${effect[1]} More`; break
            case 4746: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nRetain Block For ${effect[1]} Turn${pl(effect[1])}\nGain ${effect[2]} Strength\nLose ${effect[3]} Health Per Turn\nWhen Drawn,\nGain (K)`; break
            ...
            case 4759: string+=`Heal ${this.calculateEffect(effect[0],4)} Health\nYou Cannot Move\nFor ${effect[1]} Turn${pl(effect[1])}\nAdd a Stuffed\nto Hand`; break
            case 4760: string+=`Odd Mana Total:\nLose ${effect[0]} Random Mana`; break
            case 4765: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nDecreases by ${effect[1]}\nGain (N) in 2 Turns`; break
            case 4766: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nDraw ${effect[1]} Card${pl(effect[1])}\nGain (E)\nGain (E) Next Turn`; break
            case 4767: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nDraw ${effect[1]} Card${pl(effect[1])}\nGain (E) (E) (E) (E) (E)`; break
            case 4768: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nIf Target Has\nLess Health Than You,\nGain (G) (N)`; break
            case 4769: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nIf Target Has\nMore Health Than You,\nGain (G) (N)`; break
            case 4770: string+=`Apply ${effect[0]} Burn\nin All Directions\nApply ${effect[1]} Freeze\nin All Directions\nGain (E)\nDraw ${effect[2]} Card${pl(effect[2])}`; break
            case 4771: string+=`More Mana Than Base:\nDeal ${this.calculateEffect(effect[0],0)} Damage\nIncreases by ${effect[1]}\nIgnore Block`; break
            case 4772: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nExactly 4 Total Mana:\nDiscards to Hand`; break
            case 4773: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nExactly 4 Total Mana:\nGain (B) (R)`; break
            case 4774: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nExactly 4 Total Mana:\nGain (E) (E)`; break
            case 4775: string+=`Gain (E) (E) (E) Next Turn\nGain ${effect[0]} Dexterity\nNext Turn`; break
            case 4776: string+=`Gain (E) (E)\n(E) (E) Next Turn\nGain ${effect[0]} Dexterity\nNext Turn`; break
            case 4777: string+=`Gain (E) (E) (E)\n(E) (E) Next Turn\nGain ${effect[0]} Dexterity\nNext Turn`; break
            case 4778: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nFor Each (K) Spent:\nDraw ${effect[1]} Card${pl(effect[1])}`; break
            case 4779: string+=`Gain (E) (N)\nHidden Swap 2 Cards\nFrom Draw`; break
            case 4780: string+=`Gain (E) (E) (N)\nHidden Swap 2 Cards\nFrom Draw`; break
            case 4781: string+=`Gain (E) (E) (N) (N)\nHidden Swap 2 Cards\nFrom Draw`; break
            case 4782: string+=`Exactly 1 Mana:\nDeal ${this.calculateEffect(effect[0],0)} Damage\nApply ${effect[1]} Weak\nWhen Vanished,\nChoose a Rare Card\nto Add Permanently`; break
            case 4783: string+=`4 or More Mana:\nDeal ${this.calculateEffect(effect[0],0)} Damage\nApply ${effect[1]} Burn`; break
            case 4784: string+=`4 or More Mana:\nDeal ${this.calculateEffect(effect[0],0)} Damage\nApply ${effect[1]} Freeze`; break
            case 4785: string+=`4 or More Mana:\nDeal ${this.calculateEffect(effect[0],0)} Damage\nDraw ${effect[1]} More\nCard${pl(effect[1])} Next Turn`; break
            case 4786: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nFor Each (G) Spent:\nApply ${effect[1]} Burn`; break
            case 4787: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nFor Each (G) Spent:\nApply ${effect[1]} Freeze`; break
            case 4788: string+=`Exactly 0 Mana:\nApply ${effect[0]} Freeze\nand Draw ${effect[1]} Card${pl(effect[1])}`; break
            case 4789: string+=`Exactly 0 Mana:\nGain ${effect[0]} Armor\nand Draw ${effect[1]} Card${pl(effect[1])}`; break
            case 4790: string+=`Exactly 0 Mana:\nApply ${effect[0]} Burn\nand Draw ${effect[1]} Card${pl(effect[1])}`; break
            case 4791: string+=`Exactly 0 Mana:\nApply ${effect[0]} Bleed\nand Draw ${effect[1]} Card${pl(effect[1])}`; break
            case 4792: string+=`Exactly 0 Mana:\nApply ${effect[0]} Shock\nand Draw ${effect[1]} Card${pl(effect[1])}`; break
            case 4793: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nApply ${effect[1]} Burn\n75%: Gain (R) (R)`; break
            case 4794: string+=`Gain ${effect[0]} Vulnerable\nGain (R) at the\nStart of Your Turn`; break
            case 4795: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nIf Fatal, Gain (E) at\nthe Start of Your Turn`; break
            case 4796: string+=`Add a Random Mana\nto the Mana Base\nFor This Combat\nEach Turn`; break
            case 4797: string+=`4th Card in Hand\nand Exactly 3 Mana:\nDeal ${this.calculateEffect(effect[0],0)} Damage\nTarget Deals Half\nDamage For ${effect[1]} Turn${pl(effect[1])}`; break
            case 4798: string+=`For Each (1) Spent:\nGain (N) (N)`; break
            case 4799: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nSend Remaining Mana\nto Next Turn`; break
            case 4800: string+=`Deal ${this.calculateEffect(1,2)}${effect[0]!=0?`+${this.calculateEffect(effect[0],10)}`:``} Damage\nWhere X = Number\nof Cards in Hand\nAmplify (E):\nDeal ${this.calculateEffect(effect[1],2)} Damage Instead\nWhere X = Mana Total`; break
            case 4801: string+=`Draw ${effect[0]} Card${pl(effect[0])}\nDiscard ${effect[1]} Random Card${pl(effect[1])}\nAmplify (E) (E) (E):\nDraw ${effect[2]} More\nCard${pl(effect[2])} Per Turn`; break
            case 4802: string+=`Draw ${effect[0]} Card${pl(effect[0])}\nDiscard ${effect[1]} Random Card${pl(effect[1])}\nAmplify (E) (E):\nDraw ${effect[2]} More\nCard${pl(effect[2])} Per Turn`; break
            case 4803: string+=`Draw ${effect[0]} Card${pl(effect[0])}\nDiscard ${effect[1]} Random Card${pl(effect[1])}\nAmplify (E):\nDraw ${effect[2]} More\nCard${pl(effect[2])} Per Turn`; break
            case 4804: string+=`Exactly 0 Mana:\nApply ${effect[0]} Chained\nand Draw ${effect[1]} Card${pl(effect[1])}`; break
            case 4805: string+=`Apply ${effect[0]} Poison\n60%: Gain (K)\nDiscards to Hand`; break
            case 4806: string+=`Apply ${effect[0]} Poison\n75%: Gain (K)\nDiscards to Hand`; break
            case 4807: string+=`Apply ${effect[0]} Poison\n75%: Gain (K)\n25%: Draw ${effect[1]} Card${pl(effect[1])}\nDiscards to Hand`; break
            case 4808: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nFor Each (K) Spent (${effect[1]}):\nGain (N)\nDiscards to Hand`; break
            case 4809: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nOdd Mana Total:\nApply ${effect[1]} Fade`; break
            case 4810: string+=`Exactly 0 Mana:\nApply ${effect[0]} Fade\nand Draw ${effect[1]} Card${pl(effect[1])}`; break
            case 4811: string+=`4 or More Mana:\nDeal ${this.calculateEffect(effect[0],0)} Damage\nApply ${effect[1]} Fade`; break
            case 4812: string+=`${effect[0]>0?`Deal ${this.calculateEffect(effect[0],0)} Damage\n`:`\n`}Rotate Target Randomly\nLeft or Right\n75%: Gain (N) (N)`; break
            case 4813: string+=`Add ${this.calculateEffect(effect[0],18)} Barrier\nGain (N)\nIf X is 1 or More`; break
            case 4814: string+=`Add ${this.calculateEffect(effect[0],18)} Barrier\nGain (N)`; break
            case 4815: string+=`Heal Target For ${effect[0]}\nGain (E) (E)\nIf Healed to Full, Lose\n${effect[1]} Currency`; break
            case 4816: string+=`Apply ${effect[0]} Burn\nDiscard ${effect[1]} Random Card${pl(effect[1])}`; break
            case 4817: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nTarget Below 25% Health:\nGain (W) (B)`; break
            case 4818: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nTarget Below 25% Health:\nGain (E) (W) (B)`; break
            case 4819: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nTarget Below 25% Health:\nGain (E) (W) (B) (N)`; break
            case 4820: string+=`Gain (K) (R) and\nDraw ${effect[0]} Less Card${pl(effect[0])}\nEvery Turn`; break
            case 4821: string+=`Exactly 0 Mana:\nAdd ${this.calculateEffect(effect[0],1)} Block\nHeal ${this.calculateEffect(effect[1],4)} Health\nDraw ${effect[2]} Card${pl(effect[2])}`; break
            case 4822: string+=`Exactly 0 Mana:\nApply ${effect[0]} Jinx\nand Draw ${effect[1]} Card${pl(effect[1])}`; break
            case 4823: string+=`Gain (E) (B) (K)\nAdd a Nightfall\nof Equivalent Level\nto Discard Pile`; break
            case 4824: string+=`Gain (E) (E) (B) (K)\nAdd a Nightfall\nof Equivalent Level\nto Discard Pile`; break
            case 4825: string+=`Gain (E) (E) (E) (E)\nAdd a Nightfall\nof Equivalent Level\nto Discard Pile`; break
            case 4826: string+=`Remove All Mana\nGain (E)`; break
            case 4827: string+=`Remove All Mana\nGain (E) (E)\nA Random Card\nCosts ${effect[0]} More`; break
            case 4828: string+=`Exactly 3 Mana:\nHeal ${this.calculateEffect(effect[0],4)} Health`; break
            case 4829: string+=`Exactly 4 Mana:\nAdd ${this.calculateEffect(effect[0],1)} Block`; break
            case 4830: string+=`Exactly 2 Mana:\nCounter ${effect[0]} All\nThis Combat`; break
            case 4831: string+=`Even Mana Total:\nDeal ${this.calculateEffect(effect[0],0)} Damage\nGain (N)\nDraw ${effect[1]} Card${pl(effect[1])}\nDiscard ${effect[2]} Random Card${pl(effect[2])}`; break
            case 4832: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nDraw ${effect[1]} Card${pl(effect[1])}\nDiscard ${effect[2]} Random Card${pl(effect[2])}\nEven Mana Total:\nDraw Even Total Costs\nOdd Mana Total:\nDraw Odd Total Costs`; break
            case 4833: string+=`Requires ${['Even','Odd'][this.limit%2]} Mana Total\nDeal ${this.calculateEffect(effect[0],0)} Damage\nDiscards to Hand`; break
            case 4834: string+=`Requires ${['Even','Odd'][this.limit%2]} Mana Total\nDeal ${this.calculateEffect(effect[0],0)} Damage\nIncreases by ${effect[1]}\nDiscards to Hand`; break
            case 4835: string+=`For Each (1) Spent:\nGain ${effect[0]} Random Mana`; break
            case 4836: string+=`2 or More Mana:\nAdd ${this.calculateEffect(effect[0],1)} Block\nDiscard ${effect[1]} Random Card${pl(effect[1])}`; break
            case 4837: string+=`2 or More Mana:\nDeal ${this.calculateEffect(effect[0],2)}+${this.calculateEffect(effect[1],14)} Damage\nWhere X = Mana Total`; break
            case 4838: string+=`2 or More Mana:\nHeal ${this.calculateEffect(effect[0],4)} Health\nDiscard ${effect[1]} Random Card${pl(effect[1])}`; break
            case 4839: string+=`Odd Mana Total:\nDeal ${this.calculateEffect(effect[0],0)} Damage\nIf Exactly 3, Counter\n${effect[1]} All This Combat`; break
            case 4840: string+=`Discard Duplicate Cards\nIf Successful,\nGain (E) (E)\nDraw ${effect[0]} Card${pl(effect[0])}`; break
            ...
            case 4848: string+=`Exactly 0 Mana:\nDeal ${this.calculateEffect(effect[0],0)} Damage\nLose ${effect[1]} Currency\nDraw ${effect[2]} Card${pl(effect[2])}`; break
            case 4849: string+=`Gain (E) (E) (E) (E) (E)\nDiscard the Card\nto the Right`; break
            case 4850: string+=`Apply ${effect[0]} Freeze\nGain (E)\nNext 3 Turns`; break
            case 4851: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nMana Total Divisible by 3:\nGain (E) (E)\nDiscard the Card\nto the Right`; break
            case 4852: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nMana Total Divisible by 3:\nGain (E) (E) (E)\nDiscard the Card\nto the Right`; break
            ...
            case 4860: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nRemove a Buff\nFrom Target\nAmplify (G):\nDeal ${this.calculateEffect(effect[1],0)} Damage Instead`; break
            case 4861: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nExactly 2 Mana:\nGain ${effect[1]} Charge`; break
            case 4862: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nAmplify (E):\nHeal Equal to Half of\nTarget's Health Lost`; break
            case 4863: string+=`Wrath:\nGain ${effect[0]} Strength\nCalm:\nGain (E) (E) Next Turn\nHaste:\nGain ${effect[1]} Dodge\nSturdy:\nGain ${effect[2]} Dexterity`; break
            case 4864: string+=`Wrath:\nGain ${effect[0]} Strength\nCalm:\nGain (E) (E) (E) Next Turn\nHaste:\nGain ${effect[1]} Dodge\nSturdy:\nGain ${effect[2]} Dexterity`; break
            case 4865: string+=`Wrath:\nGain ${effect[0]} Strength\nCalm:\nGain (E) (E)\n(E) (E) Next Turn\nHaste:\nGain ${effect[1]} Dodge\nSturdy:\nGain ${effect[2]} Dexterity`; break
            case 4866: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nSparks in Hand\nGain Effect Equal to\nTarget's Health Lost\nAmplify (N) (N):\nDeal ${this.calculateEffect(effect[1],0)} Damage Instead`; break
            case 4867: string+=`Gain (E) (E) (E) (E) (E)\nDraw ${effect[0]} Card${pl(effect[0])}`; break
            case 4868: string+=`Deal ${this.calculateEffect(effect[0],0)}+${this.calculateEffect(effect[1],11)} Damage\nWhere X = Number\nof Burns in Hand\nAmplify (W) (W):\nDeal Double Damage`; break
            case 4869: string+=`Deal ${this.calculateEffect(effect[0],0)} Splash Damage\nAmplify (W) (W) (W):\nInstantly Kill Those\nWith ${effect[1]} or Less Health`; break
            case 4870: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nGain Currency Equal to\nTarget's Health Lost\nAmplify (N):\nGain Double Currency`; break
            case 4871: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nFor Each (R) Spent:\nAdd ${effect[1]} Spark${pl(effect[1])}\nto Hand`; break
            case 4872: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nIf Last Card Played\nWas a Defense,\nGain (B) (N)`; break
            case 4873: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nIf Last Card Played\nWas a Defense,\nGain (E) (B)`; break
            case 4874: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nIf Last Card Played\nWas a Defense,\nGain (E) (E)`; break
            case 4875: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nIf Last Card Played\nWas an Attack,\nGain (B) (N)`; break
            case 4876: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nIf Last Card Played\nWas an Attack,\nGain (E) (B)`; break
            case 4877: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nIf Last Card Played\nWas an Attack,\nGain (E) (E)`; break
            case 4878: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nIf Last Card Played\nWas a Movement,\nGain (B) (N)`; break
            case 4879: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nIf Last Card Played\nWas a Movement,\nGain (E) (B)`; break
            case 4880: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nIf Last Card Played\nWas a Movement,\nGain (E) (E)`; break
            case 4881: string+=`Exactly ${effect[0]} Mana:\nDeal ${this.calculateEffect(effect[1],0)} Damage\nChanges on Play`; break
            case 4882: string+=`Even Mana Total:\nApply ${effect[0]} Miss`; break
            case 4883: string+=`Add a Miracle to Your\nHand For X Turns\nGain (E)`; break
            case 4884: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nGain 1-${effect[1]} (E)`; break
            case 4885: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nAmplify (E):\nAdd ${effect[1]} Miracle${pl(effect[1])} to Hand`; break
            case 4886: string+=`Set Mana to Base\nGain ${effect[0]} Shock`; break
            case 4887: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nEven Mana Total:\nLose ${effect[1]} Random Mana`; break
            case 4888: string+=`Odd Mana Total:\nDeal ${this.calculateEffect(effect[0],0)} Damage\nIf You Have Exactly 3,\nApply ${effect[1]} Weak`; break
            case 4889: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nIf Target Will Attack,\nDraw ${effect[1]} Card${pl(effect[1])}\nOtherwise,\nGain (N)`; break
            case 4890: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nIf Target Will Attack,\nDraw ${effect[1]} Card${pl(effect[1])}\nOtherwise,\nGain (N) (N)`; break
            case 4891: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nGain (K) (K) (N) (N)\nIf You Have Weak`; break
            case 4892: string+=`Draw ${effect[0]} Card${pl(effect[0])}\n${effect[0]!=1?`They Cost`:`It Costs`} 0 Temporarily\nAmplify (W):\nRetain ${effect[0]==1?`it`:`Them`} Until Played\nGain (E) Next Turn`; break
            case 4893: string+=`Gain (E) (E) (E)\nDraw Cards to ${effect[0]} Cost`; break
            case 4894: string+=`Gain (E) (E) (E) (E)\nDraw Cards to ${effect[0]} Cost`; break
            case 4895: string+=`Set Mana to Base`; break
            ...
            case 4912: string+=`Gain ${effect[0]} Random Mana`; break
            case 4913: string+=`Confuse a Random\nCard in Hand`; break
            case 4914: string+=`Confuses a Random\nCard in Hand\nDraw ${effect[0]} Card${pl(effect[0])}`; break
            case 4915: string+=`Gain ${effect[0]} Energy\nNext Attack Deals\n${effect[1]} Less Damage`; break
            case 4916: string+=`Gain (W) (W)\nNext Attack Deals\n${effect[0]} Less Damage`; break
            case 4917: string+=`Gain (W) (W) (W)\nNext Attack Deals\n${effect[0]} Less Damage`; break
            case 4918: string+=`Gain (W) (W) (W) (W)\nNext Attack Deals\n${effect[0]} Less Damage`; break
            case 4919: string+=`Gain ${effect[0]} Armor\nCenter of Hand:\nGain (N)`; break
            case 4920: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nIf Last Card\nPlayed Was Black,\nDraw ${effect[1]} Card${pl(effect[1])}`; break
            case 4921: string+=`Add to Hand:\nBuild Wall\nMobJustice\nConviction`; break
            case 4922: string+=`Add to Hand:\nBuild Wall\nMobJustice\nConviction\nUpgrade 1\nat Random`; break
            case 4923: string+=`Add to Hand:\nBuild Wall\nMobJustice\nConviction\nUpgrade 2\nat Random`; break
            case 4924: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nApply ${effect[1]} Vulnerable\nWhen Discarded\nFrom Your Hand,\nTrigger Effect\nto All Enemies`; break
            case 4925: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nOdd Energy:\nGain ${effect[1]} Energy`; break
            case 4926: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nFor Each (K) Spent (${effect[1]}):\nGain (N)`; break
            case 4927: string+=`Any Construct Takes\n${effect[0]} Extra Turn${pl(effect[0])}\nand Adds ${effect[1]} Block\nIt Loses ${effect[2]} Health\nNext Turn`; break
            case 4928: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nWhen Drawn or Rewound,\nIncreases by ${effect[1]}`; break
            case 4929: string+=`Add X Random\nAttacks of Equivalent\nLevel to Hand\nThey Cost 0 and\nHave Exhaust`; break
            case 4930: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nWhen Played or When\nDiscarded From Hand,\nAdd ${effect[1]} Throwing\nKni${effect[1]!=1?`ves`:`fe`} to Hand`; break
            case 4931: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nDeal ${this.calculateEffect(effect[1],0)} Damage\nto a Random Enemy\nWhen Discarded\nin Any Way`; break
            case 4932: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nDeals Double if\nYou Have Played\n${effect[1]} Attack${pl(effect[1])} This TUrn`; break
            case 4933: string+=`Draw ${effect[0]} Card${pl(effect[0])}\nWhen Exhausted,\nDraw ${effect[1]} Card${pl(effect[1])}`; break
            case 4934: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\n1/3: Target Takes ${effect[1]}\nDamage Per Card\nPlayed This Turn\n1/3: Apply ${effect[2]} Poison\n1/3: Apply ${effect[3]} Bleed\nElemental Form:\nGuarantee All Chances`; break
            case 4935: string+=`Put a Card in Draw\nPile in Your Hand\nNext Card Played\nReturns to the\nTop of Draw Pile`; break
            case 4936: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nAmplify:\nGain ${effect[1]} Energy\nNext Turn`; break
            case 4937: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nAmplify (W):\nGain (E) (E)\nNext Turn`; break
            case 4938: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nAmplify (W):\nGain (E) (E) (E)\nNext Turn`; break
            case 4939: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nAmplify (W):\nGain (E) (E) (E) (E)\nNext Turn`; break
            case 4940: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nin All Directions\nShuffle a Comet\nof Equivalent Level\ninto Draw Pile`; break
            case 4941: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nDraw ${effect[1]} Card${pl(effect[1])}\nGain ${effect[2]} Temporary\nDexterity`; break
            case 4942: string+=`Exhaust Non-Attacks\nFor Each, Gain ${effect[0]} Charge\nand Draw ${effect[1]} Card${pl(effect[1])}`; break
            case 4943: string+=`50%: Gain ${effect[0]} Energy\n50%: Upgrade ${effect[1]} Card${pl(effect[1])}`; break
            case 4944: string+=`50%: Gain (E) (E)\n50%: Upgrade ${effect[0]} Card${pl(effect[0])}`; break
            ...
            case 4949: string+=`Haste:\nGain (E) (G)`; break
            case 4950: string+=`Haste:\nGain (E) (E) (G)`; break
            case 4951: string+=`Haste:\nGain (E) (E) (G) (G)`; break
            case 4952: string+=`Gain ${effect[0]} Energy\nNext Turn\nClaw Up ${effect[1]}`; break
            case 4953: string+=`Gain (W) (N)\nNext Turn\nClaw Up ${effect[0]}`; break
            case 4954: string+=`Gain (E) (W) (N)\nNext Turn\nClaw Up ${effect[0]}`; break
            case 4955: string+=`Gain (E) (E) (W)\nNext Turn\nClaw Up ${effect[0]}`; break
            case 4956: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nOdd Energy:\nGain ${effect[1]} Temporary\nStrength`; break
            case 4957: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nFor Each (R) Spent:\nGain ${effect[1]} Temporary\nStrength`; break
            case 4958: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nIf Fatal, Next ${effect[1]!=1?`${effect[1]} `:``}Attack${pl(effect[1])}\nDeal${effect[1]==1?`s`:``} No Damage`; break
            case 4959: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\n2 Times\nDeal ${this.calculateEffect(effect[1],0)} Splash Damage\nAround Self`; break
            case 4961: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\n2 Times\nAdd ${effect[1]} Random\nCard${pl(effect[1])} to Hand\n${effect[1]!=1?`They Cost`:`It Costs`} 0 Temporarily`; break
            case 4962: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\n2 Times\nGain ${effect[1]} Temporary\nDexterity`; break
            case 4963: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\n2 Times\nChoose a Card in Hand:\nIf it is a Status or Curse,\nExhaust it\nOtherwise, it Costs 1 Less\nand Retains Until Played`; break
            case 4964: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\n2nd Card in Hand:\nApply ${effect[1]} Frail`; break
            case 4965: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nIf Fatal,\nDraw ${effect[1]} Card${pl(effect[1])}\nand Gain ${effect[2]} Ammo`; break
            case 4966: string+=`Gain (E)\nAnd Draw ${effect[0]} Card${pl(effect[0])}\nWhen You Play\na 2+ Cost Card`; break
            case 4967: string+=`When You\nPlay a Discus,\nGain ${effect[0]} Temporary\nStrength and ${effect[1]}\nTemporary Dexterity`; break
            case 4968: string+=`Upgrade ${effect[0]} Card${pl(effect[0])}\nTransform ${effect[1]} Card${pl(effect[1])}\nRetain ${effect[2]} Card${pl(effect[2])} Once`; break
            case 4969: string+=`Next ${effect[0]!=1?`${effect[0]} `:``}Attack${pl(effect[0])}\nDeal${effect[0]==1?`s`:``} Triple Damage`; break
            case 4970: string+=`Put a Card in Draw\nPile in Your Hand\nPut a Card in Discard\nPile in Your Hand`; break
            case 4971: string+=`Set Combo to Cap\nLose All Combo\nNext Turn`; break
            case 4972: string+=`Gain ${effect[0]} Temporary\nStrength\nDraw ${effect[1]} Attack${pl(effect[1])}`; break
            case 4973: string+=`Next ${effect[0]!=1?`${effect[0]} `:``}Attack${pl(effect[0])}\nDeal${effect[0]==1?`s`:``} Triple Damage\nNext ${effect[1]!=1?`${effect[1]} `:``}Attack${pl(effect[1])}\nPlayed ${effect[1]!=1?`are`:`is`} Duplicated`; break
            case 4974: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nApply ${effect[1]} Frail\nin All Directions`; break
            case 4976: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nGain (E)\nWhen Drawn Innately,\nDraw ${effect[1]} Less Card${pl(effect[1])}`; break
            case 4977: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nGain (E) (E)\nWhen Drawn Innately,\nDraw ${effect[1]} Less Card${pl(effect[1])}`; break
            case 4978: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nGain (E) (E) (E)\nWhen Drawn Innately,\nDraw ${effect[1]} Less Card${pl(effect[1])}`; break
            case 4979: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nGain (E)`; break
            case 4980: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nGain (E) (E)`; break
            case 4981: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nGain (E) (E) (E)`; break
            case 4982: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nto Any Enemy\nCreate 1 Plant Tile\nUnder Target\nCreate 1 Plant Tile\nUnder Self`; break
            case 4983: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nUpgrade the Rightmost\nCard in Hand`; break
            case 4984: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nin All Directions\nFar Left or\nFar Right of Hand:\nAdd ${this.calculateEffect(effect[1],1)} Block`; break
            case 4985: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nGain ${effect[1]} Energy if\nYou Have ${effect[2]} or More\nCop${effect[2]!=1?`ies`:`y`} of This Card\nin Your Deck`; break
            case 4986: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nGain (E) if\nYou Have ${effect[1]}\nCop${effect[1]!=1?`ies`:`y`} of This Card\nin Your Deck`; break
            case 4987: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nGain ${effect[1]} Energy Next Turn\nAdd Another Random\nSculpture of Equivalent\nLevel to Hand`; break
            case 4988: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nGain (B) (B) (B) Next Turn\nAdd Another Random\nSculpture of Equivalent\nLevel to Hand`; break
            case 4989: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nStraight Right:\nAdd ${this.calculateEffect(effect[0],1)} Block`; break
            case 4990: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nUpward-Left:\nAdd ${this.calculateEffect(effect[0],1)} Block`; break
            case 4991: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nDownward-Left:\nAdd ${this.calculateEffect(effect[0],1)} Block`; break
            case 4992: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nin All Direction\nUpgrades Repeatedly\nby ${effect[1]}`; break
            ...
            case 5000: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nHold ${effect[1]} Glass Orb${pl(effect[1])}`; break
            case 5001: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nIncreases by ${effect[1]} When\nAbsorbing Wish Power\nResets on Use`; break
            case 5002: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nand Apply ${effect[1]} Lock On\nto a Random Enemy`; break
            case 5004: string+=`Create 1 Plant Tile\nChoose a Sakura Card\nto Add to Hand`; break
            case 5005: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nDeal ${this.calculateEffect(effect[1],0)} Splash Damage\nWhen Discarded by Scry`; break
            case 5006: string+=`Gain ${effect[0]} Energy\nDraw ${effect[1]} Card${pl(effect[1])}\nGain ${effect[2]} Wish Power\nAdd a Glamorous\nStarlight to Discard`; break
            case 5007: string+=`Gain (E) (E)\nDraw ${effect[0]} Card${pl(effect[0])}\nGain ${effect[1]} Wish Power\nAdd a Glamorous\nStarlight to Discard`; break
            case 5008: string+=`Gain (E) (E) (E)\nDraw ${effect[0]} Card${pl(effect[0])}\nGain ${effect[1]} Wish Power\nAdd a Glamorous\nStarlight to Discard`; break
            case 5009: string+=`Add ${effect[0]} Random\nClaw Card${pl(effect[0])}\nof Equivalent Level\nto Hand\nClaw Up ${effect[1]}`; break
            case 5010: string+=`Gain ${effect[0]} Buffer\nGain ${effect[1]} Energy\nIf You Have\na Shield Orb`; break
            case 5011: string+=`Gain ${effect[0]} Buffer\nGain (E)\nIf You Have\na Shield Orb`; break
            case 5012: string+=`Gain ${effect[0]} Buffer\nGain (E) (E)\nIf You Have\na Shield Orb`; break
            case 5013: string+=`Gain ${effect[0]} Buffer\nGain (E) (E) (E)\nIf You Have\na Shield Orb`; break
            case 5014: string+=`${effect[0]>0?`Deal ${this.calculateEffect(effect[0],0)} Damage\n`:`\n`}Push 1 Tile\nCosts 1 Less Temporarily\nWhen You Play\na Movement`; break
            case 5015: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nUpgrade a Random\nConcoction in Hand\n${effect[1]} Time${pl(effect[1])}`; break
            case 5016: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nRetain Unspent ${variants.mtg?`Mana`:`Energy`}\nFor ${effect[1]} Turn${pl(effect[1])}`; break
            case 5017: string+=`Gain ${effect[0]} Base\nEnergy This Combat\nAdd ${effect[1]} Pristine${pl(effect[1])}\nto Hand`; break
            case 5018: string+=`Gain (N) at the\nStart of Your Turn\nAdd ${effect[0]} Pristine${pl(effect[0])}\nto Hand`; break
            case 5019: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nin All Directions\nTake Another Turn`; break
            case 5020: string+=`Choose a Junkyard\nCard to Add to Hand\nIt Costs 0`; break
            case 5021: string+=`Choose a Junkyard\nCard to Add to Hand\nIt Costs 0\nDraw ${effect[0]} Card${pl(effect[0])}`; break
            case 5022: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nCosts 0 Temporarily\nWhen You Play\na Power`; break
            case 5023: string+=`Choose a X+${effect[0]} ${variants.mtg?`Total\nCost Card of\n`:`Cost Card\nof `}Equivalent Level to\nAdd to Hand\nIt Costs 0`; break
            ...
            case 5028: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nGain (E) (E) (E)\nin 2 Turns\nand in 3 Turns`; break
            case 5030: string+=`Gain ${effect[0]} Dodge\nDiscard ${effect[1]} Card${pl(effect[1])}`; break
            case 5031: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nin All Directions\nAdd ${this.calculateEffect(effect[1],3)} Block\nWhere X = Number of\nShivs in Hand`; break
            case 5032: string+=`Draw ${effect[0]} Card${pl(effect[0])}\nDivinity: Gain ${effect[1]} Energy`; break
            case 5033: string+=`Draw ${effect[0]} Card${pl(effect[0])}\nDivinity: Gain (E)`; break
            case 5034: string+=`Heal ${this.calculateEffect(effect[0],4)} Health\nNext Overdrive is Free`; break
            case 5035: string+=`Upgrade the First\n${effect[0]} Card${pl(effect[0])} in Deck\nMay Deluxe Upgrade`; break
            case 5036: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nGain ${effect[1]} Armor\nGain ${effect[2]} Frail`; break
            case 5037: string+=`Build an Exploding Wall`; break
            case 5038: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nDeals Double Damage\nif Target Will Attack`; break
            case 5039: string+=`At the Start of Your Turn,\nApply ${effect[0]} Burn\nto All Enemies`; break
            case 5040: string+=`At the Start of Your Turn,\nApply ${effect[0]} Freeze\nto All Enemies`; break
            case 5041: string+=`Gain ${effect[0]} Energy\nChoose a Rare Card\nto Add to Hand`; break
            case 5042: string+=`Gain (E) (E) (E)\nChoose a Rare Card\nto Add to Hand`; break
            case 5043: string+=`Gain (E) (E) (E) (E)\nChoose a Rare Card\nto Add to Hand`; break
            case 5044: string+=`Gain (E) (E) (E) (E) (E)\nChoose a Rare Card\nto Add to Hand`; break
            case 5045: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nAdd ${this.calculateEffect(effect[1],1)} Block\nCounts as a Strike\nand a Defend`; break
            case 5046: string+=`Construct Auto-Attacks\nLine of Sight`; break
            case 5047: string+=`Draw ${effect[0]} Card${pl(effect[0])}\nGain ${effect[1]} Temporary\nStrength`; break
            case 5048: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nIncrease Turn\nNumber by ${effect[1]}`; break
            case 5049: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nDecrease Turn\nNumber by ${effect[1]}`; break
            case 5050: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nReturn on Extra Turn`; break
            case 5051: string+=`Apply ${effect[0]} Vulnerable\nReturn on Extra Turn`; break
            case 5052: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nCosts 0 Temporarily\non Stance Change`; break
            case 5053: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nCosts 0 Temporarily\non Stance Change`; break
            case 5054: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nIf There are no\nMovements in Hand,\nDraw ${effect[1]} Movement${pl(effect[1])}`; break
            case 5055: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\n2 Times\nShuffle ${effect[1]} Shiv${pl(effect[1])}\ninto Draw Pile\n${effect[1]!=1?`They Have`:`It Has`} Replenish`; break
            case 5056: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nPlace Ahead a\nLandmine`; break
            case 5058: string+=`Take Another Turn\nAdd ${effect[0]} Shiv${pl(effect[0])} to Hand\nAt the Start\nof That Turn`; break
            case 5059: string+=`Take Another Turn\nAll Enemies\nTake Another Turn\nAfterward`; break
            case 5060: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nCosts 0\nIf You are Hit`; break
            case 5061: string+=`Lose ${effect[0]} Health`; break
            case 5062: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nIf You Have a\nShiv in Your Hand`; break
            case 5063: string+=`Draw ${effect[0]} Card${pl(effect[0])}\nCenter of Hand:\nGain ${effect[1]} Energy`; break
            case 5064: string+=`Draw ${effect[0]} Card${pl(effect[0])}\nCenter of Hand:\nGain (W) (W)`; break
            case 5065: string+=`Draw ${effect[0]} Card${pl(effect[0])}\nCenter of Hand:\nGain (W) (W) (W)`; break
            case 5066: string+=`Draw ${effect[0]} Card${pl(effect[0])}\nCenter of Hand:\nGain (W) (W) (W) (W)`; break
            ...
            case 5074: string+=`Gain ${effect[0]} Energy\nUpgrades Repeatedly\nby ${effect[1]}`; break
            case 5075: string+=`Gain ${effect[0]} (E)\nUpgrades Repeatedly\nby ${effect[1]}`; break
            ...
            case 5080: string+=`Add ${effect[0]} Strike${pl(effect[0])}\nof Equivalent Level\nto Hand and Retain\n${effect[0]===1?`it`:`Them`} Until Played`; break
            case 5081: string+=`Push 1 Tile\nTarget Takes ${effect[0]}\nDamage Per Card\nPlayed This Turn`; break
            case 5082: string+=`Target Takes ${effect[0]}\nDamage Per Card\nPlayed This Turn\nGain ${effect[1]} History`; break
            ...
            case 5086: string+=`Apply ${effect[0]} Bleed\nto All Damaged Enemies`; break
            ...
            case 5090: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nAmplify: (N)\nApply ${effect[1]} Weak\nApply ${effect[2]} Vulnerable`; break
            case 5091: string+=`Draw ${effect[0]} Rare Card${pl(effect[0])}\nDiscard ${effect[1]} Random Card${pl(effect[1])}`; break
            case 5092: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nCenter of Hand:\nGain ${effect[1]} Currency`; break
            case 5093: string+=`All Other Cards in\nHand are Attacks:\nAdd ${this.calculateEffect(effect[0],1)} Block`; break
            case 5094: string+=`Each Turn,\nRetain ${effect[0]} Card${pl(effect[0])} Once`; break
            case 5095: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nIf Played First,\nUpgrade ${effect[1]} Random Card${pl(effect[1])}`; break
            case 5096: string+=`Gain ${effect[0]} Dodge\nRetain ${effect[1]} Card${pl(effect[1])} Once`; break
            case 5097: string+=`Gain ${effect[0]} Dodge\nApply ${effect[1]} Lock On`; break
            case 5098: string+=`Gain ${effect[0]} Buffer\nAdd ${effect[1]} Miracle${pl(effect[1])}\nto Hand`; break
            case 5099: string+=`Add ${this.calculateEffect(effect[0],1)}+${this.calculateEffect(effect[1],16)} Block\nWhere X = Number of\nShivs in Hand`; break
            case 5100: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nAdd ${this.calculateEffect(effect[1],1)} Block\nScry ${effect[2]}`; break
            case 5101: string+=`When You Dodge\nan Attack,\nDeal ${effect[0]} Splash Damage`; break
            case 5102: string+=`Even Turn:\nDeal ${this.calculateEffect(effect[0],0)} Damage\nPush 1 Tile\nin All Directions`; break
            case 5103: string+=`Gain ${effect[0]} Buffer\nCosts 1 More`; break
            case 5104: string+=`Gain ${effect[0]} Buffer\nDraw ${effect[1]} Card${pl(effect[1])}\nCosts 1 More`; break
            case 5105: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nCosts 1 Less\nWhen You Take Damage`; break
            case 5106: string+=`Remove a\nRandom Debuff\nDraw ${effect[0]} Card${pl(effect[0])}`; break
            case 5107: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nWhen Discarded From\nYour Hand,\nGain an Item\nand Exhaust`; break
            case 5108: string+=`Trigger Target's Freeze`; break
            case 5109: string+=`Trigger Target's Freeze\nDraw ${effect[0]} Card${pl(effect[0])}`; break
            case 5110: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nDeal ${this.calculateEffect(effect[1],0)} Splash Damage\nNext Turn`; break
            case 5111: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\n2 Times\nOverdrive ${effect[1]}:\n3 Times Instead`; break
            case 5112: string+=`Pull Target Until Adjacent\nTarget Will Face User\nGain ${effect[0]} Random\nTemporary Item${pl(effect[0])}`; break
            case 5113: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nIf Something is Ahead,\nApply ${effect[1]} Lock On`; break
            case 5114: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nand Apply ${effect[1]} Bleed\n2 Times\nIgnore Block`; break
            case 5115: string+=`Apply ${effect[0]} Freeze\nGain ${effect[1]} Armor`; break
            case 5116: string+=`Strikes Apply ${effect[0]} Lock On\nAdd ${effect[1]} Strike${pl(effect[1])}\nof Equivalent Level\nto Hand`; break
            case 5117: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nApply ${effect[1]} Lock On`; break
            case 5118: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nAll Enemies\nTake ${effect[1]} Damage Per\nCard Played This Turn`; break
            case 5119: string+=`Attacks This Turn\nDeal ${effect[0]} More Damage\nIncrease All Block\nAdded This Turn by ${effect[1]}`; break
            case 5120: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nDraw ${effect[1]} Card${pl(effect[1])}\nGain ${effect[2]} Energy`; break
            case 5121: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nDraw ${effect[1]} Card${pl(effect[1])}\nGain (E) (E) (E) (E) (E)`; break
            case 5122: string+=`You Cannot Take\nMore Than ${effect[0]} Damage\nPer Hit This Turn`; break
            case 5123: string+=`Retain Your Hand\nFor ${effect[0]} Turn${pl(effect[0])}`; break
            case 5124: string+=`Add ${effect[0]} Random\nVanishing Card${pl(effect[0])}\nof Eqiuvalent Level\nto Hand`; break
            case 5125: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nCosts 0 Temporarily\non Stance Change`; break
            case 5126: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nAdd ${this.calculateEffect(effect[1],1)} Block\nIf You Have No Block`; break
            case 5127: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nDraw ${effect[1]} Fatigue${pl(effect[1])}`; break
            case 5128: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nHeal ${this.calculateEffect(effect[1],4)} Health`; break
            case 5129: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nUpgrade ${effect[1]} Random\nMovement${pl(effect[1])} in Hand`; break
            case 5130: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nDraw ${effect[1]} Colorless Card${pl(effect[1])}`; break
            case 5131: string+=`Put a Card in\nAlly's Discard Pile\nin Your Hand`; break
            case 5132: string+=`Put a Card in\nAlly's Draw Pile\nin Your Hand`; break
            case 5133: string+=`Ally Gains ${effect[0]} Dexterity`; break
            case 5134: string+=`Ally Takes Another Turn\nAfter Their Turn`; break
            case 5135: string+=`Ally Gains ${effect[0]} Currency`; break
            case 5136: string+=`Ally Upgrades ${effect[0]} Card${pl(effect[0])}\non Their Turn`; break
            case 5137: string+=`Ally Removes a Card\nPermanently`; break
            case 5138: string+=`Next ${effect[0]!=1?`${effect[0]} `:``}Attack${pl(effect[0])}\nof Ally Deal${effect[0]==1?`s`:``}\nDouble Damage`; break
            case 5139: string+=`Choose and Add Any\nCharacter or Colorless\nCard of Equivalent\nLevel to Ally's Hand`; break
            case 5140: string+=`Ally Gains ${effect[0]} Base\nEnergy This Combat`; break
            case 5141: string+=`Ally Gains (E) at the\nStart of Their Turn`; break
            case 5142: string+=`Ally Gains ${effect[0]}\nTemporary Strength\nAlly Gains ${effect[1]}\nTemporary Dexterity`; break
            ...
            case 5166: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nTargets a Random\nAdjacent Enemy\nCosts 1 Less`; break
            ...
            case 5298: string+=`Discard Your Hand\nAdd ${effect[0]} Miracle${pl(effect[0])}\nto Hand`; break
            case 5299: string+=`Discard Your Hand\nAdd ${effect[0]} Occult${pl(effect[0])}\nto Hand`; break
            ...
            case 5338: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nPush 1 Tile`; break
            case 5339: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nPush 1 Tile\nin Both Directions`; break
            case 5340: string+=`Push 2 Tiles\nAround Right`; break
            case 5341: string+=`Push 2 Tiles\nAround Left`; break
            case 5342: string+=`Push to End`; break
            case 5343: string+=`Push 1 Tile\nto All Enemies`; break
            case 5344: string+=`Rotate Target Left`; break
            case 5345: string+=`Rotate Target Right`; break
            case 5346: string+=`Rotate Target Hard Left`; break
            case 5347: string+=`Rotate Target Hard Right`; break
            case 5348: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nPush 1 Tile\nAdvance`; break
            case 5349: string+=`Push 1 Tile\nIf Target is Unmoved,\nPush Again`; break
            case 5350: string+=`Push 1 Tile\nCan Push 2 Targets`; break
            case 5351: string+=`Push 1 Tile\nGain ${effect[0]} Strength`; break
            case 5352: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nPush 1 Tile\nTarget Will Face Away`; break
            case 5353: string+=`Push 1 Tile\nTarget Will Face Away`; break
            case 5354: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nPush 1 Tile\nRandomize Target Intent`; break
            case 5355: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nRotate Target Randomly\nLeft or Right\n75%: Gain ${effect[1]} Energy`; break
            case 5356: string+=`Push 1 Tile\nYou Cannot be Pushed\nThis Turn`; break
            case 5357: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nPush 1 Tile\nDiscard ${effect[1]} Card${pl(effect[1])}`; break
            case 5358: string+=`Push to Edge\nto All Enemies`; break
            case 5359: string+=`Push 1 Tile\nRearm From Target Tile`; break
            case 5360: string+=`Push 1 Tile\nWhen Drawn,\nMake ${effect[0]} Cop${effect[0]!=1?`ies`:`y`}`; break
            case 5361: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nPush 1 Tile\nWhen Drawn,\nMake ${effect[1]} Cop${effect[1]!=1?`ies`:`y`}`; break
            case 5362: string+=`Push 1 Tile\nElemental Form:\nIn All Directions`; break
            case 5363: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nPush 2 Tiles\nAdvance`; break
            case 5364: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nPull 1 Tile at Range 2+`; break
            case 5365: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nPush 1 Tile\nin a Random Direction`; break
            case 5366: string+=`Push 1 Tile\nin 3 Directions`; break
            case 5367: string+=`Push 1 Tile\nGain ${effect[0]} Dexterity`; break
            case 5368: string+=`Push 1 Tile\nAdd a Pristine to Hand`; break
            case 5369: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nPush 1 Tile\nAdd a Pristine to Hand`; break
            case 5370: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nPush 1 Tile\nAdd a Pristine or\nan Occult to Hand`; break
            case 5371: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nRotate Target Randomly\nLeft or Right\n75%: Gain (N) (N)`; break
            case 5372: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nPush 1 Tile\nCosts 1 Less Temporarily\nWhen You Play\na Movement`; break
            case 5373: string+=`Add ${effect[0]} Shiv${pl(effect[0])} to Hand\nDraw ${effect[1]} Card${pl(effect[1])}`; break
            ...
            case 5382: string+=`Draw ${effect[0]} Foil Card${pl(effect[0])}`; break
            case 5383: string+=`Shuffle ${effect[0]} Foil Miracle${pl(effect[0])}\ninto Draw Pile`; break
            case 5384: string+=`-1: Play ${effect[0]} Foil Card${pl(effect[0])}\nin a Single Turn\nActive: Next Card Played\nis Free`; break
            case 5385: string+=`-1: Play ${effect[0]} Foil Card${pl(effect[0])}\nin a Single Turn\nActive: Next Card Played\nis Free\nDraw ${effect[1]} Card${pl(effect[1])}`; break
            case 5386: string+=`Deal ${this.calculateEffect(effect[0],0)}+${this.calculateEffect(effect[1],11)} Damage\nWhere X = Number of\nFoil Cards in Hand`; break
            case 5387: string+=`Add ${this.calculateEffect(effect[0],1)}+${this.calculateEffect(effect[1],16)} Block\nWhere X = Number of\nFoil Cards in Hand`; break
            case 5388: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nin All Directions\nCosts 0 When an\nErratic Card\nis Played`; break
            case 5389: string+=`Draw ${effect[0]} Foil Card${pl(effect[0])}\n${effect[0]!=1?`They Cost`:`It Costs`} 1 Less`; break
            case 5390: string+=`${effect[0]} Random Card${pl(effect[0])} in Hand\nBecome Foil`; break
            case 5391: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nIf You Have a\nFoil Card in Hand,\nAdd ${this.calculateEffect(effect[1],1)} Block`; break
            case 5392: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nApply ${effect[1]} Weak\n${effect[2]} Random Card${pl(effect[2])} in Hand\nBecome Foil`; break
            case 5393: string+=`Draw ${effect[0]} Card${pl(effect[0])}\nAdd a Pristine to Hand`; break
            ...
            case 5402: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nHeal Equal to\nTarget's Health Lost`; break
            case 5403: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nApply ${effect[1]} Vulnerable\nto a Random Enemy`; break
            case 5405: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nAdd ${this.calculateEffect(effect[1],1)} Block\nNext Turn`; break
            case 5406: string+=`Gain ${effect[0]} Base\nEnergy This Combat\nCosts 1 Less Permanently`; break
            case 5407: string+=`Gain (E) at the\nStart of Your Turn\nCosts 1 Less Permanently`; break
            case 5408: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nGain ${effect[1]} Armor\nGain ${effect[2]} Vulnerable`; break
            case 5409: string+=`Gain ${effect[0]} Dexterity\nGain ${effect[1]} Frail`; break
            case 5410: string+=`Draw ${effect[0]} Card${pl(effect[0])}\nDraw ${effect[1]} More Card${pl(effect[1])} if\nOnly 1 Enemy is Alive`; break
            case 5411: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nGain ${effect[1]} Chocolate Chip`; break
            case 5412: string+=`Gain ${effect[0]} Chocolate Chip`; break
            case 5413: string+=`Gain ${effect[0]} Chocolate Chip\nShuffle ${effect[1]} Foil Tile${pl(effect[1])}\ninto Draw Pile`; break
            case 5414: string+=`Heal ${this.calculateEffect(effect[0],4)} Health\nAdd ${effect[1]} Shiv${pl(effect[1])} to Hand`; break
            case 5415: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nLose ${effect[1]} Health\nAdd ${effect[2]} Shiv${pl(effect[2])} to Hand`; break
            case 5416: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\n3 Times\nApply ${effect[1]} Lock On`; break
            case 5417: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nProgress a Random\nQuest in Hand by ${effect[1]}`; break
            case 5418: string+=`Deal ${this.calculateEffect(effect[0],2)} Damage\nWhen Vanished,\nChoose a Rare Card\nof Equivalent Level\nto Add Permanently`; break
            case 5419: string+=`Apply ${effect[0]} Lock On\nAnd ${effect[1]} Weak\nin All Directions`; break
            case 5420: string+=`Apply ${effect[0]} Lock On\nDraw ${effect[1]} Card${pl(effect[1])}`; break
            case 5421: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nBecomes Foil on Play`; break
            case 5422: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nBecomes Foil on Play`; break
            case 5423: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nBecomes Foil on Play`; break
            case 5424: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nAll Enemies Lose\nHealth Equal to\nTheir Lock On`; break
            case 5425: string+=`Shuffle ${effect[0]} Foil Tile${pl(effect[0])}\ninto Draw Pile\nPut a Card in Draw\nPile in Your Hand`; break
            case 5426: string+=`Heal ${this.calculateEffect(effect[0],4)} Health\nUpgrade ${effect[1]} Random Card${pl(effect[1])}`; break
            case 5427: string+=`Apply ${effect[0]} Freeze\nin All Directions\nDraw ${effect[1]} Card${pl(effect[1])}`; break
            case 5428: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nin All Directions\nGain ${effect[1]} Energy\nEnergy Increases by ${effect[2]}`; break
            case 5429: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nin All Directions\nGain ${effect[1]} (W) (G)\nMana Gain Increases by ${effect[2]}`; break
            case 5430: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nGain ${effect[1]} Energy\nEnergy Increases by ${effect[2]}`; break
            case 5431: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nin All Directions\nGain ${effect[1]} (W) (G)\nMana Gain Increases by ${effect[2]}`; break
            case 5432: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nProgress a Random\nQuest in Hand by ${effect[1]}`; break
            case 5433: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\n2 Times\nExhaust Any\nNumber of Cards\nAdd a Miracle to Hand\nPer Card Exhausted`; break
            case 5434: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nIf Last Card Played\nWas a Skill,\nDeals Double Damage`; break
            case 5435: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nIf Last Card Played\nWas a Skill,\nApply ${effect[1]} Weak`; break
            case 5436: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nIf Last Card Played\nWas a Skill,\nApply ${effect[1]} Vulnerable`; break
            case 5437: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nIf Last Card Played\nWas a Skill,\nGain ${effect[1]} Energy`; break
            case 5438: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nIf Last Card Played\nWas a Skill,\nGain (B) (N)`; break
            case 5439: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nRetain ${effect[1]} Random\nSkill${pl(effect[1])} in Hand\nUntil Played`; break
            case 5440: string+=`Draw ${effect[0]} Card${pl(effect[0])}\nMake a Card in Draw\nPile Ethereal and\nShuffle ${effect[1]} Cop${effect[1]!=1?`ies`:`y`} of it\ninto Draw Pile`; break
            case 5441: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nIf Last Card Played\nWas a Skill,\nAdds Double Block`; break
            case 5442: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nIf Last Card Played\nWas a Skill,\nGain ${effect[1]} Temporary\nStrength`; break
            case 5443: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nIf Last Card Played\nWas a Skill,\nGain ${effect[1]} Temporary\nDexterity`; break
            case 5444: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nIf Last Card Played\nWas a Skill,\nGain ${effect[1]} Energy`; break
            case 5445: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nIf Last Card Played\nWas a Skill,\nGain (B) (N)`; break
            case 5446: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nRetain ${effect[1]} Random\nSkill${pl(effect[1])} in Hand\nUntil Played`; break
            case 5447: string+=`When Drawn or Created,\nRetains Once`; break
            case 5448: string+=`When Drawn or Created,\nRetains Until Played`; break
            case 5449: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nPulled:\nAdd ${this.calculateEffect(effect[1],1)} Block`; break
            case 5450: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nAdd ${effect[1]} Dark Matter${pl(effect[1])}\nto Hand`; break
            case 5451: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nDraw ${effect[1]} Card${pl(effect[1])}\nExhaust ${effect[2]} Random Card${pl(effect[2])}`; break
            case 5452: string+=`Put a Card in Draw\nPile in Your Hand\nShuffle ${effect[0]} Dark Matter${pl(effect[0])}\ninto Draw Pile`; break
            case 5453: string+=`Gain ${effect[0]} Buffer\nDraw ${effect[1]} More Card${pl(effect[1])}\nNext Turn`; break
            case 5454: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nWhen Added, Remove a\nCard Permanently`; break
            case 5455: string+=`Draw ${effect[0]} Card${pl(effect[0])}\n${effect[0]!=1?`They Become`:`It Becomes`} Foil`; break
            case 5456: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nDuplicate ${effect[1]} Random\nFoil Card${pl(effect[1])}`; break
            case 5457: string+=`Draw ${effect[0]} Card${pl(effect[0])}\nAdd ${this.calculateEffect(effect[1],1)} Block\nPer Foil Card Drawn`; break
            case 5458: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nIf You Have a\nFoil Card in Hand,\nDraw ${effect[1]} Card${pl(effect[1])}`; break
            case 5459: string+=`Heal ${this.calculateEffect(effect[0],4)} Health\nGain ${effect[1]} Chocolate Chip`; break
            case 5460: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nWhen Added, a\nRandom Card in Deck\nBecomes Foil`; break
            case 5461: string+=`Make a Card Foil\nPermanently`; break
            ...
            case 5469: string+=`When Drawn,\nAdd ${this.calculateEffect(effect[0],1)} Block\nPulled:\nDiscard ${effect[1]} Random Card${pl(effect[1])}`; break
            case 5470: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nin All Directions\nGain ${effect[1]} Energy Per\nCard in Hand With Mass`; break
            case 5471: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nin All Directions\nGain (E) Per Card\nin Hand With Mass`; break
            case 5472: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nApply ${effect[1]} Weak\nPulled:\nCounter ${effect[2]} All`; break
            case 5473: string+=`Gain ${effect[0]} Energy\nPulled:\nDraw ${effect[1]} Card${pl(effect[1])}`; break
            case 5474: string+=`Gain (E) (E)\nPulled:\nDraw ${effect[0]} Card${pl(effect[0])}`; break
            case 5475: string+=`Gain (E) (E) (E)\nPulled:\nDraw ${effect[0]} Card${pl(effect[0])}`; break
            case 5476: string+=`Gain (E) (E) (E) (E)\nPulled:\nDraw ${effect[0]} Card${pl(effect[0])}`; break
            case 5477: string+=`Exhaust Your Hand\nAdd ${effect[0]} Dark Matter${pl(effect[0])}\nto Hand and\nDeal ${effect[1]} Damage to\na Random Enemy Each`; break
            case 5478: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nin All Directions\nDiscard ${effect[1]}\nRandom Card${pl(effect[1])}\nIf a Card With Mass\nWas Pulled, Repeat`; break
            case 5479: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nDraw ${effect[1]} Card${pl(effect[1])}\nFor Each Card\nWith Mass Drawn,\nDeals ${this.calculateEffect(effect[2],10)} More Damage`; break
            case 5480: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nDraw ${effect[1]} Card${pl(effect[1])}\nFor Each Card\nWith Mass Drawn,\nDeals ${this.calculateEffect(effect[2],14)} Add Block`; break
            case 5481: string+=`Draw ${effect[0]} Card${pl(effect[0])}\nDiscard ${effect[1]} Random Card${pl(effect[1])}\nGain ${effect[2]} Energy`; break
            case 5482: string+=`Draw ${effect[0]} Card${pl(effect[0])}\nDiscard ${effect[1]} Random Card${pl(effect[1])}\nGain (K)`; break
            case 5483: string+=`Draw ${effect[0]} Card${pl(effect[0])}\nExhaust ${effect[1]} Random Card${pl(effect[1])}`; break
            case 5484: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nCounter ${effect[1]} Once\nBoth Increase by ${effect[2]}\nWhen a Card is Played`; break
            case 5485: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\n2 Times\nIncreases by ${effect[1]}\nWhen a Card is Played`; break
            ...
            case 5493: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nIncreases by ${effect[1]}\nWhen Another Countdown\nis Incremented`; break
            case 5494: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nHold ${effect[1]} Crystal Orb${pl(effect[1])}`; break
            case 5495: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nHold ${effect[1]} Dual Orb${pl(effect[1])}`; break
            case 5496: string+=`Add ${effect[0]} Miracle${pl(effect[0])} to Hand\nDraw ${effect[0]} Card${pl(effect[0])}\nExhaust ${effect[2]} Random Card${pl(effect[2])}`; break
            case 5497: string+=`Add ${effect[0]} Occult${pl(effect[0])} to Hand\nDraw ${effect[0]} Card${pl(effect[0])}\nExhaust ${effect[2]} Random Card${pl(effect[2])}`; break
            case 5498: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nPlayed Above 1 ${variants.mtg?`Neutral `:``}Cost:\nHalves Block and\nCosts 1 Less`; break
            case 5499: string+=`When You Pull\na Card With Mass,\nDeal ${effect[0]} Damage\nto a Random Enemy`; break
            case 5500: string+=`When Drawn,\nExhaust ${effect[0]} Random Card${pl(effect[0])}\nGain ${effect[1]} Strength`; break
            case 5501: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nUpgrade ${effect[1]} Random\nCard${pl(effect[1])} in Hand\nDeals ${this.calculateEffect(effect[2],10)} More Damage\nPer Card With\nMass Pulled`; break
            case 5502: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nPulled:\nPut a Copy of This\nCard in Your Hand`; break
            case 5503: string+=`Gain ${effect[0]} Energy\nDraw ${effect[1]} Card${pl(effect[1])}\nAdd a Quiet\nMoonlight to Discard Pile`; break
            case 5504: string+=`Gain ${effect[0]} Energy\nDraw ${effect[1]} Card${pl(effect[1])}\nAdd a Refracted\nSunlight to Discard Pile`; break
            case 5505: string+=`Gain ${effect[0]} Energy\nDraw ${effect[1]} Card${pl(effect[1])}\nAdd a Glamorous\nStarlight to Discard Pile`; break
            case 5506: string+=`Gain (E) (E)\nDraw ${effect[0]} Card${pl(effect[0])}\nAdd a Quiet\nMoonlight to Discard Pile`; break
            case 5507: string+=`Gain (E) (E) (E)\nDraw ${effect[0]} Card${pl(effect[0])}\nAdd a Quiet\nMoonlight to Discard Pile`; break
            case 5508: string+=`Gain (E) (E)\nDraw ${effect[0]} Card${pl(effect[0])}\nAdd a Refracted\nSunlight to Discard Pile`; break
            case 5509: string+=`Gain (E) (E) (E)\nDraw ${effect[0]} Card${pl(effect[0])}\nAdd a Refracted\nSunlight to Discard Pile`; break
            case 5510: string+=`Gain (E) (E)\nDraw ${effect[0]} Card${pl(effect[0])}\nAdd a Glamorous\nStarlight to Discard Pile`; break
            case 5511: string+=`Gain (E) (E) (E)\nDraw ${effect[0]} Card${pl(effect[0])}\nAdd a Glamorous\nStarlight to Discard Pile`; break
            case 5512: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nIf Last Card Played\nWas a Skill,\nDraw ${effect[1]} Card${pl(effect[1])}`; break
            case 5513: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nIf Last Card Played\nWas a Skill,\nDraw ${effect[1]} Card${pl(effect[1])}`; break
            case 5514: string+=`Put ${effect[0]} Random Card${pl(effect[0])}\nFrom Draw Pile\nin Your Hand\nReturn ${effect[1]} Random Card${pl(effect[1])}\nFrom Discard Pile\nto Hand`; break
            case 5515: string+=`Draw ${effect[0]} More Card${pl(effect[0])} and\nExhaust ${effect[1]} Random Card${pl(effect[1])}\nEach Turn`; break
            case 5516: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nin All Directions\n4 Times\nWhen Retained,\nDecreases by ${effect[1]}`; break
            case 5517: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nCounts as a Shiv`; break
            case 5518: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nApply ${effect[1]} Weak\nCounts as a Shiv`; break
            case 5519: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nRepeats For Each Card\nExhausted This Turn`; break
            case 5520: string+=`Deal ${this.calculateEffect(effect[0],2)} Damage\nin All Directions\nExhaust ${effect[1]!=1?`${effect[1]}`:``}X Cards`; break
            case 5521: string+=`Add ${effect[0]} Random\nAttack${pl(effect[0])} to Hand\n${effect[0]!=1?`They Cost`:`It Costs`} 0 Temporarily\nAdd ${effect[0]} Random\nDefense${pl(effect[1])} to Hand\n${effect[1]!=1?`They Cost`:`It Costs`} 0 Temporarily\nAdd ${effect[2]} Dark Matter${pl(effect[2])}\nto Hand`; break
            case 5522: string+=`Add ${effect[0]} Random\nAttack${pl(effect[0])} to Hand\n${effect[0]!=1?`They Cost`:`It Costs`} 0\nAdd ${effect[0]} Random\nDefense${pl(effect[1])} to Hand\n${effect[1]!=1?`They Cost`:`It Costs`} 0\nAdd ${effect[2]} Dark Matter${pl(effect[2])}\nto Hand`; break
            case 5523: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nIf Last Card Played\nWas a Skill,\nGain ${effect[1]} Energy`; break
            case 5524: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nIf Last Card Played\nWas a Skill,\nGain (B) (N)`; break
            case 5525: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nRetain ${effect[1]} Random\nSkill${pl(effect[1])} in Hand\nUntil Played`; break
            case 5526: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nIn a Random Direction\nDraw ${effect[1]} Card${pl(effect[1])}`; break
            case 5527: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nDraw ${effect[1]} Card${pl(effect[1])}\nExhaust ${effect[2]} Random Card${pl(effect[2])}`; break
            case 5528: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nAdd ${effect[1]} Dark Matter${pl(effect[1])}\nto Hand`; break
            case 5529: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nDraw ${effect[1]} Quest${pl(effect[1])}`; break
            case 5530: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nDraw ${effect[1]} Wish${pl(effect[1])}`; break
            case 5531: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nDraw ${effect[1]} Unplayable Card${pl(effect[1])}`; break
            case 5532: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nDraw ${effect[1]} Card${pl(effect[1])}\nExhaust ${effect[2]} Random Card${pl(effect[2])}`; break
            case 5533: string+=`-1: Exhaust a Card\nActive: Gain ${effect[0]}\nTemporary Strength`; break
            ...
            case 5541: string+=`Draw ${effect[0]} Card${pl(effect[0])}\nDraw ${effect[1]} Less Card${pl(effect[1])}\nNext Turn`; break
            case 5542: string+=`Exhaust ${effect[0]} Card${pl(effect[0])}\nHold ${effect[1]} Light Orb${pl(effect[1])}`; break
            case 5543: string+=`+1: Deal ${this.calculateEffect(effect[0],0)} Damage\nin All Directions\nExhaust ${effect[1]} Card${pl(effect[1])}\n-3: Exhaust Discard Pile\nDeal ${this.calculateEffect(effect[2],0)} Damage\nin All Directions Each\n-6: Exhaust Your Hand\nDraw ${effect[3]} Card${pl(effect[3])} and\nGain ${effect[4]} Energy Each`; break
                case -1064: string+=`-3: Exhaust Discard Pile\nDeal ${this.calculateEffect(effect[2],0)} Damage\nin All Directions Each`; break
                case -1065: string+=`-6: Exhaust Your Hand\nDraw ${effect[3]} Card${pl(effect[3])} and\nGain ${effect[4]} Energy Each`; break
            case 5544: string+=`+1: Deal ${this.calculateEffect(effect[0],0)} Damage\nin All Directions\nExhaust ${effect[1]} Card${pl(effect[1])}\n-3: Exhaust Discard Pile\nDeal ${this.calculateEffect(effect[2],0)} Damage\nin All Directions Each\n-6: Exhaust Your Hand\nDraw ${effect[3]} Card${pl(effect[3])} and\nGain (E) Each`; break
                case -1066: string+=`-6: Exhaust Your Hand\nDraw ${effect[3]} Card${pl(effect[3])} and\nGain (E) Each`; break
            case 5545: string+=`Draw ${effect[0]} Skill${pl(effect[0])} and\nRetain ${effect[0]!=1?`Them`:`It`} Until Played`; break
            case 5546: string+=`Draw ${effect[0]!=1?`${effect[0]}`:``}X${effect[1]>0?`+${effect[1]}`:``} Cards\nUpgrade ${effect[2]!=1?`${effect[2]}`:``}X${effect[3]>0?`+${effect[3]}`:``} Cards`; break
            case 5547: string+=`Draw ${effect[0]!=1?`${effect[0]}`:``}X${effect[1]>0?`+${effect[1]}`:``} Cards\nUpgrade ${effect[2]} Card${pl(effect[2])}`; break
            case 5548: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\n2 Times\nPulled:\nApply ${effect[1]} Vulnerable\nin All Directions`; break
            case 5549: string+=`Draw ${effect[0]} Card${pl(effect[0])}\nRandomly Swap the Costs\nof Every Card in Hand`; break
            case 5550: string+=`Draw ${effect[0]} Card${pl(effect[0])}\nGain (E) (E) (E)\nRandomly Swap the Costs\nof Every Card in Hand`; break
            case 5551: string+=`Apply ${effect[0]} Weak and Frail\nApplies Double if\nAnother Enemy is\nAdjacent to Target`; break
            case 5552: string+=`Take Another Turn\nGain ${effect[0]} Energy\non That Turn\nAll Cards Cost\n${effect[1]} More on That Turn\nCosts 1 Less\nWhen a Card is Played`; break
            case 5553: string+=`Take Another Turn\nGain (E)\non That Turn\nAll Cards Cost\n${effect[0]} More on That Turn\nCosts 1 Less\nWhen a Card is Played`; break
            case 5554: string+=`Take Another Turn\nGain (E) (E)\non That Turn\nAll Cards Cost\n${effect[0]} More on That Turn\nCosts 1 Less\nWhen a Card is Played`; break
            ...
            case 5562: string+=`Deal ${this.calculateEffect(effect[0],0)} Splash Damage\nExhaust ${effect[1]} Random Card${pl(effect[1])}`; break
            case 5563: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nWhen Retained,\nCounter ${effect[1]} All`; break
            case 5564: string+=`Pull Target Until Adjacent\nTarget Will Face User\nPulled:\nAdd a Stride to Hand`; break
            case 5565: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nProgress a Random\nQuest in Hand by ${effect[1]}`; break
            case 5566: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nDraw ${effect[1]!=1?`${effect[1]}`:``}X${effect[2]>0?`+${effect[2]}`:``} Cards`; break
            case 5567: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nPut a Card in Discard\nPile in Your Hand`; break
            case 5568: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nPut a Card in Draw\nPile in Your Hand`; break
            case 5569: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nDiscard the Leftmost\nCard in Hand`; break
            case 5570: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nApply ${effect[1]} Vulnerable\nto a Random Enemy`; break
            case 5571: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nAdd ${this.calculateEffect(effect[1],1)} Block\nRetain Block\nFor ${effect[2]} Turn${pl(effect[2])}`; break
            case 5572: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nAdd ${this.calculateEffect(effect[1],1)} Block Next Turn\nGain ${effect[2]} Energy Next Turn`; break
            case 5573: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nAdd ${this.calculateEffect(effect[1],1)} Block Next Turn\nGain (G) (N) Next Turn`; break
            case 5574: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nDuplicate ${effect[1]} Random Card${pl(effect[1])}`; break
            case 5575: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nCosts 0 Temporarily\nWhen an X Cost\nCard is Played`; break
            case 5576: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nChoose a 2 ${variants.mtg?`Total\nCost Card to\n`:`Cost Card\nto `}Add to Hand`; break
            case 5577: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nChoose a 3 ${variants.mtg?`Total\nCost Card to\n`:`Cost Card\nto `}Add to Hand`; break
            case 5578: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nGain ${effect[1]} Energy if\nOnly 1 Enemy is Alive`; break
            case 5579: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nGain (R) (N) if Only\n1 Enemy is Alive`; break
            case 5580: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nIf Last Card Played\nWas a Skill,\nDraw ${effect[1]} Card${pl(effect[1])}`; break
            case 5581: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nDiscard the Card\nto the Right`; break
            case 5582: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nUpgrade the Rightmost\nCard in Hand`; break
            case 5583: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nChoose a Skill\nto Add to Hand`; break
            case 5584: string+=`Move ${effect[0]} Tile${pl(effect[0])}\nDraw ${effect[1]} Card${pl(effect[1])}\nAdd a Refracted\nSunlight to Discard Pile`; break
            
            //mark p

            case 5585: string+=`When an Enemy Gains\nFreeze on Your Turn,\nThey Gain ${effect[0]} Vulnerable`; break
            case 5586: string+=`Apply ${effect[0]} Freeze\nin All Directions\nWhen You Gain ${variants.mtg?`Mana`:`Energy`}\nDuring Your Turn`; break
            //3521
            case 5587: string+=`Draw ${effect[0]} Skill${pl(effect[0])}\nEvery Turn`; break
            case 5588: string+=`When You Play a Quest,\nProgress Another Random\nQuest in Hand by ${effect[0]}`; break
            //3543
            case 5589: string+=`When You Play a Tile,\nDraw ${effect[0]} Card${pl(effect[0])}`; break
            case 5590: string+=`Draw ${effect[0]} Movement${pl(effect[0])}\nEvery Turn`; break
            
            case 5591: string+=`Shuffle ${effect[0]} Foil Tile${pl(effect[0])}\ninto Draw Pile\nDraw ${effect[1]} Card${pl(effect[1])}`; break
            case 5592: string+=`-1: Play ${effect[0]} Movement${pl(effect[0])}\nin a Single Turn\nActive: Heal ${this.calculateEffect(effect[1],4)} Health`; break
            //5307
            case 5593: string+=`-1: Play a Power\nActive: Gain an Item`; break
            case 5594: string+=`-1: Play a Power\nActive: Gain an Item\nDraw ${effect[0]} Card${pl(effect[0])}`; break
            //5317
            case 5595: string+=`Gain ${effect[0]} Currency\nGain ${effect[1]} Chocolate Chip`; break
            case 5596: string+=`Shuffle ${effect[0]} Dark Matter${pl(effect[0])}\ninto Draw Pile\nEvery Turn`; break
            case 5597: string+=`Shuffle Discard into Draw\nDraw ${effect[0]} Card${pl(effect[0])}\nPulls Affected Cards\nWith Mass`; break

            case 5598: string+=`Apply ${effect[0]} Weak\nApply ${effect[1]} Vulnerable\nDraw ${effect[2]} Card${pl(effect[2])}`; break
            case 5599: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\n2 Times in All Directions\nLose ${effect[1]} Health`; break
            case 5600: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nin All Directions\nDeals Double Damage\nto Targets With Block`; break
            case 5601: string+=`When You Draw\na Dark Matter,\nAdd ${this.calculateEffect(effect[0],1)} Block`; break
            case 5602: string+=`Gain ${effect[0]} Temporary\nStrength\nDiscard ${effect[1]} Random Card${pl(effect[1])}`; break
            case 5603: string+=`Heal ${this.calculateEffect(effect[0],4)} Health\nExhaust ${effect[1]} Random Card${pl(effect[1])}\nFrom Discard Pile`; break

            case 5604: string+=`Add ${effect[0]} Miracle${pl(effect[0])} to Hand\nExhaust a Card\nGain ${variants.mtg?`Mana`:`Energy`} Equal\nto its Cost`; break
            //1423
            case 5605: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nto Any Enemy\nUnupgrade ${effect[1]} Card${pl(effect[1])}`; break
            //2086
            case 5606: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nAdd ${this.calculateEffect(effect[1],1)} Block\nCosts 1 Less`; break
            case 5607: string+=`Gain ${effect[0]} Energy\nDraw ${effect[1]} Card${pl(effect[1])}\nGain ${effect[2]} Temporary\nStrength\nAll Cards Cost ${effect[3]}\nMore This Turn`; break
            case 5608: string+=`Gain (E) (E) (E) (E) (E)\nDraw ${effect[0]} Card${pl(effect[0])}\nGain ${effect[1]} Temporary\nStrength\nAll Cards Cost ${effect[2]}\nMore This Turn`; break
            case 5609: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nGain ${effect[1]} Buffer`; break
            case 5610: string+=`Gain ${effect[0]} Control\nPulled:\nGain ${effect[1]} Buffer`; break
            case 5611: string+=`Gain ${effect[0]} Control\nDraw ${effect[1]} Card${pl(effect[1])}\nPulled:\nGain ${effect[2]} Buffer`; break

            case 5612: string+=`When Retained,\nDeal ${this.calculateEffect(effect[0],0)} Damage\nto a Random Enemy\n${effect[1]} Time${pl(effect[1])} and\nExhaust ${effect[2]} Random Card${pl(effect[2])}\nBoth Increase by ${effect[3]}`; break
            ...
            case 5619: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nReturn a Random Card\nFrom Exhaust Pile to Hand\nDeals Double Damage\nIf it Has Mass`; break
            case 5620: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nOverdrive ${effect[1]}:\nGain ${effect[2]} Control\nOverdrive ${effect[3]}:\nRemove ${effect[4]} Fatigue${pl(effect[4])}`; break
            //92,3485?
            case 5621: string+=`Add ${this.calculateEffect(effect[0],1)} Block\nCounter ${effect[1]} All\nPer Card Played While\nThis Card is in Your hand`; break
            //5540
            case 5622: string+=`When Drawn,\nDeal ${this.calculateEffect(effect[0],0)} Damage\nin All Directions\nPulled:\nDraw ${effect[1]} Card${pl(effect[1])}\nTransform ${effect[2]} Card${pl(effect[2])}`; break
            case 5623: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nPierces Up to 2 Targets\nDraw ${effect[1]} Card${pl(effect[1])}\nPulled:\nGain ${effect[2]} Energy`; break
            case 5624: string+=`Deal ${this.calculateEffect(effect[0],0)} Damage\nPierces Up to 2 Targets\nDraw ${effect[1]} Card${pl(effect[1])}\nPulled:\nGain (B) (G)`; break
            //358
    ...
    played(){
        ...
        switch(this.attack){
            ...
            case 4628: case 4629: case 4630: case 4631: case 4632: case 5164: case 5543: case 5544:
                                ...
                                switch(this.edition){
                                    case 1:
                                        if(this.battle.relicManager.hasRelic(349,this.player)){
                                            this.layer.text(`Silver: -1(${2+2*this.battle.relicManager.active[349][this.player+1]}) Health`,0,this.height/2)
                                        }else{
                                            this.layer.text(`Silver: -1 Health`,0,this.height/2)
                                        }
                                    break
                                    case 2:
                                        if(this.battle.relicManager.hasRelic(349,this.player)){
    ...
    getBasic(cardClass){
        return this.basic&&(this.class==cardClass||cardClass==-1)||this.attack==5045&&(cardClass==1||cardClass==2||cardClass==-1)
    }
    getBasicMultiple(cardClasses){
        return this.basic&&cardClasses.includes(this.class)||this.attack==5045&&(cardClasses.includes(1)||cardClasses.includes(2))
    }
    free(){
        let userCombatant=this.battle.combatantManager.combatants[this.battle.combatantManager.getPlayerCombatantIndex(this.player)]
