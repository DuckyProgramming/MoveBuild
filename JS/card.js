class card{
    ...
    description(attack,effect,spec,target){
        ...
        switch(attack){
            ...
            case 3307: string+=`Exhaust a Card\nFrom Draw\nAdd ${effect[0]} Cop${effect[0]!=1?`ies`:`y`} of\nit to Hand`; break
