function displayStatusSymbol(layer,x,y,type,direction,size,fade){
    ...
    switch(type){
        ...
        case 383:
            ...
            layer.rect(0,0,3,3)
            for(let a=0,la=6;a<la;a++){
                layer.fill([255,255,255,0,0,150][a],[0,150,255,255,150,0][a],[0,0,0,50,255,200][a])
...
function displayIntentSymbol(layer,x,y,type,effect,direction,size,fade,info){
    ...
    if(info){
        switch(type){
            ...
            case 335: case 336: case 340: case 344: case 347: case 350: case 351: case 359:
