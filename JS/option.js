    ...
    display(){
        ...
        switch(this.type){
            case 0:
                ...
                this.layer.noFill()
                this.layer.line(15,-35,60,0)
                this.layer.line(15,-15,15,-35)
                this.layer.line(15,-15,-50,-15)
                this.layer.line(-50,-15,-50,15)
                this.layer.line(15,15,-50,15)
                this.layer.line(15,15,15,35)
                this.layer.line(15,35,60,0)
                this.layer.noStroke()
                this.layer.fill(mergeColor([255,125,0],[50,255,50],this.anim.complete)[0],mergeColor([255,125,0],[50,255,50],this.anim.complete)[1],mergeColor([255,125,0],[50,255,50],this.anim.complete)[2],this.fade)
