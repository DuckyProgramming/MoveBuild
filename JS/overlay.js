        ...
        switch(this.type){
            ...
            case 2:
                ...
                switch(this.args[0]){
                    ...
                    case 23: case 25: case 30: case 41: case 44:
        ...
        switch(this.type){
            ...
            case 2:
                ...
                switch(this.args[0]){
                    ...
                    case 41: case 44: this.args[1]=args[0]; this.args[2]=args[1]; break
                }
            break
            case 3:
                this.cards=[]
                let sublist=[]
                this.taken=0
                if(args[2]==7||args[2]==9||args[2]==10||args[2]==11||args[2]==17){
                    this.options=args[3]
                }else{
                    this.options=3
                }
    ...
    display(){
        ...
        switch(this.type){
            ...
            case 2:
                ...
                switch(this.args[0]){
                    case 0: case 6: case 20: case 22: case 25: case 30: this.layer.text('Not in Actual Order',this.layer.width/2,this.layer.height/2+197.5); break
                }
                this.layer.textSize(20)
                switch(this.args[0]){
                ...
                switch(this.args[0]){
                    case 0: case 6: case 18: case 22: case 25: case 30: this.battle.cardManagers[this.player].reserve.display('overlay',[0,this.page]); break
                    case 1: case 5: case 11: case 19: case 21: case 31: case 34: case 39: case 40: case 42: this.battle.cardManagers[this.player].discard.display('overlay',[1,this.page]); break
                    case 2: case 3: case 4: case 7: case 8: case 10: case 17: case 26: case 27: case 28:
                    ...
                    case 41: case 44: this.battle.cardManagers[this.player].reserve.display('overlay',[6,this.page,this.args[1]]); break
    ...
    update(first){
        ...
        if(this.fade>0){
            switch(this.type){
                ...
                case 2:
                    switch(this.args[0]){
                        case 0: case 6: case 9: case 18: case 22: case 25: case 30:
                        ...
                        break
                        case 20: case 23: case 41: case 44:
                            this.page=0
                        break
                        case 24:
            ...
            switch(this.type){
                ...
                case 2:
                    if(this.args[0]==24){
                        ...
                        this.page<ceil(this.battle.cardManagers[this.player].reserve.cards.length/15)-1&&(this.args[0]==0||this.args[0]==6||this.args[0]==9||this.args[0]==18||this.args[0]==23||this.args[0]==25||this.args[0]==30)||
                        this.page<ceil(this.battle.cardManagers[this.player].discard.cards.length/15)-1&&(this.args[0]==1||this.args[0]==5||this.args[0]==11||this.args[0]==19||this.args[0]==21||this.args[0]==31||this.args[0]==34||this.args[0]==39||this.args[0]==40||this.args[0]==42)||
                    ...
                    switch(this.args[0]){
                            ...
                            for(let a=0,la=this.battle.cardManagers[this.player].deck.cards.length;a<la;a++){
                                ...
                                !(this.args[0]==17&&this.battle.cardManagers[this.player].deck.cards[a].level>=2&&!this.battle.cardManagers[this.player].deck.cards[a].spec.includes(53))){
                                    ...
                                    switch(this.args[0]){
                                        ...
                                        break
                                        case 43:
                                            if(this.battle.cardManagers[this.player].deck.cards[a].cost>0&&!this.battle.cardManagers[this.player].deck.cards[a].additionalSpec.includes(-2)){
                                                this.battle.cardManagers[this.player].deck.cards[a].additionalSpec.push(-2)
                        ...
                        break
                        case 5: case 11: case 19: case 21: case 31: case 34: case 39: case 40: case 42:
                            for(let a=0,la=this.battle.cardManagers[this.player].discard.cards.length;a<la;a++){
                        ...
                        break
                        case 6: case 13: case 14: case 15: case 16: case 18: case 22: case 25: case 30:
                            for(let a=0,la=this.battle.cardManagers[this.player].reserve.cards.length;a<la;a++){
                ...
                case 2:
                    if(this.args[0]==24){
                        ...
                        if(code==LEFT_ARROW&&this.page>0){
                            ...
                            this.page<ceil(this.battle.cardManagers[this.player].reserve.cards.length/15)-1&&(this.args[0]==0||this.args[0]==6||this.args[0]==9||this.args[0]==18||this.args[0]==22||this.args[0]==25||this.args[0]==30)||
                            this.page<ceil(this.battle.cardManagers[this.player].discard.cards.length/15)-1&&(this.args[0]==1||this.args[0]==5||this.args[0]==11||this.args[0]==19||this.args[0]==21||this.args[0]==31||this.args[0]==34||this.args[0]==39||this.args[0]==40||this.args[0]==42)||
                            this.page<ceil(this.battle.cardManagers[this.player].deck.cards.length/15)-1&&(this.args[0]==2||this.args[0]==3||this.args[0]==4||this.args[0]==7||this.args[0]==8||this.args[0]==10||this.args[0]==17||this.args[0]==26||this.args[0]==27||this.args[0]==28||this.args[0]==29||this.args[0]==32||this.args[0]==33||this.args[0]==35||this.args[0]==36||this.args[0]==37||this.args[0]==43)||
                            this.page<ceil(this.battle.cardManagers[this.player].exhaust.cards.length/15)-1&&(this.args[0]==12)||
                            this.page<ceil(this.battle.cardManagers[this.player].reserve.sorted.length/15)-1&&(this.args[0]==13||this.args[0]==14||this.args[0]==15||this.args[0]==16))){
