class overlay{
        ...
        switch(this.type){
            ...
            case 2:
                switch(this.args[0]){
                    ...
                    case 59: case 60: case 62: case 63: case 73: case 74:
                    ...
                    case 68: case 69: case 70: case 72:
            ...
            case 17:
                ...
                for(let a=0,la=2;a<la;a++){
                    ...
                    switch(this.cards[a].attack){
                        ...
                        break
                        case 3082:
                            this.cards[a].attack=[-108,-109][a]
                        break
                        case 3134:
                            this.cards[a].attack=[-110,-111][a]
                        break
                        case 3135:
                        ...
                        break
                        case 3459:
                            this.cards[a].attack=[-131,-132][a]
                        break
                        case 3569:
                            this.cards[a].attack=[-133,-134][a]
                        break
                        case 3584:
                            this.cards[a].attack=[-135,-136][a]
                        break
                        case 3585:
                            this.cards[a].attack=[-137,-138][a]
                        break
                        case 3586:
                            this.cards[a].attack=[-139,-140][a]
                        break
                    }
                }
            break
        ...
        switch(this.type){
            ...
            case 2:
                ...
                switch(this.args[0]){
                    ...
                    case 2: case 3: case 4: case 7: case 8: case 10: case 17: case 26: case 27: case 28:
                    case 29: case 32: case 33: case 35: case 36: case 37: case 38: case 43: case 50: case 51:
                    case 57: case 64: case 65: case 66: case 67: case 68: case 69: case 70: case 72:
                ...
                switch(this.args[0]){
                    case 3: case 17: case 43: this.card.fade=1; this.card.anim.afford=1; this.card.display(); break
                }
            break
            case 3:
                this.layer.fill(160,this.fade*0.8)
    ...
    update(first,firstType){
        this.fade=smoothAnim(this.fade,this.active&&(first==-1||firstType==this.type&&(this.type==1||this.type==16)),0,1,5)
            ...
            switch(this.type){
                ...
                case 2:
                    switch(this.args[0]){
                        ...
                        break
                        case 53: case 54: case 55: case 56: case 61:
                    ...
                    switch(this.args[0]){
                        case 3: case 17: case 43: this.card.size=constrain(smoothAnim(this.card.size,this.card.page==this.page,0,this.fade,5),0,this.fade); break
                    }
                break
                ...
                case 2:
                    if(this.args[0]==24){
                        ...
                        if(pointInsideBox({position:inputs.rel},{position:{x:this.layer.width/2-285,y:this.layer.height/2},width:40,height:40})&&this.page>0){
                            ...
                            this.page<ceil(this.battle.cardManagers[this.player].discard.cards.length/15)-1&&(this.args[0]==1||this.args[0]==5||this.args[0]==11||this.args[0]==19||this.args[0]==21||this.args[0]==31||this.args[0]==34||this.args[0]==39||this.args[0]==40||this.args[0]==42||this.args[0]==46||this.args[0]==52)||
                            this.page<ceil(this.battle.cardManagers[this.player].deck.cards.length/15)-1&&(this.args[0]==2||this.args[0]==3||this.args[0]==4||this.args[0]==7||this.args[0]==8||this.args[0]==10||this.args[0]==17||this.args[0]==26||this.args[0]==27||this.args[0]==28||this.args[0]==29||this.args[0]==32||this.args[0]==33||this.args[0]==35||this.args[0]==36||this.args[0]==37||this.args[0]==38||this.args[0]==43||this.args[0]==50||this.args[0]==51||this.args[0]==57||this.args[0]==64||this.args[0]==65||this.args[0]==66||this.args[0]==67||this.args[0]==68||this.args[0]==69||this.args[0]==70||this.args[0]==72)||
                            ...
                            this.page<ceil(this.args[1]/15)-1&&(this.args[0]==41||this.args[0]==44||this.args[0]==47||this.args[0]==48||this.args[0]==49||this.args[0]==59||this.args[0]==73)
                        )){
                            this.page++
                        }else if(pointInsideBox({position:inputs.rel},{position:{x:this.layer.width/2,y:this.layer.height/2+225},width:120,height:40})){
                            this.active=false
                    ...
                    switch(this.args[0]){
                        ...
                        case 58: case 60: case 62: case 63: case 74:
                            for(let a=0,la=this.battle.cardManagers[this.player].reserve.cards.length;a<la;a++){
                ...
                case 8:
                    ...
                    for(let a=0,la=this.cards.length;a<la;a++){
                        if((int(key)+9)%10==a&&!this.cards[a].deSize){
                            switch(this.args[0]){
                                case 0:
                                    this.battle.cardManagers[this.player].deck.addAbstract(this.cards[a].type,this.cards[a].level,this.cards[a].color,this.cards[a].edition,[1],[])
                                    this.battle.cardManagers[this.player].deck.add(this.cards[a].type,this.cards[a].level,this.cards[a].color,this.cards[a].edition)
                                break
                                case 1:
                                    this.battle.cardManagers[this.player].hand.addAbstract(this.cards[a].type,this.cards[a].level,this.cards[a].color,this.cards[a].edition,[1],[])
                                    this.battle.cardManagers[this.player].hand.add(this.cards[a].type,this.cards[a].level,this.cards[a].color,this.cards[a].edition)
                                break
                            }
                            this.cards[a].deSize=true
