        ...
        switch(this.type){
            case 1:
                ...
                for(let a=0,la=args[1].length;a<la;a++){
                    ...
                    if(this.rewards[this.rewards.length-1].type==2){
                        this.rewards[this.rewards.length-1].relic=new relic(this.layer,this.battle,0,0,0,this.battle.relicManager.makeRelicSelection([[0,0,0,1,1,2][floor(random(0,6))]])[0],0.8)
            ...
            case 2:
                switch(this.args[0]){
                    ...
                    case 59: case 60: case 62: case 63: case 73: case 74: case 80:
                    ...
                    case 68: case 69: case 70: case 72: case 75: case 76: case 78:
            ...
            case 3:
                ...
                if(this.battle.relicManager.active[238][this.player+1]>0&&args[2]>=14&&args[2]<=16&&this.args[0]==0){
                ...
                switch(args[2]){
                    case 0: case 7:
                                ...
                                if(this.args[0]==0&&this.battle.relicManager.hasRelic(315,this.player)&&floor(random(0,30))<this.battle.relicManager.active[315][this.player+1]){
                                    ...
                                    if(variants.colorshift){
                                        ...
                                        if(!variants.ultraprism&&!variants.prism&&!variants.mtg&&!variants.junk){
                                            ...
                                            if(this.battle.cardManagers[this.player].listing.card[type][args[1]].length>0){
                                                let index=floor(random(0,this.battle.cardManagers[this.player].listing.card[type][args[1]].length))
                                                this.battle.cardManagers[this.player].listing.card[this.battle.player[this.player]][args[1]].push(this.battle.cardManagers[this.player].listing.card[type][args[1]][index])
                                                this.battle.cardManagers[this.player].listing.card[type][args[1]].splice(index,1)
                                            }
                                        }
                                    }
                                }
                        ...
                        if(this.args[0]==0&&this.battle.relicManager.hasRelic(172,this.player)){
                            for(let a=0,la=this.battle.relicManager.active[172][this.player+1];a<la;a++){
                                list=variants.ultraprism?copyArrayStack(this.battle.cardManagers[this.player].listing.all):variants.prism?copyArrayStack(this.battle.cardManagers[this.player].listing.allPlayerCard):variants.mtg?copyArrayStack(this.battle.cardManagers[this.player].listing.allPlayerCard):variants.junk?quadroArray(copyArray(this.battle.cardManagers[this.player].listing.junk[game.playerNumber+1])):copyArrayStack(this.battle.cardManagers[this.player].listing.allPlayerCard)
                                if(list[args[1]].length>0){
                    ...
                    break
                    case 16:
                        list=copyArrayStack(this.battle.cardManagers[this.player].listing.card[game.playerNumber+5])
                        for(let a=0,la=this.options;a<la;a++){
                            if(list[args[1]].length>0){
                                let index=floor(random(0,list[args[1]].length))
                                this.cards.push(new card(this.layer,this.battle,this.player,this.layer.width/2+60-la*60+a*120,this.layer.height/2+20,list[args[1]][index],0,game.playerNumber+5,-1))
                                this.cards[this.cards.length-1].upSize=true
                                list[args[1]].splice(index,1)
                            }
                        }
                    ...
                    break
                    case 20:
                        list=copyArrayStack(this.battle.cardManagers[this.player].listing.card[args[3]])
                        for(let a=0,la=this.options;a<la;a++){
                            if(list[args[1]].length>0){
                                let index=floor(random(0,list[args[1]].length))
                    ...
                    case 21:
                        for(let a=0,la=this.options;a<la;a++){
                            this.cards.push(new card(this.layer,this.battle,this.player,this.layer.width/2+60-la*60+a*120,this.layer.height/2+20,findName(['Discus of Fire\nand Water','Discus of Mountain\nand Rain','Discus of Wind\nand Thunder'][a%3],types.card),args[0],0,-1))
                            this.cards[a].upSize=true
                        }
                    break
                    case 22:
                ...
                if(this.cards.length==0){
                    ...
                    switch(args[2]){
                        case 0:
                            ...
                            let total=0
                            for(let a=0,la=list[args[1]].length;a<la;a++){
                                if(types.card[list[args[1]][a]].rarity==this.args[1]||this.args[1]==-1){
                                    ...
                                    tick++
                                    if(types.card[list[args[1]][a]].list!=mark){
                                        mark=types.card[list[args[1]][a]].list
                                        this.marks.push(floor(total/24))
                                    }
                                    total++
                                }
                            }
                            this.marks.push(ceil(this.cards.length/24))
                        break
                    }
                    this.setupArgs=args
                    for(let a=0,la=this.cards.length;a<la;a++){
                ...
                switch(this.args[0]){
                    case 0:
                        ...
                        switch(args[0].attack){
                            ...
                            case -1036:
                                this.card.cost-=6
                                this.battle.cardManagers[this.player].hand.callInput(6,[2951,[args[0].effect[4],args[0].effect[5]],4,[5]])
                            break
                            case -1037:
                                this.card.cost-=2
        ...
        switch(this.type){
            case 1:
                ...
                for(let a=0,la=this.rewards.length;a<la;a++){
                    ...
                    switch(this.rewards[a].type){
                        ...
                        case 11:
                            this.layer.rect(this.layer.width/2+225*this.posKey,this.layer.height/2-105+this.rewards[a].position,120,40,10)
                            this.layer.fill(types.color.card[game.playerNumber+5].fill[0],types.color.card[game.playerNumber+5].fill[1],types.color.card[game.playerNumber+5].fill[2],this.fade*this.rewards[a].fade)
                            this.layer.stroke(types.color.card[game.playerNumber+5].stroke[0],types.color.card[game.playerNumber+5].stroke[1],types.color.card[game.playerNumber+5].stroke[2],this.fade*this.rewards[a].fade)
                            this.layer.strokeWeight(3)
                            this.layer.rect(this.layer.width/2+225*this.posKey-40,this.layer.height/2-105+this.rewards[a].position,24,32,5)
                            this.layer.noStroke()
                            this.layer.fill(types.color.card[game.playerNumber+5].active[0],types.color.card[game.playerNumber+5].active[1],types.color.card[game.playerNumber+5].active[2],this.fade*this.rewards[a].fade)
            ...
            case 2:
                switch(this.args[0]){
                    ...
                    case 4: this.title='Remove a Card'; break
                    ...
                    case 7: this.title='Transform a Card'; break
                    ...
                    case 71: this.title='Put a Removed Card in Deck'; break
                    ...
                    case 78: this.title='Transofmr a card Into Any Random Double Upgraded Card With an Edition'; break
                ...
                switch(this.args[0]){
                    ...
                    case 2: case 3: case 4: case 7: case 8: case 10: case 17: case 26: case 27: case 28:
                    case 29: case 32: case 33: case 35: case 36: case 37: case 38: case 43: case 50: case 51:
                    case 57: case 64: case 65: case 66: case 67: case 68: case 69: case 70: case 72: case 76:
                    case 78:
                    ...
                    case 41: case 44: case 47: case 48: case 49: case 59: case 73: case 80:
                    ...
                    case 71: this.battle.cardManagers[this.player].remove.display('overlay',[1,this.page]); break
                    case 75: this.battle.cardManagers[this.player].deck.display('overlay',[9,this.page,[1,2][this.args[1]]]); break

                }
                switch(this.args[0]){
                    case 3: case 17: case 43: case 75: case 77: this.card.fade=1; this.card.anim.afford=1; this.card.display(); break
                }
            break
            case 3:
                this.layer.fill(160,this.fade*0.8)
                this.layer.rect(this.layer.width/2,this.layer.height/2,this.options*120+(this.setupArgs[2]==0||this.setupArgs[2]==7?this.battle.relicManager.active[172][this.player+1]:0)*120+40,200,10)
            ...
            case 4:
                ...
                this.layer.text(`${tennify(this.battle.stats.block[this.player])} Block Added${this.battle.stats.barrier[this.player]>0?`, ${tennify(this.battle.stats.barrier[this.player])} Barrier Added`:``}`,this.layer.width/2+225*this.posKey,this.layer.height/2)
                ...
                for(let a=0,la=this.colors.length;a<la;a++){
                    ...
                    switch(this.colors[a]){
                        case 0:
                            ...
                            this.layer.rect(-1.5,1.5,7)
                            this.layer.line(-5,-2,-2,-5)
                            this.layer.line(2,-2,5,-5)
                            this.layer.line(2,5,5,2)
                            this.layer.line(5,-5,5,2)
                            this.layer.line(-2,-5,5,-5)
                        break
                        case 1:
                            this.layer.stroke(40,160,40,this.fade)
                            regPoly(this.layer,0,0,6,5,5,30)
                        break
                        case 2:
                            this.layer.stroke(40,100,160,this.fade)
                            this.layer.arc(0,0,8,8,-45,225)
                            this.layer.line(-2*sqrt(2),-2*sqrt(2),0,-4*sqrt(2))
                            this.layer.line(2*sqrt(2),-2*sqrt(2),0,-4*sqrt(2))
                        break
                        case 3:
                            this.layer.stroke(80,20,80,this.fade)
                            this.layer.arc(0,0,10,10,-270,45)
                            this.layer.line(0,0,0,0+5)
                        break
                        case 4:
                            this.layer.stroke(160,160,80,this.fade)
                            this.layer.line(0,-6,0,6)
                            this.layer.line(-3*sqrt(3),-3,3*sqrt(3),3)
                            this.layer.line(-3*sqrt(3),3,3*sqrt(3),-3)
                        break
                        case 5:
        ...
        if(this.fade>0){
            switch(this.type){
                ...
                case 2:
                    ...
                    switch(this.args[0]){
                        case 3: case 17: case 43: case 75: case 77: this.card.size=constrain(smoothAnim(this.card.size,this.card.page==this.page,0,this.fade,5),0,this.fade); break
                    }
                break
                ...
                case 2:
                    if(this.args[0]==24){
                        ...
                        if(pointInsideBox({position:inputs.rel},{position:{x:this.layer.width/2-285,y:this.layer.height/2},width:40,height:40})&&this.page>0){
                            ...
                            this.page<ceil(this.battle.cardManagers[this.player].reserve.cards.length/15)-1&&(this.args[0]==0||this.args[0]==6||this.args[0]==9||this.args[0]==18||this.args[0]==23||this.args[0]==25||this.args[0]==30||this.args[0]==45||this.args[0]==58||this.args[0]==60||this.args[0]==63||this.args[0]==74)||
                            this.page<ceil(this.battle.cardManagers[this.player].discard.cards.length/15)-1&&(this.args[0]==1||this.args[0]==5||this.args[0]==11||this.args[0]==19||this.args[0]==21||this.args[0]==31||this.args[0]==34||this.args[0]==39||this.args[0]==40||this.args[0]==42||this.args[0]==46||this.args[0]==52||this.args[0]==77||this.args[0]==79)||
                            this.page<ceil(this.battle.cardManagers[this.player].deck.cards.length/15)-1&&(this.args[0]==2||this.args[0]==3||this.args[0]==4||this.args[0]==7||this.args[0]==8||this.args[0]==10||this.args[0]==17||this.args[0]==26||this.args[0]==27||this.args[0]==28||this.args[0]==29||this.args[0]==32||this.args[0]==33||this.args[0]==35||this.args[0]==36||this.args[0]==37||this.args[0]==38||this.args[0]==43||this.args[0]==50||this.args[0]==51||this.args[0]==57||this.args[0]==64||this.args[0]==65||this.args[0]==66||this.args[0]==67||this.args[0]==68||this.args[0]==69||this.args[0]==70||this.args[0]==72||this.args[0]==76||this.args[0]==78)||
                            this.page<ceil(this.battle.cardManagers[this.player].exhaust.cards.length/15)-1&&(this.args[0]==12)||
                            this.page<ceil(this.battle.cardManagers[this.player].remove.cards.length/15)-1&&(this.args[0]==71)||
                            this.page<ceil(this.battle.cardManagers[this.player].deck.sorted.length/15)-1&&(this.args[0]==53||this.args[0]==54||this.args[0]==55||this.args[0]==56||this.args[0]==61)||
                            this.page<ceil(this.battle.cardManagers[this.player].reserve.sorted.length/15)-1&&(this.args[0]==13||this.args[0]==14||this.args[0]==15||this.args[0]==16||this.args[0]==62)||
                            this.page<ceil(this.args[1]/15)-1&&(this.args[0]==41||this.args[0]==44||this.args[0]==47||this.args[0]==48||this.args[0]==49||this.args[0]==59||this.args[0]==73||this.args[0]==80)
                        )){
                            this.page++
                        }else if(pointInsideBox({position:inputs.rel},{position:{x:this.layer.width/2,y:this.layer.height/2+225},width:120,height:40})){
                            this.active=false
                    ...
                    switch(this.args[0]){
                        ...
                        case 69: case 70: case 72: case 75: case 76: case 78:
                            for(let a=0,la=this.battle.cardManagers[this.player].deck.cards.length;a<la;a++){
                        ...
                        case 52: case 77: case 79:
                            for(let a=0,la=this.battle.cardManagers[this.player].discard.cards.length;a<la;a++){
                                if(pointInsideBox({position:inputs.rel},this.battle.cardManagers[this.player].discard.cards[a])&&this.battle.cardManagers[this.player].discard.cards[a].size>0.5&&this.battle.cardManagers[this.player].discard.cards[a].select&&
                                    !(this.args[0]==77&&this.battle.cardManagers[this.player].deck.cards[a].spec.includes(37))&&
                                    !(this.args[0]==77&&this.battle.cardManagers[this.player].deck.cards[a].level>=1&&!this.battle.cardManagers[this.player].deck.cards[a].spec.includes(53))
                                ){
                        ...
                        case 58: case 60: case 62: case 63: case 74: case 80:
                            for(let a=0,la=this.battle.cardManagers[this.player].reserve.cards.length;a<la;a++){
                    ...
                    for(let a=0,la=this.cards.length;a<la;a++){
                        if((pointInsideBox({position:inputs.rel},this.cards[a])||this.battle.relicManager.hasRelic(173,this.player)&&pointInsideBox({position:inputs.rel},{position:{x:this.layer.width/2,y:this.layer.height/2+170},width:120,height:40}))&&!this.cards[a].deSize){
                            ...
                            for(let b=0,lb=lists.length;b<lb;b++){
                                ...
                                }else if(this.setupArgs[2]==2||this.setupArgs[2]==4||this.setupArgs[2]==24||this.setupArgs[2]==29||this.setupArgs[2]==33){
                ...
                case 2:
                    if(this.args[0]==24){
                        ...
                        if(code==LEFT_ARROW&&this.page>0){
                            ...
                            this.page<ceil(this.battle.cardManagers[this.player].reserve.cards.length/15)-1&&(this.args[0]==0||this.args[0]==6||this.args[0]==9||this.args[0]==18||this.args[0]==22||this.args[0]==25||this.args[0]==30||this.args[0]==45||this.args[0]==58||this.args[0]==60||this.args[0]==63||this.args[0]==74)||
                            this.page<ceil(this.battle.cardManagers[this.player].discard.cards.length/15)-1&&(this.args[0]==1||this.args[0]==5||this.args[0]==11||this.args[0]==19||this.args[0]==21||this.args[0]==31||this.args[0]==34||this.args[0]==39||this.args[0]==40||this.args[0]==42||this.args[0]==46||this.args[0]==52||this.args[0]==77||this.args[0]==79)||
                            this.page<ceil(this.battle.cardManagers[this.player].deck.cards.length/15)-1&&(this.args[0]==2||this.args[0]==3||this.args[0]==4||this.args[0]==7||this.args[0]==8||this.args[0]==10||this.args[0]==17||this.args[0]==26||this.args[0]==27||this.args[0]==28||this.args[0]==29||this.args[0]==32||this.args[0]==33||this.args[0]==35||this.args[0]==36||this.args[0]==37||this.args[0]==38||this.args[0]==43||this.args[0]==50||this.args[0]==51||this.args[0]==57||this.args[0]==64||this.args[0]==65||this.args[0]==66||this.args[0]==67||this.args[0]==68||this.args[0]==69||this.args[0]==70||this.args[0]==72||this.args[0]==76||this.args[0]==78)||
                            this.page<ceil(this.battle.cardManagers[this.player].exhaust.cards.length/15)-1&&(this.args[0]==12)||
                            this.page<ceil(this.battle.cardManagers[this.player].remove.cards.length/15)-1&&(this.args[0]==71)||
