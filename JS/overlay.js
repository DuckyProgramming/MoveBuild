        ...
        switch(this.type){
            ...
            case 2:
                ...
                switch(this.args[0]){
                    ...
                    break
                    case 2: case 3: case 4: case 7: case 8: case 10: case 17: case 26: case 27:
        ...
        switch(this.type){
            ...
            case 2:
                switch(this.args[0]){
                    ...
                    case 2: case 3: case 4: case 7: case 8: case 10: case 17: case 26: case 27: this.battle.cardManagers[this.player].deck.resetAnim(); break
                ...
                switch(args[2]){
                    case 0: case 7:
                        ...
                        for(let a=0,la=this.options;a<la;a++){
                            ...
                            this.cards.push(new card(this.layer,this.battle,this.player,this.layer.width/2+60-la*60+a*120,this.layer.height/2+20,list[args[1]][index],args[0],variants.ultraprism?(types.card[list[args[1]][index]].list<0?0:types.card[list[args[1]][index]].list>=types.color.card.length?0:types.card[list[args[1]][index]].list):variants.prism?types.card[list[args[1]][index]].list:this.battle.player[this.player],-1))
        ...
        switch(this.type){
            ...
            case 2:
                ...
                switch(this.args[0]){
                    ...
                    case 2: case 3: case 4: case 7: case 8: case 10: case 17: case 26: case 27: this.battle.cardManagers[this.player].deck.display('overlay',[1,this.page]); break
            ...
            switch(this.type){
                ...
                case 2:
                    ...
                    switch(this.args[0]){
                        ...
                        case 2: case 3: case 4: case 7: case 8: case 10: case 17: case 26: case 27: this.battle.cardManagers[this.player].deck.update('overlay',[this.page]); break
            ...
            switch(this.type){
                ...
                case 2:
                    if(this.args[0]==24){
                        ...
                        this.page<ceil(this.battle.cardManagers[this.player].deck.cards.length/15)-1&&(this.args[0]==2||this.args[0]==3||this.args[0]==4||this.args[0]==7||this.args[0]==8||this.args[0]==10||this.args[0]==17||this.args[0]==26||this.args[0]==27)||
                    ...
                    switch(this.args[0]){
                        case 3: case 4: case 7: case 8: case 10: case 17: case 26: case 27:
                            for(let a=0,la=this.battle.cardManagers[this.player].deck.cards.length;a<la;a++){
