        ...
        switch(this.type){
            ...
            case 2:
                switch(this.args[0]){
                    ...
                    case 46: case 52: case 77: case 79: case 99: case 101: case 102:
                    ...
                    case 86: case 87: case 89: case 90: case 91: case 92: case 93: case 98:
        ...
        switch(this.type){
            ...
            case 2:
                switch(this.args[0]){
                    ...
                    case 102: this.title='Put a Card From Discard Pile in Hand, Retain it Until Played, and Make it Cost 0'; break
                ...
                switch(this.args[0]){
                    ...
                    case 63: case 74: case 80: case 94: case 95: case 96: case 100:
                ...
                switch(this.args[0]){
                    ...
                    case 74: case 94: case 95: case 96: case 100:
            ...
            case 27:
                ...
                if(this.common.includes(0)){
                    ...
                    if(this.commonAttributes>0){
                        this.layer.text(`${this.commonAttributes} Common Attributes${pl(this.commonAttributes)}`,this.layer.width/2,this.layer.height/2+ticker*20)
                        ticker++
                    }
                }
                for(let a=0,la=this.suggestions.length;a<la;a++){
            ...
            switch(this.type){
                ...
                case 2:
                    switch(this.args[0]){
                        ...
                        case 63: case 74: case 94: case 95: case 96: case 100:
                        ...
                        case 83: case 86: case 87: case 89: case 90: case 91: case 92: case 93: case 98:
            ...
            switch(this.type){
                ...
                case 2:
                    ...
                    switch(this.args[0]){
                        ...
                        case 87: case 89: case 90: case 91: case 92: case 93: case 98:
                            switch(this.args[0]){
                            ...
                            for(let a=0,la=this.battle.cardManagers[this.player].deck.cards.length;a<la;a++){
                                if(pointInsideBox({position:inputs.rel},this.battle.cardManagers[this.player].deck.cards[a])&&this.battle.cardManagers[this.player].deck.cards[a].size>0.5&&this.battle.cardManagers[this.player].deck.cards[a].select&&
                                    ...
                                    !(this.args[0]==4&&this.args[2]==4&&this.battle.cardManagers[this.player].deck.cards[a].spec.includes(15))&&
                        ...
                        case 52: case 77: case 79: case 99: case 101: case 102:
                            switch(this.args[0]){
                                case 77: case 101:
                                    this.card=new card(this.layer,this.battle,this.player,-100,-100,0,0,variants.mtg?[]:0,0)
                                break
                    ...
                    for(let a=0,la=this.cards.length;a<la;a++){
                        if((pointInsideBox({position:inputs.rel},this.cards[a])||this.battle.relicManager.hasRelic(173,this.player)&&pointInsideBox({position:inputs.rel},{position:{x:this.layer.width/2,y:this.layer.height/2+170+(this.options>=8?75:0)},width:120,height:40}))&&!this.cards[a].deSize){
                            ...
                            for(let b=0,lb=lists.length;b<lb;b++){
                                ...
                                }else if(this.setupArgs[2]==4||this.setupArgs[2]==24||this.setupArgs[2]==29||this.setupArgs[2]==33||(this.setupArgs[2]==2||this.setupArgs[2]==12)&&this.setupArgs[3]==1||this.setupArgs[2]==38||this.setupArgs[2]==44||this.setupArgs[2]==45||this.setupArgs[2]==48||this.setupArgs[2]==51||this.setupArgs[2]==52){
