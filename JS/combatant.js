            ...
            for(let a=0,la=this.battle.combatantManager.combatants.length;a<la;a++){
                if(this.battle.combatantManager.combatants[a].team!=this.team&&type==0||this.battle.combatantManager.combatants[a].id==id&&(type==1||type==2)){
                    switch(this.attack[this.intent].type){
                        ...
                        case 282: case 295: case 304: case 305: case 309: case 341: case 355:
                        ...
                        case 276: case 277: case 297: case 298: case 299: case 310: case 317: case 342: case 343: case 354:
                            for(let b=0,lb=this.targetTile.length;b<lb;b++){
                                if(
                                    this.battle.combatantManager.combatants[a].tilePosition.x==this.targetTile[b].tilePosition.x&&
                                    this.battle.combatantManager.combatants[a].tilePosition.y==this.targetTile[b].tilePosition.y&&
                        ...
                        case 265: case 278: case 288: case 291: case 292: case 308: case 344: case 347: case 350: case 351:
                        case 357:
                            for(let b=0,lb=this.targetTile.length;b<lb;b++){
                                if(
                                    this.battle.combatantManager.combatants[a].tilePosition.x==this.targetTile[b].tilePosition.x&&
                        ...
                        case 335: case 336: case 338: case 340: case 353: case 358:
                            for(let b=0,lb=this.targetTile.length;b<lb;b++){
                                if(
                                    this.battle.combatantManager.combatants[a].tilePosition.x==this.targetTile[b].tilePosition.x&&
                                    this.battle.combatantManager.combatants[a].tilePosition.y==this.targetTile[b].tilePosition.y&&
        ...
        if(this.life>0&&!this.moved&&this.status.main[32]<=0&&this.status.main[51]<=0){
            if(this.attack[this.intent].type==78){
                ...
                switch(this.attack[this.intent].type){
                    ...
                    case 288: case 291: case 292: case 308: case 319: case 330: case 357:
                        for(let b=0,lb=this.targetTile.length;b<lb;b++){
                    ...
                    case 327: case 328: case 336: case 338: case 340: case 343: case 346: case 350: case 351: case 353:
                    case 358:
                        for(let b=0,lb=this.targetTile.length;b<lb;b++){
                            if(
                                this.targetTile[b].tilePosition.x>=0&&
            ...
            default:
                switch(type){
                    case 0: case 2: case 4: case 6:
                        this.animSet.loop=0
                        this.animSet.flip=floor(random(0,2))
                        if((this.name=='Goon'||this.name=='Slaver'||this.name=='Pointy'||this.name=='Romeo'||this.name=='Batter'||this.name=='Swordmaster'||this.name=='Champion'||this.name=='Purge X02'||this.name=='Vengeful'||this.name=='Lunaria'||this.name=='Divine Guard'||this.name=='Avant Guard'||this.name=='Dimension Wanderer')&&(type==2||type==6)){
                            this.animSet.loop=0
                            this.goal.anim.sword=true
                        }
                    break
        ...
        switch(this.name){
            ...
            default:
                switch(type){
                    ...
                    case 2:
                        this.animSet.loop+=rate
                        if(this.name=='Goon'||this.name=='Slaver'||this.name=='Pointy'||this.name=='Romeo'||this.name=='Batter'||this.name=='Swordmaster'||this.name=='Champion'||this.name=='Purge X02'||this.name=='Vengeful'||this.name=='Lunaria'||this.name=='Divine Guard'||this.name=='Avant Guard'||this.name=='Dimension Wanderer'){
