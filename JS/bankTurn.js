    ...
    switch(this.action){
        case 0:
            switch(this.type){
                ...
                case 378: case 385: case 386: case 389: case 390:
                ...
                case 346: case 359: case 365: case 376: case 392:
                    if(variants.nobasicanim){
                        this.selfCall(1)
                        this.remove=true
                    }else{
                ...
                case 249: case 301: case 302: case 352: case 391:
                    if(variants.nobasicanim){
                        this.selfCall(2)
                        this.remove=true
                    }else{
                ...
                case 330: case 368: case 379: case 387: case 388:
                    if(variants.nobasicanim){
                        this.selfCall(3)
                        this.remove=true
                    }else{
