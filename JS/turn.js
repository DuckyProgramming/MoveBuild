                ...
                case 0:
                    if(this.attackClass==2||this.attackClass==4){
                        ...
                        switch(this.type){
                            ...
                            case 36: case 37: case 58: case 97: case 101: case 103:
                        ...
                        }else if(this.type==9||this.type==16||this.type==17||this.type==28||this.type==44||this.type==53||this.type==54||this.type==55||this.type==60||this.type==64||
                            this.type==69||this.type==85||this.type==86||this.type==87||this.type==95||this.type==104||this.type==105){
                ...
                switch(this.type){
                    ...
                    case 79: case 83: case 100:
                        ...
                        if(this.timer==15*this.targetDistance-15){
                            ...
                            }else if(this.type==23||this.type==33){
                    ...
                    break
                    case 20: case 31: case 59: case 66: case 99: case 103: case 107:
                        if(this.timer==1&&this.targetDistance>1){
                            this.userCombatant.startAnimation(0)
                        }else if(this.timer==15*this.targetDistance-14){
                            this.userCombatant.startAnimation(2)
                    ...
                    break
                    case 2: case 19: case 34: case 45: case 76:
                        if(this.timer==1&&this.targetDistance>1){
                            this.userCombatant.startAnimation(0)
                        }else if(this.timer==15*this.targetDistance-14){
                            this.userCombatant.startAnimation(2)
                    ...
                    break
                    case 4: case 10: case 29: case 48: case 65: case 72: case 102: case 108:
                        if(this.timer==1){
                            this.userCombatant.startAnimation(1)
                        }
                        this.userCombatant.runAnimation(1/30,1)
                        if(this.timer==15){
                            if(this.type==10||this.type==65){
                    ...
                    case 75: case 78: case 88: case 92: case 93: case 94:
                        if(this.userCombatant.name=='General Duckion'||this.type!=39&&this.type!=56&&this.type!=74&&this.type!=75&&this.type!=78&&this.type!=92&&this.type!=93&&this.type!=94){
                            if(this.timer==1){
                                this.userCombatant.startAnimation(3)
                            }
                        ...
                        if(this.timer==15){
                            for(let a=0,la=this.targetCombatant.length;a<la;a++){
                                ...
                                switch(this.type){
                                    ...
                                    break
                                    case 84:
                                        this.targeteCombatant[a].statusEffect('Weak',this.effect[1])
                                    break
                                }
                            }
                        }else if(this.timer>=30){
                    ...
                    break
                    case 12: case 50: case 81: case 89:
                        if(this.timer==1){
                        ...
                        if(this.timer==15){
                            ...
                            }else if(this.type==89&&this.targetCombatant.blocked>0){
                                for(let a=0,la=this.effect[1];a<la;a++){
                                    this.battle.drop(this.targetCombatant.id,findName(this.effect[2],types.card),0,game.playerNumber+1)
                                }
                            }
                    ...
                    break
                    case 18: case 25: case 26: case 43: case 46: case 63: case 70:
                        if(this.timer==1){
                    ...
                    case 87:
                        ...
                        for(let a=0,la=this.targetCombatant.length;a<la;a++){
                            if(this.timer==10){
                                this.targetCombatant[a].takeDamage(this.effect[0])
                            }
                    ...
                    case 106:
                        ...
                        if(this.procedure[this.procedure.length-1]==2){
                            ...
                            if(this.timer>=15*this.upTargetDistance+5){
                                ...
                                this.procedure.push(this.targetCombatant.status.main[2]>0?2:index>=0&&this.battle.tileManager.tiles[index].occupied==0?0:1)
                            }
                        }
                    break
            ...
            case 1:
                switch(this.type){
                    case 0: case 1: case 2:
                        ...
                        if(this.userCombatant.agressor){
                            this.userCombatant.agressor=false
                        }
                    break
