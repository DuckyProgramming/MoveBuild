        ...
        switch(this.action){
            case 0:
                switch(this.type){
                    ...
                    case 75: case 78: case 88:
                        if(this.userCombatant.name=='General Duckion'||this.type!=39&&this.type!=56&&this.type!=74&&this.type!=75&&this.type!=78){
                            if(this.timer==1){
                                this.userCombatant.startAnimation(3)
                            }
