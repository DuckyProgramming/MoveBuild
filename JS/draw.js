function draw(){
    ...
    graphics.main.push()
    switch(stage.scene){
        case 'title': case 'menu': case 'menu2': case 'variants': case 'battle': case 'map': case 'rest': case 'shop': case 'victory': case 'defeat':
        case 'stash': case 'pack': case 'perk': case 'event': case 'bossstash': case 'graphic': case 'replay':
