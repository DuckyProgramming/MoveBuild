class attackManager{
    ...
    execute(){
        if(!(this.battle.modded(91)&&this.cost==0&&floor(random(0,4))==0)&&!(variants.cursed&&floor(random(0,5))==0)){
            this.attacks.push(new attack(this.type,this.battle,this.player,this.effect,this.attackClass,this.user,this.level,this.color,this.energy,this.target,this.targetDistance,this.targetClass,this.combo,{replay:0},this.amplify,this.relPos,this.limit,this.id,this.edition,this.drawn))
